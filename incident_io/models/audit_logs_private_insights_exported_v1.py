...
if TYPE_CHECKING:
    ...
    from ..models.audit_log_private_insights_exported_metadata_v2 import (
        AuditLogPrivateInsightsExportedMetadataV2,
    )
    from ..models.audit_log_target_v2 import AuditLogTargetV2


T = TypeVar("T", bound="AuditLogsPrivateInsightsExportedV1")


@_attrs_define(kw_only=True)
class AuditLogsPrivateInsightsExportedV1:
    """
    Example:
        {'action': 'private_insights.exported', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
    ...
    Attributes:
        action (str): The type of log entry that this is Example: private_insights.exported.
        ...
        metadata (AuditLogPrivateInsightsExportedMetadataV2):  Example: {'measure': 'alert_volume', 'outcome':
            'granted'}.
    ...
    metadata: AuditLogPrivateInsightsExportedMetadataV2
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        metadata = AuditLogPrivateInsightsExportedMetadataV2.from_dict(
            d.pop("metadata")
        )
        ...
        audit_logs_private_insights_exported_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            metadata=metadata,
        ...
        audit_logs_private_insights_exported_v1.additional_properties = d
        return audit_logs_private_insights_exported_v1
