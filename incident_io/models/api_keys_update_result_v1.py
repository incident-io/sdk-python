...
T = TypeVar("T", bound="APIKeysUpdateResultV1")


@_attrs_define
class APIKeysUpdateResultV1:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        api_keys_update_result_v1 = cls(
            api_key=api_key,
        )

        api_keys_update_result_v1.additional_properties = d
        return api_keys_update_result_v1
