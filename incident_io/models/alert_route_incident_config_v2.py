...
T = TypeVar("T", bound="AlertRouteIncidentConfigV2")


@_attrs_define(kw_only=True)
class AlertRouteIncidentConfigV2:
    """
    Example:
        {'auto_decline_enabled': False, 'auto_relate_grouped_alerts': False, 'condition_groups': [{'conditions':
            ...
            'Incident Severity', 'reference': 'incident.severity'}}]}], 'defer_time_seconds': 1, 'enabled': False,
    ...
    Attributes:
        ...
        auto_relate_grouped_alerts (bool): Should grouped alerts automatically be related to active incidents without
            confirmation? Example: False.
        condition_groups (list[ConditionGroupV2]): What condition groups must be true for this alert route to create an
            incident? Example: [{'conditions': [{'operation': {'label': 'Lawrence Jones', 'value':
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        auto_relate_grouped_alerts = d.pop("auto_relate_grouped_alerts")
        ...
        alert_route_incident_config_v2 = cls(
            auto_decline_enabled=auto_decline_enabled,
            auto_relate_grouped_alerts=auto_relate_grouped_alerts,
            condition_groups=condition_groups,
            defer_time_seconds=defer_time_seconds,
        ...
        alert_route_incident_config_v2.additional_properties = d
        return alert_route_incident_config_v2
