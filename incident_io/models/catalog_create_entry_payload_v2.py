...
if TYPE_CHECKING:
    from ..models.catalog_create_entry_payload_v2_attribute_values import (
        CatalogCreateEntryPayloadV2AttributeValues,
    )


T = TypeVar("T", bound="CatalogCreateEntryPayloadV2")


@_attrs_define
class CatalogCreateEntryPayloadV2:
    """
    Example:
    ...
    Attributes:
        attribute_values (CatalogCreateEntryPayloadV2AttributeValues): Values of this entry Example: {'abc123':
    ...
    attribute_values: CatalogCreateEntryPayloadV2AttributeValues
    catalog_type_id: str
    name: str
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        d = dict(src_dict)
        attribute_values = CatalogCreateEntryPayloadV2AttributeValues.from_dict(
        ...
        catalog_create_entry_payload_v2 = cls(
            attribute_values=attribute_values,
            catalog_type_id=catalog_type_id,
            name=name,
            aliases=aliases,
        ...
        catalog_create_entry_payload_v2.additional_properties = d
        return catalog_create_entry_payload_v2
