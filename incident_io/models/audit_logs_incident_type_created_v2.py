...
if TYPE_CHECKING:
    ...
    from ..models.audit_log_incident_type_default_teams_metadata_v2 import (
        AuditLogIncidentTypeDefaultTeamsMetadataV2,
    )
    from ..models.audit_log_target_v2 import AuditLogTargetV2


T = TypeVar("T", bound="AuditLogsIncidentTypeCreatedV2")


@_attrs_define(kw_only=True)
class AuditLogsIncidentTypeCreatedV2:
    """
    Example:
        {'action': 'incident_type.created', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
            ...
            'targets': [{'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Security', 'type': 'incident_type'}], 'version': 2}

    Attributes:
        action (str): The type of log entry that this is Example: incident_type.created.
        ...
        metadata (AuditLogIncidentTypeDefaultTeamsMetadataV2):  Example: {'after_default_team_ids':
            '01FCNDV6P870EA6S7TK1DSYDG0,01FCNDV6P870EA6S7TK1DSYDG2', 'before_default_team_ids':
    ...
    metadata: AuditLogIncidentTypeDefaultTeamsMetadataV2
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        metadata = AuditLogIncidentTypeDefaultTeamsMetadataV2.from_dict(
            d.pop("metadata")
        )
        ...
        audit_logs_incident_type_created_v2 = cls(
            action=action,
            actor=actor,
            context=context,
            metadata=metadata,
        ...
        audit_logs_incident_type_created_v2.additional_properties = d
        return audit_logs_incident_type_created_v2
