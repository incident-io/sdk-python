...
T = TypeVar("T", bound="AlertsV2ListStatus")


@_attrs_define(kw_only=True)
class AlertsV2ListStatus:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        alerts_v2_list_status.additional_properties = additional_properties
        return alerts_v2_list_status
