...
T = TypeVar("T", bound="AnnouncementRulesShowResultV2")
...
class AnnouncementRulesShowResultV2:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        announcement_rules_show_result_v2 = cls(
            announcement_rule=announcement_rule,
        )

        announcement_rules_show_result_v2.additional_properties = d
        return announcement_rules_show_result_v2
