...
T = TypeVar("T", bound="AlertRoutesUpdateResultV2")


@_attrs_define(kw_only=True)
class AlertRoutesUpdateResultV2:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        alert_routes_update_result_v2 = cls(
            alert_route=alert_route,
        )

        alert_routes_update_result_v2.additional_properties = d
        return alert_routes_update_result_v2
