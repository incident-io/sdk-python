...
from ..models.schedule_rotation_create_payload_v2_scheduling_mode import (
    ScheduleRotationCreatePayloadV2SchedulingMode,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.schedule_layer_create_payload_v2 import ScheduleLayerCreatePayloadV2
    from ..models.schedule_rotation_handover_v2 import ScheduleRotationHandoverV2
    from ..models.schedule_rotation_working_interval_create_payload_v2 import (
...
class ScheduleRotationCreatePayloadV2:
    ...
    Attributes:
        ...
        layers (list[ScheduleLayerCreatePayloadV2] | Unset):  Example: [{'id': '01G0J1EXE7AXZ2C93K61WBPYEH', 'name':
            'Layer 1'}].
        scheduling_mode (ScheduleRotationCreatePayloadV2SchedulingMode | Unset): Scheduling algorithm to use for this
        ...
        working_interval (list[ScheduleRotationWorkingIntervalCreatePayloadV2] | Unset): DEPRECATED: Use
            working_intervals instead. Example: [{'end_time': '17:00', 'start_time': '09:00', 'weekday': 'monday'}].
        working_intervals (list[ScheduleRotationWorkingIntervalCreatePayloadV2] | Unset):  Example: [{'end_time':
            '17:00', 'start_time': '09:00', 'weekday': 'monday'}].
    """
    ...
    id: str | Unset = UNSET
    layers: list[ScheduleLayerCreatePayloadV2] | Unset = UNSET
    scheduling_mode: ScheduleRotationCreatePayloadV2SchedulingMode | Unset = UNSET
    users: list[UserReferencePayloadV2] | Unset = UNSET
    working_interval: list[ScheduleRotationWorkingIntervalCreatePayloadV2] | Unset = (
        UNSET
    )
    working_intervals: list[ScheduleRotationWorkingIntervalCreatePayloadV2] | Unset = (
        UNSET
    )
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _layers is not UNSET:
            ...
            for layers_item_data in _layers:
                layers_item = ScheduleLayerCreatePayloadV2.from_dict(layers_item_data)

                layers.append(layers_item)

        _scheduling_mode = d.pop("scheduling_mode", UNSET)
        scheduling_mode: ScheduleRotationCreatePayloadV2SchedulingMode | Unset
        if isinstance(_scheduling_mode, Unset):
            scheduling_mode = UNSET
        else:
            scheduling_mode = ScheduleRotationCreatePayloadV2SchedulingMode(
                _scheduling_mode
            )
        ...
        working_interval: (
            list[ScheduleRotationWorkingIntervalCreatePayloadV2] | Unset
        ) = UNSET
        if _working_interval is not UNSET:
            working_interval = []
            for working_interval_item_data in _working_interval:
                working_interval_item = (
                    ScheduleRotationWorkingIntervalCreatePayloadV2.from_dict(
        ...
        schedule_rotation_create_payload_v2 = cls(
            name=name,
        ...
        schedule_rotation_create_payload_v2.additional_properties = d
