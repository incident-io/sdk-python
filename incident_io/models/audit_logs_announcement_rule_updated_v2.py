...
if TYPE_CHECKING:
    ...
    from ..models.audit_log_announcement_rule_metadata_v2 import (
...
T = TypeVar("T", bound="AuditLogsAnnouncementRuleUpdatedV2")


@_attrs_define
class AuditLogsAnnouncementRuleUpdatedV2:
    """
    Example:
        {'action': 'announcement_rule.updated', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
            ...
            'occurred_at': '2021-08-17T13:28:57.801578Z', 'targets': [{'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name':
            '#engineering', 'type': 'announcement_rule'}], 'version': 2}

    Attributes:
        action (str): The type of log entry that this is Example: announcement_rule.updated.
        ...
        metadata (AuditLogAnnouncementRuleMetadataV2):  Example: {'after_owning_team_ids':
            '01FCNDV6P870EA6S7TK1DSYDG0,01FCNDV6P870EA6S7TK1DSYDG2', 'after_private_incident_scope': 'owning_teams',
        ...
        targets (list[AuditLogTargetV2]): The custom field that was created Example: [{'id':
            '01FCNDV6P870EA6S7TK1DSYDG0', 'name': '#engineering', 'type': 'announcement_rule'}].
    ...
    metadata: AuditLogAnnouncementRuleMetadataV2
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        metadata = AuditLogAnnouncementRuleMetadataV2.from_dict(d.pop("metadata"))
        ...
        audit_logs_announcement_rule_updated_v2 = cls(
            action=action,
            actor=actor,
            context=context,
            metadata=metadata,
        ...
        audit_logs_announcement_rule_updated_v2.additional_properties = d
        return audit_logs_announcement_rule_updated_v2
