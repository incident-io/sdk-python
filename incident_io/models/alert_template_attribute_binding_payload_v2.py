...
from ..models.alert_template_attribute_binding_payload_v2_merge_strategy import (
...
T = TypeVar("T", bound="AlertTemplateAttributeBindingPayloadV2")
...
class AlertTemplateAttributeBindingPayloadV2:
    ...
    Attributes:
        array_value (list[EngineParamBindingValuePayloadV2] | Unset): If set, this is the array value of the step
            parameter Example: [{'literal': 'SEV123', 'reference': 'incident.severity'}].
        merge_strategy (AlertTemplateAttributeBindingPayloadV2MergeStrategy | Unset): Merge strategy for this attribute
            when alert updates Example: first_wins.
        value (EngineParamBindingValuePayloadV2 | Unset):  Example: {'literal': 'SEV123', 'reference':
            'incident.severity'}.
    """

    array_value: list[EngineParamBindingValuePayloadV2] | Unset = UNSET
    merge_strategy: AlertTemplateAttributeBindingPayloadV2MergeStrategy | Unset = UNSET
    value: EngineParamBindingValuePayloadV2 | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        merge_strategy: AlertTemplateAttributeBindingPayloadV2MergeStrategy | Unset
        if isinstance(_merge_strategy, Unset):
            merge_strategy = UNSET
        else:
            merge_strategy = AlertTemplateAttributeBindingPayloadV2MergeStrategy(
                _merge_strategy
            )

        _value = d.pop("value", UNSET)
        value: EngineParamBindingValuePayloadV2 | Unset
        if isinstance(_value, Unset):
            value = UNSET
        else:
            value = EngineParamBindingValuePayloadV2.from_dict(_value)

        alert_template_attribute_binding_payload_v2 = cls(
            array_value=array_value,
            merge_strategy=merge_strategy,
            value=value,
        )

        alert_template_attribute_binding_payload_v2.additional_properties = d
        return alert_template_attribute_binding_payload_v2
