...
T = TypeVar("T", bound="SchedulesShowOverrideResultV2")


@_attrs_define(kw_only=True)
class SchedulesShowOverrideResultV2:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        schedules_show_override_result_v2 = cls(
            override=override,
        )

        schedules_show_override_result_v2.additional_properties = d
        return schedules_show_override_result_v2
