...
T = TypeVar("T", bound="AlertsV2ListUpdatedAt")


@_attrs_define
class AlertsV2ListUpdatedAt:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        alerts_v2_list_updated_at.additional_properties = additional_properties
        return alerts_v2_list_updated_at
