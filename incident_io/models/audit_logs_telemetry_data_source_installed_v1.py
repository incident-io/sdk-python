...
T = TypeVar("T", bound="AuditLogsTelemetryDataSourceInstalledV1")


@_attrs_define
class AuditLogsTelemetryDataSourceInstalledV1:
    """
    Example:
        {'action': 'telemetry_data_source.installed', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
    ...
    Attributes:
        action (str): The type of log entry that this is Example: telemetry_data_source.installed.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_telemetry_data_source_installed_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_telemetry_data_source_installed_v1.additional_properties = d
        return audit_logs_telemetry_data_source_installed_v1
