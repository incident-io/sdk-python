...
T = TypeVar("T", bound="SchedulesCreateResultV2")


@_attrs_define
class SchedulesCreateResultV2:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        schedules_create_result_v2 = cls(
            schedule=schedule,
        )

        schedules_create_result_v2.additional_properties = d
        return schedules_create_result_v2
