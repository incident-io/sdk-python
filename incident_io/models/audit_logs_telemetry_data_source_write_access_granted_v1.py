...
if TYPE_CHECKING:
    ...
    from ..models.audit_log_telemetry_data_source_write_access_metadata_v2 import (
        AuditLogTelemetryDataSourceWriteAccessMetadataV2,
    )


T = TypeVar("T", bound="AuditLogsTelemetryDataSourceWriteAccessGrantedV1")


@_attrs_define(kw_only=True)
class AuditLogsTelemetryDataSourceWriteAccessGrantedV1:
    """
    Example:
        {'action': 'telemetry_data_source.write_access_granted', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0',
            ...
            {'tools': 'create_issue:chat=execute, delete_issue:chat=execute'}, 'occurred_at': '2021-08-17T13:28:57.801578Z',
            'targets': [{'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Grafana Cloud', 'type': 'telemetry_data_source'}],
            'version': 1}

    Attributes:
        action (str): The type of log entry that this is Example: telemetry_data_source.write_access_granted.
        ...
        metadata (AuditLogTelemetryDataSourceWriteAccessMetadataV2):  Example: {'tools': 'create_issue:chat=execute,
    ...
    metadata: AuditLogTelemetryDataSourceWriteAccessMetadataV2
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        metadata = AuditLogTelemetryDataSourceWriteAccessMetadataV2.from_dict(
            d.pop("metadata")
        )
        ...
        audit_logs_telemetry_data_source_write_access_granted_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            metadata=metadata,
        ...
        audit_logs_telemetry_data_source_write_access_granted_v1.additional_properties = d
        return audit_logs_telemetry_data_source_write_access_granted_v1
