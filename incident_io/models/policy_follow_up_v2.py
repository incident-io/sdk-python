...
T = TypeVar("T", bound="PolicyFollowUpV2")


@_attrs_define(kw_only=True)
class PolicyFollowUpV2:
    ...
    Attributes:
        requirements (list[ConditionGroupV2]): Conditions a follow-up must satisfy to be compliant, e.g. 'is exported to
            Jira' Example: [{'conditions': [{'operation': {'label': 'Lawrence Jones', 'value':
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        policy_follow_up_v2 = cls(
            requirements=requirements,
            due_date_config=due_date_config,
            run_on_private_incidents=run_on_private_incidents,
        )

        policy_follow_up_v2.additional_properties = d
        return policy_follow_up_v2
