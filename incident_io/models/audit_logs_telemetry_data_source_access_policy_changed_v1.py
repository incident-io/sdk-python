...
if TYPE_CHECKING:
    ...
    from ..models.audit_log_telemetry_data_source_access_policy_changed_metadata_v2 import (
        AuditLogTelemetryDataSourceAccessPolicyChangedMetadataV2,
    )


T = TypeVar("T", bound="AuditLogsTelemetryDataSourceAccessPolicyChangedV1")


@_attrs_define(kw_only=True)
class AuditLogsTelemetryDataSourceAccessPolicyChangedV1:
    """
    Example:
        {'action': 'telemetry_data_source.access_policy_changed', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0',
            ...
            'set_by': '01FCNDV6P870EA6S7TK1DSYDG0'}, 'occurred_at': '2021-08-17T13:28:57.801578Z', 'targets': [{'id':
            '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Grafana Cloud', 'type': 'telemetry_data_source'}], 'version': 1}

    Attributes:
        action (str): The type of log entry that this is Example: telemetry_data_source.access_policy_changed.
        ...
        metadata (AuditLogTelemetryDataSourceAccessPolicyChangedMetadataV2):  Example: {'after':
            '{"read":{"enabled":true,"surfaces":{"chat":{"type":"deny"}}}}', 'before':
            '{"read":{"enabled":true,"surfaces":{"chat":{"type":"allow"}}}}', 'change_id': '01JD8ZQK9X0000000000000000',
    ...
    metadata: AuditLogTelemetryDataSourceAccessPolicyChangedMetadataV2
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        metadata = AuditLogTelemetryDataSourceAccessPolicyChangedMetadataV2.from_dict(
            d.pop("metadata")
        )
        ...
        audit_logs_telemetry_data_source_access_policy_changed_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            metadata=metadata,
        ...
        audit_logs_telemetry_data_source_access_policy_changed_v1.additional_properties = d
        return audit_logs_telemetry_data_source_access_policy_changed_v1
