...
T = TypeVar("T", bound="EscalationsListPathsResultV2")
...
class EscalationsListPathsResultV2:
    """
    Example:
        {'escalation_paths': [{'current_responders': [{'email': 'lisa@incident.io', 'id': '01FCNDV6P870EA6S7TK1DSYDG0',
    ...
    Attributes:
        escalation_paths (list[EscalationPathV2]):  Example: [{'current_responders': [{'email': 'lisa@incident.io',
            'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Lisa Karlin Curtis', 'role': 'owner', 'slack_user_id':
            'U02AYNF2XJM'}], 'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'kind': 'templated', 'name': 'Urgent Support',
            'param_bindings': {'abc123': {'array_value': [{'label': 'Lawrence Jones', 'literal': 'SEV123', 'reference':
    ...
    escalation_paths: list[EscalationPathV2]
    pagination_meta: PaginationMetaResultV2
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        escalation_paths = []
        for escalation_paths_item_data in self.escalation_paths:
            escalation_paths_item = escalation_paths_item_data.to_dict()
            escalation_paths.append(escalation_paths_item)
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        d = dict(src_dict)
        escalation_paths = []
        _escalation_paths = d.pop("escalation_paths")
        for escalation_paths_item_data in _escalation_paths:
            escalation_paths_item = EscalationPathV2.from_dict(
                escalation_paths_item_data
            )
        ...
        escalations_list_paths_result_v2 = cls(
            escalation_paths=escalation_paths,
            pagination_meta=pagination_meta,
        )

        escalations_list_paths_result_v2.additional_properties = d
        return escalations_list_paths_result_v2
