...
T = TypeVar("T", bound="FollowUpsConnectExternalIssueResultV2")
...
class FollowUpsConnectExternalIssueResultV2:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        follow_ups_connect_external_issue_result_v2 = cls(
            follow_up=follow_up,
        )

        follow_ups_connect_external_issue_result_v2.additional_properties = d
        return follow_ups_connect_external_issue_result_v2
