...
from ..models.escalation_path_node_notify_channel_with_binding_v2_time_to_ack_interval_condition import (
...
T = TypeVar("T", bound="EscalationPathNodeNotifyChannelWithBindingV2")
...
class EscalationPathNodeNotifyChannelWithBindingV2:
    ...
    Attributes:
        targets (list[EscalationPathTargetWithBindingV2]): The channels to notify, each concrete or a parameter binding.
            Example: [{'binding': {'array_value': [{'label': 'Lawrence Jones', 'literal': 'SEV123', 'reference':
            'incident.severity'}], 'value': {'label': 'Lawrence Jones', 'literal': 'SEV123', 'reference':
            'incident.severity'}}, 'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'schedule_mode': 'currently_on_call',
            'selected_rota_id': '01FCNDV6P870EA6S7TK1DSYDG0', 'type': 'schedule', 'urgency': 'high'}].
        time_to_ack_interval_condition (EscalationPathNodeNotifyChannelWithBindingV2TimeToAckIntervalCondition | Unset):
    ...
    time_to_ack_interval_condition: (
        EscalationPathNodeNotifyChannelWithBindingV2TimeToAckIntervalCondition | Unset
    ) = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        escalation_path_node_notify_channel_with_binding_v2 = cls(
            targets=targets,
        ...
        escalation_path_node_notify_channel_with_binding_v2.additional_properties = d
        return escalation_path_node_notify_channel_with_binding_v2
