...
T = TypeVar("T", bound="SchedulesShowScheduleSyncRuleResultV2")


@_attrs_define(kw_only=True)
class SchedulesShowScheduleSyncRuleResultV2:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        schedules_show_schedule_sync_rule_result_v2 = cls(
            schedule_sync_rule=schedule_sync_rule,
        )

        schedules_show_schedule_sync_rule_result_v2.additional_properties = d
        return schedules_show_schedule_sync_rule_result_v2
