...
if TYPE_CHECKING:
    ...
    from ..models.audit_log_user_scim_group_mapping_changed_metadata_v2 import (
...
class AuditLogsScimGroupRoleMappingsUpdatedV1:
    ...
    Attributes:
        ...
        metadata (AuditLogUserSCIMGroupMappingChangedMetadataV2):  Example: {'after_base_role_slug': 'owner',
    ...
    metadata: AuditLogUserSCIMGroupMappingChangedMetadataV2
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_scim_group_role_mappings_updated_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            metadata=metadata,
        ...
        audit_logs_scim_group_role_mappings_updated_v1.additional_properties = d
        return audit_logs_scim_group_role_mappings_updated_v1
