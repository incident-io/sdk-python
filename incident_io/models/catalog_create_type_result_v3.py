...
T = TypeVar("T", bound="CatalogCreateTypeResultV3")


@_attrs_define
class CatalogCreateTypeResultV3:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        catalog_create_type_result_v3 = cls(
            catalog_type=catalog_type,
        )

        catalog_create_type_result_v3.additional_properties = d
        return catalog_create_type_result_v3
