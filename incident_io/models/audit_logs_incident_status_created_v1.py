...
T = TypeVar("T", bound="AuditLogsIncidentStatusCreatedV1")


@_attrs_define
class AuditLogsIncidentStatusCreatedV1:
    """
    Example:
        {'action': 'incident_status.created', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
    ...
    Attributes:
        action (str): The type of log entry that this is Example: incident_status.created.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_incident_status_created_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_incident_status_created_v1.additional_properties = d
        return audit_logs_incident_status_created_v1
