...
T = TypeVar("T", bound="AuditLogsAnnouncementPostTemplateCreatedV1")


@_attrs_define
class AuditLogsAnnouncementPostTemplateCreatedV1:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_announcement_post_template_created_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_announcement_post_template_created_v1.additional_properties = d
        return audit_logs_announcement_post_template_created_v1
