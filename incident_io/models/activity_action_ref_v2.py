...
T = TypeVar("T", bound="ActivityActionRefV2")
...
class ActivityActionRefV2:
    ...
    Attributes:
        action_id (str): The action. Fetch it from GET /v2/actions/{id}. Example: 01FCNDV6P870EA6S7TK1DSYDG0.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        activity_action_ref_v2 = cls(
            action_id=action_id,
            actor=actor,
        )

        activity_action_ref_v2.additional_properties = d
        return activity_action_ref_v2
