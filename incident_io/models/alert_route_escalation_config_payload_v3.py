...
if TYPE_CHECKING:
    from ..models.alert_route_escalation_target_payload_v3 import (
        AlertRouteEscalationTargetPayloadV3,
    )
    from ..models.alert_route_when_alert_joins_group_payload_v3 import (
        AlertRouteWhenAlertJoinsGroupPayloadV3,
    )


T = TypeVar("T", bound="AlertRouteEscalationConfigPayloadV3")
...
class AlertRouteEscalationConfigPayloadV3:
    ...
    Attributes:
        ...
        escalation_targets (list[AlertRouteEscalationTargetPayloadV3]): Targets for escalation Example:
        ...
        when_alert_joins_group (AlertRouteWhenAlertJoinsGroupPayloadV3 | Unset):  Example: {'grace_period_seconds': 60,
            'mode': 'on_each_new_alert'}.
    """

    auto_cancel_escalations: bool
    escalation_targets: list[AlertRouteEscalationTargetPayloadV3]
    when_alert_joins_group: AlertRouteWhenAlertJoinsGroupPayloadV3 | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for escalation_targets_item_data in _escalation_targets:
            escalation_targets_item = AlertRouteEscalationTargetPayloadV3.from_dict(
        ...
        when_alert_joins_group: AlertRouteWhenAlertJoinsGroupPayloadV3 | Unset
        if isinstance(_when_alert_joins_group, Unset):
            when_alert_joins_group = UNSET
        else:
            when_alert_joins_group = AlertRouteWhenAlertJoinsGroupPayloadV3.from_dict(
                _when_alert_joins_group
            )

        alert_route_escalation_config_payload_v3 = cls(
            auto_cancel_escalations=auto_cancel_escalations,
            escalation_targets=escalation_targets,
            when_alert_joins_group=when_alert_joins_group,
        )

        alert_route_escalation_config_payload_v3.additional_properties = d
        return alert_route_escalation_config_payload_v3
