...
T = TypeVar("T", bound="AuditLogsIntegrationUninstalledV1")


@_attrs_define
class AuditLogsIntegrationUninstalledV1:
    """
    Example:
        {'action': 'integration.uninstalled', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
            ...
            '2021-08-17T13:28:57.801578Z', 'targets': [{'id': 'github', 'name': 'Github', 'type': 'integration'}],
            'version': 1}

    Attributes:
        action (str): The type of log entry that this is Example: integration.uninstalled.
        ...
        targets (list[AuditLogTargetV2]): The custom field that was created Example: [{'id': 'github', 'name': 'Github',
            'type': 'integration'}].
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_integration_uninstalled_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_integration_uninstalled_v1.additional_properties = d
        return audit_logs_integration_uninstalled_v1
