...
T = TypeVar("T", bound="AlertRoutesUpdateResultV3")
...
class AlertRoutesUpdateResultV3:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        alert_routes_update_result_v3 = cls(
            alert_route=alert_route,
        )

        alert_routes_update_result_v3.additional_properties = d
        return alert_routes_update_result_v3
