...
T = TypeVar("T", bound="AuditLogsDebriefInviteRuleCreatedV1")


@_attrs_define(kw_only=True)
class AuditLogsDebriefInviteRuleCreatedV1:
    """
    Example:
        {'action': 'debrief_invite_rule.created', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
    ...
    Attributes:
        action (str): The type of log entry that this is Example: debrief_invite_rule.created.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_debrief_invite_rule_created_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_debrief_invite_rule_created_v1.additional_properties = d
        return audit_logs_debrief_invite_rule_created_v1
