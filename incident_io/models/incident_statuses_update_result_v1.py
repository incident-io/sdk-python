...
T = TypeVar("T", bound="IncidentStatusesUpdateResultV1")


@_attrs_define(kw_only=True)
class IncidentStatusesUpdateResultV1:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        incident_statuses_update_result_v1 = cls(
            incident_status=incident_status,
        )

        incident_statuses_update_result_v1.additional_properties = d
        return incident_statuses_update_result_v1
