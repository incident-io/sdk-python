...
T = TypeVar("T", bound="PayConfigsUpdateWeeklyRuleResultV2")


@_attrs_define
class PayConfigsUpdateWeeklyRuleResultV2:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        pay_configs_update_weekly_rule_result_v2 = cls(
            weekly_rule=weekly_rule,
        )

        pay_configs_update_weekly_rule_result_v2.additional_properties = d
        return pay_configs_update_weekly_rule_result_v2
