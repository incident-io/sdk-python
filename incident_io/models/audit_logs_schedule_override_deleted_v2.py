...
T = TypeVar("T", bound="AuditLogsScheduleOverrideDeletedV2")


@_attrs_define(kw_only=True)
class AuditLogsScheduleOverrideDeletedV2:
    """
    Example:
        {'action': 'schedule_override.deleted', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
    ...
    Attributes:
        action (str): The type of log entry that this is Example: schedule_override.deleted.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_schedule_override_deleted_v2 = cls(
            action=action,
            actor=actor,
            context=context,
            metadata=metadata,
        ...
        audit_logs_schedule_override_deleted_v2.additional_properties = d
        return audit_logs_schedule_override_deleted_v2
