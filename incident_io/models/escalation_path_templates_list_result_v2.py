...
T = TypeVar("T", bound="EscalationPathTemplatesListResultV2")
...
class EscalationPathTemplatesListResultV2:
    """
    Example:
        {'escalation_path_templates': [{'description': 'abc123', 'expressions': [{'else_branch': {'result':
            ...
            'weekday_intervals': [{'end_time': '17:00', 'start_time': '09:00', 'weekday': 'monday'}]}]}], 'pagination_meta':
            {'after': '01FCNDV6P870EA6S7TK1DSYDG0', 'page_size': 25}}

    Attributes:
        escalation_path_templates (list[EscalationPathTemplateV2]):  Example: [{'description': 'abc123', 'expressions':
    ...
    escalation_path_templates: list[EscalationPathTemplateV2]
    pagination_meta: PaginationMetaResultV2
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        escalation_path_templates = []
        for escalation_path_templates_item_data in self.escalation_path_templates:
            escalation_path_templates_item = (
                escalation_path_templates_item_data.to_dict()
            )
            escalation_path_templates.append(escalation_path_templates_item)
        ...
        field_dict.update(
            {
                "escalation_path_templates": escalation_path_templates,
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        d = dict(src_dict)
        escalation_path_templates = []
        _escalation_path_templates = d.pop("escalation_path_templates")
        for escalation_path_templates_item_data in _escalation_path_templates:
            escalation_path_templates_item = EscalationPathTemplateV2.from_dict(
                escalation_path_templates_item_data
            )
        ...
        escalation_path_templates_list_result_v2 = cls(
            escalation_path_templates=escalation_path_templates,
            pagination_meta=pagination_meta,
        )

        escalation_path_templates_list_result_v2.additional_properties = d
        return escalation_path_templates_list_result_v2
