...
T = TypeVar("T", bound="ExpressionParseOptsPayloadV3")


@_attrs_define
class ExpressionParseOptsPayloadV3:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        expression_parse_opts_payload_v3 = cls(
            returns=returns,
            source=source,
        )

        expression_parse_opts_payload_v3.additional_properties = d
        return expression_parse_opts_payload_v3
