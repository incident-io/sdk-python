...
T = TypeVar("T", bound="PayConfigsUpdateOneOffRuleResultV2")
...
class PayConfigsUpdateOneOffRuleResultV2:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        pay_configs_update_one_off_rule_result_v2 = cls(
            one_off_rule=one_off_rule,
        )

        pay_configs_update_one_off_rule_result_v2.additional_properties = d
        return pay_configs_update_one_off_rule_result_v2
