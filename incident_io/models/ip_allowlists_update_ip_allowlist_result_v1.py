...
T = TypeVar("T", bound="IPAllowlistsUpdateIPAllowlistResultV1")
...
class IPAllowlistsUpdateIPAllowlistResultV1:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        ip_allowlists_update_ip_allowlist_result_v1 = cls(
            ip_allowlist=ip_allowlist,
        )

        ip_allowlists_update_ip_allowlist_result_v1.additional_properties = d
        return ip_allowlists_update_ip_allowlist_result_v1
