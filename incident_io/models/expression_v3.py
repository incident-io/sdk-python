...
if TYPE_CHECKING:
    from ..models.expression_else_branch_v3 import ExpressionElseBranchV3
    from ..models.expression_operation_v3 import ExpressionOperationV3
    from ..models.returns_meta_v3 import ReturnsMetaV3


T = TypeVar("T", bound="ExpressionV3")
...
class ExpressionV3:
    ...
    Attributes:
        ...
        operations (list[ExpressionOperationV3]):  Example: [{'branches': {'branches': [{'condition_groups':
            ...
            '1235', 'reference_label': 'Teams'}, 'filter': {'condition_groups': [{'conditions': [{'operation': {'label':
        ...
        root_reference (str): The root reference for this expression (i.e. where the expression starts) Example:
            incident.status.
        else_branch (ExpressionElseBranchV3 | Unset):  Example: {'result': {'array_value': [{'literal': 'SEV123',
            'reference': 'incident.severity'}], 'value': {'literal': 'SEV123', 'reference': 'incident.severity'}}}.
    """

    label: str
    operations: list[ExpressionOperationV3]
    reference: str
    returns: ReturnsMetaV3
    root_reference: str
    else_branch: ExpressionElseBranchV3 | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.expression_else_branch_v3 import (
            ExpressionElseBranchV3,
        )
        from ..models.expression_operation_v3 import (
        ...
        for operations_item_data in _operations:
            operations_item = ExpressionOperationV3.from_dict(operations_item_data)
        ...
        else_branch: ExpressionElseBranchV3 | Unset
        if isinstance(_else_branch, Unset):
            else_branch = UNSET
        else:
            else_branch = ExpressionElseBranchV3.from_dict(_else_branch)
        ...
        expression_v3.additional_properties = d
        return expression_v3
