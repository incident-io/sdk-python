...
class CustomFieldValueV2:
    ...
    Attributes:
        value_catalog_entry (EmbeddedCatalogEntryV2 | Unset):  Example: {'aliases': ['lawrence@incident.io',
        ...
        value_numeric (str | Unset): If the custom field type is 'numeric', this will contain the value assigned.
            Example: 123.456.
        value_option (CustomFieldOptionV2 | Unset):  Example: {'custom_field_id': '01FCNDV6P870EA6S7TK1DSYDG0', 'id':
    ...
    value_catalog_entry: EmbeddedCatalogEntryV2 | Unset = UNSET
    value_link: str | Unset = UNSET
    value_numeric: str | Unset = UNSET
    value_option: CustomFieldOptionV2 | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.custom_field_option_v2 import CustomFieldOptionV2
        from ..models.embedded_catalog_entry_v2 import (
            EmbeddedCatalogEntryV2,
        )

        d = dict(src_dict)
        _value_catalog_entry = d.pop("value_catalog_entry", UNSET)
        value_catalog_entry: EmbeddedCatalogEntryV2 | Unset
        ...
        value_option: CustomFieldOptionV2 | Unset
