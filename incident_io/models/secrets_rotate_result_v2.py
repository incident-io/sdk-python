...
T = TypeVar("T", bound="SecretsRotateResultV2")


@_attrs_define(kw_only=True)
class SecretsRotateResultV2:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        secrets_rotate_result_v2 = cls(
            secret=secret,
        )

        secrets_rotate_result_v2.additional_properties = d
        return secrets_rotate_result_v2
