...
T = TypeVar("T", bound="CallRoutesShowOptionResultV2")


@_attrs_define
class CallRoutesShowOptionResultV2:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        call_routes_show_option_result_v2 = cls(
            option=option,
        )

        call_routes_show_option_result_v2.additional_properties = d
        return call_routes_show_option_result_v2
