...
T = TypeVar("T", bound="AuditLogsAlertChatMessageTemplateCreatedV1")


@_attrs_define(kw_only=True)
class AuditLogsAlertChatMessageTemplateCreatedV1:
    """
    Example:
        {'action': 'alert_chat_message_template.created', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
    ...
    Attributes:
        action (str): The type of log entry that this is Example: alert_chat_message_template.created.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_alert_chat_message_template_created_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_alert_chat_message_template_created_v1.additional_properties = d
        return audit_logs_alert_chat_message_template_created_v1
