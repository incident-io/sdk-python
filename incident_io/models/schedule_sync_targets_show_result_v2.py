...
T = TypeVar("T", bound="ScheduleSyncTargetsShowResultV2")


@_attrs_define(kw_only=True)
class ScheduleSyncTargetsShowResultV2:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        schedule_sync_targets_show_result_v2 = cls(
            schedule_sync_target=schedule_sync_target,
        )

        schedule_sync_targets_show_result_v2.additional_properties = d
        return schedule_sync_targets_show_result_v2
