...
T = TypeVar("T", bound="AuditLogsNudgeCreatedV1")


@_attrs_define(kw_only=True)
class AuditLogsNudgeCreatedV1:
    """
    Example:
        {'action': 'nudge.created', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata': {'user_base_role_slug':
            ...
            'targets': [{'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Reminder to take a break', 'type': 'nudge'}],
            'version': 1}

    Attributes:
        action (str): The type of log entry that this is Example: nudge.created.
        ...
        targets (list[AuditLogTargetV2]): The custom field that was created Example: [{'id':
            '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Reminder to take a break', 'type': 'nudge'}].
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_nudge_created_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_nudge_created_v1.additional_properties = d
        return audit_logs_nudge_created_v1
