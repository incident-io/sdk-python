...
T = TypeVar("T", bound="AuditLogsInternalStatusPageUpdatedV1")


@_attrs_define
class AuditLogsInternalStatusPageUpdatedV1:
    """
    Example:
        {'action': 'internal_status_page.updated', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
    ...
    Attributes:
        action (str): The type of log entry that this is Example: internal_status_page.updated.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_internal_status_page_updated_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_internal_status_page_updated_v1.additional_properties = d
        return audit_logs_internal_status_page_updated_v1
