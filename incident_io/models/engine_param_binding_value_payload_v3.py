...
T = TypeVar("T", bound="EngineParamBindingValuePayloadV3")
...
class EngineParamBindingValuePayloadV3:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        engine_param_binding_value_payload_v3 = cls(
            literal=literal,
            reference=reference,
        )

        engine_param_binding_value_payload_v3.additional_properties = d
        return engine_param_binding_value_payload_v3
