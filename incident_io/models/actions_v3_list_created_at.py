...
T = TypeVar("T", bound="ActionsV3ListCreatedAt")


@_attrs_define(kw_only=True)
class ActionsV3ListCreatedAt:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        d = dict(src_dict)
        actions_v3_list_created_at = cls()
        ...
        actions_v3_list_created_at.additional_properties = additional_properties
        return actions_v3_list_created_at
