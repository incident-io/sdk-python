...
if TYPE_CHECKING:
    ...
    from ..models.audit_log_private_incident_access_attempted_metadata_v2 import (
        AuditLogPrivateIncidentAccessAttemptedMetadataV2,
    )
    from ..models.audit_log_target_v2 import AuditLogTargetV2


T = TypeVar("T", bound="AuditLogsPrivateIncidentAccessAttemptedV1")


@_attrs_define
class AuditLogsPrivateIncidentAccessAttemptedV1:
    """
    Example:
        {'action': 'private_incident.access_attempted', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
            ...
            'name': '#INC-123 The website is slow', 'type': 'incident'}], 'version': 1}
    ...
    Attributes:
        ...
        metadata (AuditLogPrivateIncidentAccessAttemptedMetadataV2):  Example: {'outcome': 'granted'}.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_private_incident_access_attempted_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            metadata=metadata,
        ...
        audit_logs_private_incident_access_attempted_v1.additional_properties = d
        return audit_logs_private_incident_access_attempted_v1
