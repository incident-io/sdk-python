...
T = TypeVar("T", bound="CatalogListTypesResultV2")
...
class CatalogListTypesResultV2:
    ...
    Example:
        {'catalog_types': [{'annotations': {'incident.io/catalog-importer/id': 'id-of-config'}, 'categories':
            ...
            Kubernetes clusters that we run inside of GKE.', 'dynamic_resource_parameter': 'abc123', 'estimated_count': 7,
            'icon': 'alert', 'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'is_editable': False, 'last_synced_at':
            ...
            'semantic_type': 'abc123', 'source_repo_url': 'https://github.com/my-company/incident-io-catalog', 'type_name':
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        catalog_list_types_result_v2 = cls(
            catalog_types=catalog_types,
        )

        catalog_list_types_result_v2.additional_properties = d
        return catalog_list_types_result_v2
