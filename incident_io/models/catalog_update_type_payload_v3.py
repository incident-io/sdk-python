...
from ..models.catalog_update_type_payload_v3_categories_item import (
    CatalogUpdateTypePayloadV3CategoriesItem,
)
from ..models.catalog_update_type_payload_v3_color import (
    CatalogUpdateTypePayloadV3Color,
)
from ..models.catalog_update_type_payload_v3_icon import CatalogUpdateTypePayloadV3Icon
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.catalog_update_type_payload_v3_annotations import (
        CatalogUpdateTypePayloadV3Annotations,
    )


T = TypeVar("T", bound="CatalogUpdateTypePayloadV3")
...
class CatalogUpdateTypePayloadV3:
    ...
    Example:
        {'annotations': {'incident.io/catalog-importer/id': 'id-of-config'}, 'categories': ['customer'], 'color':
            ...
            'https://github.com/my-company/incident-io-catalog', 'use_name_as_identifier': True}
    ...
    Attributes:
        ...
        annotations (CatalogUpdateTypePayloadV3Annotations | Unset): Annotations that can track metadata about this type
            Example: {'incident.io/catalog-importer/id': 'id-of-config'}.
        categories (list[CatalogUpdateTypePayloadV3CategoriesItem] | Unset): What categories is this type considered
            part of Example: ['customer'].
        color (CatalogUpdateTypePayloadV3Color | Unset): Sets the display color of this type in the dashboard Example:
            yellow.
        icon (CatalogUpdateTypePayloadV3Icon | Unset): Sets the display icon of this type in the dashboard Example:
            alert.
    ...
    description: str
    name: str
    annotations: CatalogUpdateTypePayloadV3Annotations | Unset = UNSET
    categories: list[CatalogUpdateTypePayloadV3CategoriesItem] | Unset = UNSET
    color: CatalogUpdateTypePayloadV3Color | Unset = UNSET
    icon: CatalogUpdateTypePayloadV3Icon | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        annotations: CatalogUpdateTypePayloadV3Annotations | Unset
        if isinstance(_annotations, Unset):
            annotations = UNSET
        else:
            annotations = CatalogUpdateTypePayloadV3Annotations.from_dict(_annotations)
        ...
        if _categories is not UNSET:
            ...
            for categories_item_data in _categories:
                categories_item = CatalogUpdateTypePayloadV3CategoriesItem(
        ...
        color: CatalogUpdateTypePayloadV3Color | Unset
        if isinstance(_color, Unset):
            color = UNSET
        else:
            color = CatalogUpdateTypePayloadV3Color(_color)

        _icon = d.pop("icon", UNSET)
        icon: CatalogUpdateTypePayloadV3Icon | Unset
        if isinstance(_icon, Unset):
            icon = UNSET
        else:
            icon = CatalogUpdateTypePayloadV3Icon(_icon)
        ...
        catalog_update_type_payload_v3 = cls(
            description=description,
            name=name,
        ...
        catalog_update_type_payload_v3.additional_properties = d
        return catalog_update_type_payload_v3
