...
T = TypeVar("T", bound="AuditLogsStatusPageSubPageUpdatedV1")


@_attrs_define
class AuditLogsStatusPageSubPageUpdatedV1:
    """
    Example:
        {'action': 'status_page_sub_page.updated', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
    ...
    Attributes:
        action (str): The type of log entry that this is Example: status_page_sub_page.updated.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_status_page_sub_page_updated_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_status_page_sub_page_updated_v1.additional_properties = d
        return audit_logs_status_page_sub_page_updated_v1
