...
T = TypeVar("T", bound="AuditLogsOnCallNotificationPauseCreatedV1")


@_attrs_define(kw_only=True)
class AuditLogsOnCallNotificationPauseCreatedV1:
    """
    Example:
        {'action': 'on_call_notification_pause.created', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
            ...
            '2021-08-17T13:28:57.801578Z', 'targets': [{'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Notification pause for
            Bob the builder', 'type': 'on_call_notification_pause'}, {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Bob the
            builder', 'type': 'user'}], 'version': 1}

    Attributes:
        action (str): The type of log entry that this is Example: on_call_notification_pause.created.
        ...
        targets (list[AuditLogTargetV2]): The custom field that was created Example: [{'id':
            '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Notification pause for Bob the builder', 'type':
            'on_call_notification_pause'}, {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Bob the builder', 'type': 'user'}].
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_on_call_notification_pause_created_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_on_call_notification_pause_created_v1.additional_properties = d
        return audit_logs_on_call_notification_pause_created_v1
