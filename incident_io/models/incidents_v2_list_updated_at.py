...
T = TypeVar("T", bound="IncidentsV2ListUpdatedAt")


@_attrs_define(kw_only=True)
class IncidentsV2ListUpdatedAt:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        d = dict(src_dict)
        incidents_v2_list_updated_at = cls()
        ...
        incidents_v2_list_updated_at.additional_properties = additional_properties
        return incidents_v2_list_updated_at
