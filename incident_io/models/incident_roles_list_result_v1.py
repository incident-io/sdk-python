...
T = TypeVar("T", bound="IncidentRolesListResultV1")
...
class IncidentRolesListResultV1:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        incident_roles_list_result_v1 = cls(
            incident_roles=incident_roles,
        )

        incident_roles_list_result_v1.additional_properties = d
        return incident_roles_list_result_v1
