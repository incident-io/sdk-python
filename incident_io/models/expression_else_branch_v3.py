...
T = TypeVar("T", bound="ExpressionElseBranchV3")
...
class ExpressionElseBranchV3:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        expression_else_branch_v3 = cls(
            result=result,
        )

        expression_else_branch_v3.additional_properties = d
        return expression_else_branch_v3
