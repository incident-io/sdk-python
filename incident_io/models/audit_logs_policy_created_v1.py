...
T = TypeVar("T", bound="AuditLogsPolicyCreatedV1")


@_attrs_define
class AuditLogsPolicyCreatedV1:
    """
    Example:
        {'action': 'policy.created', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata': {'user_base_role_slug':
            ...
            {'location': '1.2.3.4', 'user_agent': 'Chrome/91.0.4472.114'}, 'occurred_at': '2021-08-17T13:28:57.801578Z',
            'targets': [{'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Follow-ups must be closed within 3 weeks', 'type':
            'policy'}], 'version': 1}
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_policy_created_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_policy_created_v1.additional_properties = d
        return audit_logs_policy_created_v1
