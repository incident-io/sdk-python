...
class ScheduleCreatePayloadV2:
    ...
    Attributes:
        annotations (ScheduleCreatePayloadV2Annotations | Unset): Annotations that can track metadata about the schedule
            Example: {'incident.io/terraform/version': 'version-of-terraform'}.
        config (ScheduleConfigCreatePayloadV2 | Unset):  Example: {'rotations': [{'effective_from':
    ...
    annotations: ScheduleCreatePayloadV2Annotations | Unset = UNSET
    config: ScheduleConfigCreatePayloadV2 | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        annotations: ScheduleCreatePayloadV2Annotations | Unset
        ...
        config: ScheduleConfigCreatePayloadV2 | Unset
