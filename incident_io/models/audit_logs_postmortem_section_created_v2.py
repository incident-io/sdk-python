...
T = TypeVar("T", bound="AuditLogsPostmortemSectionCreatedV2")


@_attrs_define
class AuditLogsPostmortemSectionCreatedV2:
    """
    Example:
        {'action': 'postmortem_section.created', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
    ...
    Attributes:
        action (str): The type of log entry that this is Example: postmortem_section.created.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_postmortem_section_created_v2 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_postmortem_section_created_v2.additional_properties = d
        return audit_logs_postmortem_section_created_v2
