...
T = TypeVar("T", bound="CatalogCreateTypeResultV2")


@_attrs_define
class CatalogCreateTypeResultV2:
    """
    Example:
        {'catalog_type': {'annotations': {'incident.io/catalog-importer/id': 'id-of-config'}, 'categories':
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        catalog_create_type_result_v2 = cls(
            catalog_type=catalog_type,
        )

        catalog_create_type_result_v2.additional_properties = d
        return catalog_create_type_result_v2
