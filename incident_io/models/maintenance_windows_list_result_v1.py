...
T = TypeVar("T", bound="MaintenanceWindowsListResultV1")
...
class MaintenanceWindowsListResultV1:
    """
    Example:
        {'maintenance_windows': [{'alert_condition_groups': [{'conditions': [{'operation': {'label': 'Lawrence Jones',
    ...
    Attributes:
        maintenance_windows (list[MaintenanceWindowV1]):  Example: [{'alert_condition_groups': [{'conditions':
            ...
            'Incident Severity', 'reference': 'incident.severity'}}]}], 'archived_at': '2021-08-17T13:28:57.801578Z',
            'created_at': '2021-08-17T13:28:57.801578Z', 'end_at': '2021-08-17T14:28:57.801578Z', 'escalation_targets':
            [{'escalation_paths': {'array_value': [{'label': 'Lawrence Jones', 'literal': 'SEV123', 'reference':
            'incident.severity'}], 'value': {'label': 'Lawrence Jones', 'literal': 'SEV123', 'reference':
            'incident.severity'}}, 'users': {'array_value': [{'label': 'Lawrence Jones', 'literal': 'SEV123', 'reference':
            'incident.severity'}], 'value': {'label': 'Lawrence Jones', 'literal': 'SEV123', 'reference':
    ...
    maintenance_windows: list[MaintenanceWindowV1]
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for maintenance_windows_item_data in _maintenance_windows:
            maintenance_windows_item = MaintenanceWindowV1.from_dict(
        ...
        maintenance_windows_list_result_v1 = cls(
            maintenance_windows=maintenance_windows,
            pagination_meta=pagination_meta,
        )

        maintenance_windows_list_result_v1.additional_properties = d
        return maintenance_windows_list_result_v1
