...
T = TypeVar("T", bound="PayConfigsShowWeeklyRuleResultV2")
...
class PayConfigsShowWeeklyRuleResultV2:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        pay_configs_show_weekly_rule_result_v2 = cls(
            weekly_rule=weekly_rule,
        )

        pay_configs_show_weekly_rule_result_v2.additional_properties = d
        return pay_configs_show_weekly_rule_result_v2
