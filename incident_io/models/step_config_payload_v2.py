...
T = TypeVar("T", bound="StepConfigPayloadV2")
...
class StepConfigPayloadV2:
    ...
    Attributes:
        ...
        param_bindings (list[EngineParamBindingPayloadV2]): List of parameter bindings Example: [{'array_value':
            [{'literal': 'SEV123', 'reference': 'incident.severity'}], 'value': {'literal': 'SEV123', 'reference':
            'incident.severity'}}].
        for_each (str | Unset): Reference to an expression that returns resources to run this step over Example: abc123.
    """

    id: str
    name: str
    param_bindings: list[EngineParamBindingPayloadV2]
    for_each: str | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        step_config_payload_v2.additional_properties = d
        return step_config_payload_v2
