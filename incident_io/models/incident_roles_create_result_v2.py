...
T = TypeVar("T", bound="IncidentRolesCreateResultV2")
...
class IncidentRolesCreateResultV2:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        incident_roles_create_result_v2 = cls(
            incident_role=incident_role,
        )

        incident_roles_create_result_v2.additional_properties = d
        return incident_roles_create_result_v2
