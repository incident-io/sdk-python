...
T = TypeVar("T", bound="ScheduleSyncTargetsCreateResultV2")


@_attrs_define
class ScheduleSyncTargetsCreateResultV2:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        schedule_sync_targets_create_result_v2 = cls(
            schedule_sync_target=schedule_sync_target,
        )

        schedule_sync_targets_create_result_v2.additional_properties = d
        return schedule_sync_targets_create_result_v2
