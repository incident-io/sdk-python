...
from ..models.policies_create_payload_v2_policy_type import (
    PoliciesCreatePayloadV2PolicyType,
)
from ..models.policies_create_payload_v2_status import PoliciesCreatePayloadV2Status
...
T = TypeVar("T", bound="PoliciesCreatePayloadV2")
...
class PoliciesCreatePayloadV2:
    ...
    Attributes:
        ...
        policy_type (PoliciesCreatePayloadV2PolicyType): Type of the policy, specifying what this applies to. Cannot be
        ...
        status (PoliciesCreatePayloadV2Status | Unset): Defaults to enabled on create. Settable on update — there is no
    ...
    description: str
    name: str
    policy_type: PoliciesCreatePayloadV2PolicyType
    ...
    status: PoliciesCreatePayloadV2Status | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        policy_type = PoliciesCreatePayloadV2PolicyType(d.pop("policy_type"))
        ...
        status: PoliciesCreatePayloadV2Status | Unset
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = PoliciesCreatePayloadV2Status(_status)

        policies_create_payload_v2 = cls(
            conditions=conditions,
            description=description,
            name=name,
            policy_type=policy_type,
        ...
        policies_create_payload_v2.additional_properties = d
        return policies_create_payload_v2
