...
T = TypeVar("T", bound="AuditLogsFollowUpCategoryUpdatedV1")


@_attrs_define
class AuditLogsFollowUpCategoryUpdatedV1:
    """
    Example:
        {'action': 'follow_up_category.updated', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
            ...
            '2021-08-17T13:28:57.801578Z', 'targets': [{'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Category Name', 'type':
            'follow_up_category'}], 'version': 1}

    Attributes:
        action (str): The type of log entry that this is Example: follow_up_category.updated.
        ...
        targets (list[AuditLogTargetV2]): The custom field that was created Example: [{'id':
            '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Category Name', 'type': 'follow_up_category'}].
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_follow_up_category_updated_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_follow_up_category_updated_v1.additional_properties = d
        return audit_logs_follow_up_category_updated_v1
