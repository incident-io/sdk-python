...
from ..models.incident_template_custom_field_binding_v1_merge_strategy import (
...
T = TypeVar("T", bound="IncidentTemplateCustomFieldBindingV1")
...
class IncidentTemplateCustomFieldBindingV1:
    ...
    Attributes:
        ...
        merge_strategy (IncidentTemplateCustomFieldBindingV1MergeStrategy): The strategy to use when multiple alerts
            match this route Example: first-wins.
    """

    binding: EngineParamBindingV3
    custom_field_id: str
    merge_strategy: IncidentTemplateCustomFieldBindingV1MergeStrategy
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        incident_template_custom_field_binding_v1 = cls(
            binding=binding,
            custom_field_id=custom_field_id,
            merge_strategy=merge_strategy,
        )

        incident_template_custom_field_binding_v1.additional_properties = d
        return incident_template_custom_field_binding_v1
