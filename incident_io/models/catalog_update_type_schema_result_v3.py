...
T = TypeVar("T", bound="CatalogUpdateTypeSchemaResultV3")


@_attrs_define(kw_only=True)
class CatalogUpdateTypeSchemaResultV3:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        catalog_update_type_schema_result_v3 = cls(
            catalog_type=catalog_type,
        )

        catalog_update_type_schema_result_v3.additional_properties = d
        return catalog_update_type_schema_result_v3
