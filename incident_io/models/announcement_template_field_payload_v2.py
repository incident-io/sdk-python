...
from ..models.announcement_template_field_payload_v2_field_type import (
...
T = TypeVar("T", bound="AnnouncementTemplateFieldPayloadV2")
...
class AnnouncementTemplateFieldPayloadV2:
    ...
    Attributes:
        field_type (AnnouncementTemplateFieldPayloadV2FieldType): Type of this field Example:
            announcement_post_fields_status.
        rank (int): Position of this field on the post, lowest first Example: 1.
        custom_field_id (str | Unset): ID of the custom field to show. Required for custom field fields. Example:
            01FCNDV6P870EA6S7TK1DSYDG0.
        emoji (str | Unset): Emoji shown next to this field, as a Slack emoji name Example: fire.
        incident_role_id (str | Unset): ID of the incident role to show. Required for incident role fields. Example:
            01FCNDV6P870EA6S7TK1DSYDG0.
        incident_timestamp_id (str | Unset): ID of the incident timestamp to show. Required for incident timestamp
            fields. Example: 01FCNDV6P870EA6S7TK1DSYDG0.
    ...
    field_type: AnnouncementTemplateFieldPayloadV2FieldType
    rank: int
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        d = dict(src_dict)
        field_type = AnnouncementTemplateFieldPayloadV2FieldType(d.pop("field_type"))
        ...
        announcement_template_field_payload_v2 = cls(
            field_type=field_type,
            rank=rank,
        ...
        announcement_template_field_payload_v2.additional_properties = d
        return announcement_template_field_payload_v2
