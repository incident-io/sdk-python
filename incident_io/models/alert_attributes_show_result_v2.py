...
T = TypeVar("T", bound="AlertAttributesShowResultV2")


@_attrs_define(kw_only=True)
class AlertAttributesShowResultV2:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        alert_attributes_show_result_v2 = cls(
            alert_attribute=alert_attribute,
        )

        alert_attributes_show_result_v2.additional_properties = d
        return alert_attributes_show_result_v2
