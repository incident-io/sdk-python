...
if TYPE_CHECKING:
    from ..models.incident_template_auto_generated_binding_v1 import (
        IncidentTemplateAutoGeneratedBindingV1,
    )
    from ..models.incident_template_binding_v1 import IncidentTemplateBindingV1
    from ..models.incident_template_custom_field_binding_v1 import (
        IncidentTemplateCustomFieldBindingV1,
    )
    from ..models.incident_template_severity_binding_v1 import (
        IncidentTemplateSeverityBindingV1,
    )


T = TypeVar("T", bound="IncidentTemplateConfigV1")


@_attrs_define
class IncidentTemplateConfigV1:
    ...
    Attributes:
        name (IncidentTemplateAutoGeneratedBindingV1):  Example: {'autogenerated': False, 'binding': {'array_value':
            [{'literal': 'SEV123', 'reference': 'incident.severity'}], 'value': {'literal': 'SEV123', 'reference':
            'incident.severity'}}}.
        custom_fields (list[IncidentTemplateCustomFieldBindingV1] | Unset): Custom fields configuration Example:
            ...
            'first-wins'}].
        incident_mode (IncidentTemplateBindingV1 | Unset):  Example: {'binding': {'array_value': [{'literal': 'SEV123',
            'reference': 'incident.severity'}], 'value': {'literal': 'SEV123', 'reference': 'incident.severity'}}}.
        incident_type (IncidentTemplateBindingV1 | Unset):  Example: {'binding': {'array_value': [{'literal': 'SEV123',
            'reference': 'incident.severity'}], 'value': {'literal': 'SEV123', 'reference': 'incident.severity'}}}.
        severity (IncidentTemplateSeverityBindingV1 | Unset):  Example: {'binding': {'array_value': [{'literal':
            'SEV123', 'reference': 'incident.severity'}], 'value': {'literal': 'SEV123', 'reference': 'incident.severity'}},
            'merge_strategy': 'first-wins'}.
        start_in_triage (IncidentTemplateBindingV1 | Unset):  Example: {'binding': {'array_value': [{'literal':
            'SEV123', 'reference': 'incident.severity'}], 'value': {'literal': 'SEV123', 'reference':
            'incident.severity'}}}.
        summary (IncidentTemplateAutoGeneratedBindingV1 | Unset):  Example: {'autogenerated': False, 'binding':
            {'array_value': [{'literal': 'SEV123', 'reference': 'incident.severity'}], 'value': {'literal': 'SEV123',
            'reference': 'incident.severity'}}}.
        workspace (IncidentTemplateBindingV1 | Unset):  Example: {'binding': {'array_value': [{'literal': 'SEV123',
            'reference': 'incident.severity'}], 'value': {'literal': 'SEV123', 'reference': 'incident.severity'}}}.
    """

    name: IncidentTemplateAutoGeneratedBindingV1
    custom_fields: list[IncidentTemplateCustomFieldBindingV1] | Unset = UNSET
    incident_mode: IncidentTemplateBindingV1 | Unset = UNSET
    incident_type: IncidentTemplateBindingV1 | Unset = UNSET
    severity: IncidentTemplateSeverityBindingV1 | Unset = UNSET
    start_in_triage: IncidentTemplateBindingV1 | Unset = UNSET
    summary: IncidentTemplateAutoGeneratedBindingV1 | Unset = UNSET
    workspace: IncidentTemplateBindingV1 | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        from ..models.incident_template_binding_v1 import (
        ...
        d = dict(src_dict)
        name = IncidentTemplateAutoGeneratedBindingV1.from_dict(d.pop("name"))
        ...
        if _custom_fields is not UNSET:
            ...
            for custom_fields_item_data in _custom_fields:
                custom_fields_item = IncidentTemplateCustomFieldBindingV1.from_dict(
        ...
        incident_mode: IncidentTemplateBindingV1 | Unset
        if isinstance(_incident_mode, Unset):
            incident_mode = UNSET
        else:
            incident_mode = IncidentTemplateBindingV1.from_dict(_incident_mode)

        _incident_type = d.pop("incident_type", UNSET)
        incident_type: IncidentTemplateBindingV1 | Unset
        if isinstance(_incident_type, Unset):
            incident_type = UNSET
        else:
            incident_type = IncidentTemplateBindingV1.from_dict(_incident_type)

        _severity = d.pop("severity", UNSET)
        severity: IncidentTemplateSeverityBindingV1 | Unset
        if isinstance(_severity, Unset):
            severity = UNSET
        else:
            severity = IncidentTemplateSeverityBindingV1.from_dict(_severity)

        _start_in_triage = d.pop("start_in_triage", UNSET)
        start_in_triage: IncidentTemplateBindingV1 | Unset
        if isinstance(_start_in_triage, Unset):
            start_in_triage = UNSET
        else:
            start_in_triage = IncidentTemplateBindingV1.from_dict(_start_in_triage)

        _summary = d.pop("summary", UNSET)
        summary: IncidentTemplateAutoGeneratedBindingV1 | Unset
        if isinstance(_summary, Unset):
            summary = UNSET
        else:
            summary = IncidentTemplateAutoGeneratedBindingV1.from_dict(_summary)

        _workspace = d.pop("workspace", UNSET)
        workspace: IncidentTemplateBindingV1 | Unset
        if isinstance(_workspace, Unset):
            workspace = UNSET
        else:
            workspace = IncidentTemplateBindingV1.from_dict(_workspace)

        incident_template_config_v1 = cls(
            name=name,
        ...
        incident_template_config_v1.additional_properties = d
        return incident_template_config_v1
