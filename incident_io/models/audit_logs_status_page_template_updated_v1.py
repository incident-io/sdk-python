...
T = TypeVar("T", bound="AuditLogsStatusPageTemplateUpdatedV1")


@_attrs_define(kw_only=True)
class AuditLogsStatusPageTemplateUpdatedV1:
    """
    Example:
        {'action': 'status_page_template.updated', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
    ...
    Attributes:
        action (str): The type of log entry that this is Example: status_page_template.updated.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_status_page_template_updated_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_status_page_template_updated_v1.additional_properties = d
        return audit_logs_status_page_template_updated_v1
