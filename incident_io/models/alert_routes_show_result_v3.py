...
T = TypeVar("T", bound="AlertRoutesShowResultV3")


@_attrs_define
class AlertRoutesShowResultV3:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        alert_routes_show_result_v3 = cls(
            alert_route=alert_route,
        )

        alert_routes_show_result_v3.additional_properties = d
        return alert_routes_show_result_v3
