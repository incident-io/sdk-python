...
if TYPE_CHECKING:
    ...
    from ..models.audit_log_schedule_override_metadata_v2 import (
        AuditLogScheduleOverrideMetadataV2,
    )
    from ..models.audit_log_target_v2 import AuditLogTargetV2


T = TypeVar("T", bound="AuditLogsScheduleOverrideUpdatedV2")


@_attrs_define
class AuditLogsScheduleOverrideUpdatedV2:
    """
    Example:
        {'action': 'schedule_override.updated', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
            ...
            '2026-03-02T08:00:00Z', 'start_at': '2026-03-01T18:00:00Z'}, 'occurred_at': '2021-08-17T13:28:57.801578Z',
            'targets': [{'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Override for Urgent Support', 'type':
            'schedule_override'}], 'version': 2}

    Attributes:
        action (str): The type of log entry that this is Example: schedule_override.updated.
        ...
        metadata (AuditLogScheduleOverrideMetadataV2):  Example: {'after_user_ids': '01FCNDV6P870EA6S7TK1DSYDG2',
            'after_user_names': 'Nicole C', 'before_user_ids': '01FCNDV6P870EA6S7TK1DSYDG0,01FCNDV6P870EA6S7TK1DSYDG1',
            'before_user_names': 'Nicole A,Nicole B', 'end_at': '2026-03-02T08:00:00Z', 'start_at': '2026-03-01T18:00:00Z'}.
        ...
        targets (list[AuditLogTargetV2]): The custom field that was created Example: [{'id':
            '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Override for Urgent Support', 'type': 'schedule_override'}].
    ...
    metadata: AuditLogScheduleOverrideMetadataV2
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        metadata = AuditLogScheduleOverrideMetadataV2.from_dict(d.pop("metadata"))
        ...
        audit_logs_schedule_override_updated_v2 = cls(
            action=action,
            actor=actor,
            context=context,
            metadata=metadata,
        ...
        audit_logs_schedule_override_updated_v2.additional_properties = d
        return audit_logs_schedule_override_updated_v2
