...
T = TypeVar("T", bound="EscalationsShowPathResultV2")


@_attrs_define(kw_only=True)
class EscalationsShowPathResultV2:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        escalations_show_path_result_v2 = cls(
            escalation_path=escalation_path,
        )

        escalations_show_path_result_v2.additional_properties = d
        return escalations_show_path_result_v2
