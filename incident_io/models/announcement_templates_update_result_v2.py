...
T = TypeVar("T", bound="AnnouncementTemplatesUpdateResultV2")


@_attrs_define(kw_only=True)
class AnnouncementTemplatesUpdateResultV2:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        announcement_templates_update_result_v2 = cls(
            announcement_template=announcement_template,
        )

        announcement_templates_update_result_v2.additional_properties = d
        return announcement_templates_update_result_v2
