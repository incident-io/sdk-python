...
from ..models.action_v3_status import ActionV3Status
...
class ActionV3:
    ...
    Attributes:
        ...
        status (ActionV3Status): Status of the action Example: outstanding.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        status = ActionV3Status(d.pop("status"))
        ...
        action_v3.additional_properties = d
        return action_v3
