...
T = TypeVar("T", bound="IncidentsV2ListSeverity")


@_attrs_define(kw_only=True)
class IncidentsV2ListSeverity:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        d = dict(src_dict)
        incidents_v2_list_severity = cls()
        ...
        incidents_v2_list_severity.additional_properties = additional_properties
        return incidents_v2_list_severity
