...
T = TypeVar("T", bound="AlertNotesCreateResultV1")
...
class AlertNotesCreateResultV1:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        alert_notes_create_result_v1 = cls(
            alert_note=alert_note,
        )

        alert_notes_create_result_v1.additional_properties = d
        return alert_notes_create_result_v1
