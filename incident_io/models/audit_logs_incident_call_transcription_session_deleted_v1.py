...
T = TypeVar("T", bound="AuditLogsIncidentCallTranscriptionSessionDeletedV1")


@_attrs_define
class AuditLogsIncidentCallTranscriptionSessionDeletedV1:
    """
    Example:
        {'action': 'incident_call_transcription_session.deleted', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0',
            ...
            '2021-08-17T13:28:57.801578Z', 'targets': [{'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Call transcription
            session', 'type': 'incident_call_transcription_session'}], 'version': 1}

    Attributes:
        action (str): The type of log entry that this is Example: incident_call_transcription_session.deleted.
        ...
        targets (list[AuditLogTargetV2]): The custom field that was created Example: [{'id':
            '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Call transcription session', 'type':
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_incident_call_transcription_session_deleted_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_incident_call_transcription_session_deleted_v1.additional_properties = d
        return audit_logs_incident_call_transcription_session_deleted_v1
