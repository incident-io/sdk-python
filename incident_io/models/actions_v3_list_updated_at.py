...
T = TypeVar("T", bound="ActionsV3ListUpdatedAt")


@_attrs_define
class ActionsV3ListUpdatedAt:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        d = dict(src_dict)
        actions_v3_list_updated_at = cls()
        ...
        actions_v3_list_updated_at.additional_properties = additional_properties
        return actions_v3_list_updated_at
