...
T = TypeVar("T", bound="AlertsRemoveTagsResultV2")


@_attrs_define
class AlertsRemoveTagsResultV2:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        alerts_remove_tags_result_v2 = cls(
            alert=alert,
        )

        alerts_remove_tags_result_v2.additional_properties = d
        return alerts_remove_tags_result_v2
