...
class EscalationPathTargetV2:
    ...
    Attributes:
        ...
        schedule_mode (EscalationPathTargetV2ScheduleMode | Unset): Only set for schedule targets, this specifies which
            users to fetch from the schedule. Use currently_on_call to notify whoever is on call right now across the
            schedule, all_users to notify every user attached to the schedule, or all_users_for_rota /
            currently_on_call_for_rota / next_on_call_for_rota to scope to a specific rota (in which case selected_rota_id
            is required). next_on_call notifies whoever is next on call across the schedule. Example: currently_on_call.
    ...
    schedule_mode: EscalationPathTargetV2ScheduleMode | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        schedule_mode: EscalationPathTargetV2ScheduleMode | Unset
