...
T = TypeVar("T", bound="IncidentRolesUpdatePayloadV1")
...
class IncidentRolesUpdatePayloadV1:
    ...
    Attributes:
        ...
        shortform (str): Short human readable name for Slack. Note that this will be empty for the 'reporter' role.
            Example: lead.
        required (bool | Unset): DEPRECATED: this will always be false. Example: False.
    """
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        incident_roles_update_payload_v1 = cls(
            description=description,
            instructions=instructions,
            name=name,
            shortform=shortform,
        ...
        incident_roles_update_payload_v1.additional_properties = d
        return incident_roles_update_payload_v1
