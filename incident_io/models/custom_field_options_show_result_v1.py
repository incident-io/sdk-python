...
T = TypeVar("T", bound="CustomFieldOptionsShowResultV1")


@_attrs_define
class CustomFieldOptionsShowResultV1:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        custom_field_options_show_result_v1 = cls(
            custom_field_option=custom_field_option,
        )

        custom_field_options_show_result_v1.additional_properties = d
        return custom_field_options_show_result_v1
