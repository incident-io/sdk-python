...
T = TypeVar("T", bound="SchedulesPreviewScheduleEntriesResultV2")
...
class SchedulesPreviewScheduleEntriesResultV2:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        schedules_preview_schedule_entries_result_v2 = cls(
            schedule_entries=schedule_entries,
        )

        schedules_preview_schedule_entries_result_v2.additional_properties = d
        return schedules_preview_schedule_entries_result_v2
