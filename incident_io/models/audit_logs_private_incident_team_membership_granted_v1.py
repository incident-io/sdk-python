...
T = TypeVar("T", bound="AuditLogsPrivateIncidentTeamMembershipGrantedV1")


@_attrs_define
class AuditLogsPrivateIncidentTeamMembershipGrantedV1:
    """
    Example:
        {'action': 'private_incident_team_membership.granted', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
            ...
            '2021-08-17T13:28:57.801578Z', 'targets': [{'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Engineering Team',
            'type': 'catalog_entry'}, {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': '#INC-123 The website is slow', 'type':
            'incident'}], 'version': 1}

    Attributes:
        action (str): The type of log entry that this is Example: private_incident_team_membership.granted.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_private_incident_team_membership_granted_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_private_incident_team_membership_granted_v1.additional_properties = d
        return audit_logs_private_incident_team_membership_granted_v1
