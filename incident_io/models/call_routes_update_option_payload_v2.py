...
from ..models.call_routes_update_option_payload_v2_digit import (
...
T = TypeVar("T", bound="CallRoutesUpdateOptionPayloadV2")
...
class CallRoutesUpdateOptionPayloadV2:
    ...
    Attributes:
        digit (CallRoutesUpdateOptionPayloadV2Digit): The keypad digit a caller presses to choose this option Example:
            1.
    ...
    digit: CallRoutesUpdateOptionPayloadV2Digit
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        d = dict(src_dict)
        digit = CallRoutesUpdateOptionPayloadV2Digit(d.pop("digit"))
        ...
        call_routes_update_option_payload_v2 = cls(
            digit=digit,
            path=path,
            prompt=prompt,
        )

        call_routes_update_option_payload_v2.additional_properties = d
        return call_routes_update_option_payload_v2
