...
T = TypeVar("T", bound="MaintenanceWindowsUpdateResultV1")


@_attrs_define(kw_only=True)
class MaintenanceWindowsUpdateResultV1:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        maintenance_windows_update_result_v1 = cls(
            maintenance_window=maintenance_window,
        )

        maintenance_windows_update_result_v1.additional_properties = d
        return maintenance_windows_update_result_v1
