...
T = TypeVar("T", bound="EscalationsCreateResultV2")
...
class EscalationsCreateResultV2:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        escalations_create_result_v2 = cls(
            escalation=escalation,
        )

        escalations_create_result_v2.additional_properties = d
        return escalations_create_result_v2
