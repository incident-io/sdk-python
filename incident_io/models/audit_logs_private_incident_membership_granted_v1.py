...
T = TypeVar("T", bound="AuditLogsPrivateIncidentMembershipGrantedV1")


@_attrs_define
class AuditLogsPrivateIncidentMembershipGrantedV1:
    """
    Example:
        {'action': 'private_incident_membership.granted', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
    ...
    Attributes:
        action (str): The type of log entry that this is Example: private_incident_membership.granted.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_private_incident_membership_granted_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_private_incident_membership_granted_v1.additional_properties = d
        return audit_logs_private_incident_membership_granted_v1
