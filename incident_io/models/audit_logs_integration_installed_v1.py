...
T = TypeVar("T", bound="AuditLogsIntegrationInstalledV1")


@_attrs_define
class AuditLogsIntegrationInstalledV1:
    """
    Example:
        {'action': 'integration.installed', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
    ...
    Attributes:
        action (str): The type of log entry that this is Example: integration.installed.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_integration_installed_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_integration_installed_v1.additional_properties = d
        return audit_logs_integration_installed_v1
