...
T = TypeVar("T", bound="AuditLogsAlertRouteUpdatedV1")


@_attrs_define(kw_only=True)
class AuditLogsAlertRouteUpdatedV1:
    """
    Example:
        {'action': 'alert_route.updated', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
            ...
            'type': 'alert_route'}], 'version': 1}

    Attributes:
        action (str): The type of log entry that this is Example: alert_route.updated.
        ...
        targets (list[AuditLogTargetV2]): The custom field that was created Example: [{'id':
            '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Production incidents', 'type': 'alert_route'}].
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_alert_route_updated_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_alert_route_updated_v1.additional_properties = d
        return audit_logs_alert_route_updated_v1
