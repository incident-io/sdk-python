...
T = TypeVar("T", bound="CustomFieldsCreateResultV2")


@_attrs_define
class CustomFieldsCreateResultV2:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        custom_fields_create_result_v2 = cls(
            custom_field=custom_field,
        )

        custom_fields_create_result_v2.additional_properties = d
        return custom_fields_create_result_v2
