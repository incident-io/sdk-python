...
T = TypeVar("T", bound="AuditLogsIncidentRoleDeletedV1")


@_attrs_define(kw_only=True)
class AuditLogsIncidentRoleDeletedV1:
    """
    Example:
        {'action': 'incident_role.deleted', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
    ...
    Attributes:
        action (str): The type of log entry that this is Example: incident_role.deleted.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_incident_role_deleted_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_incident_role_deleted_v1.additional_properties = d
        return audit_logs_incident_role_deleted_v1
