...
from ..models.policy_due_date_config_payload_v2_calculation_type import (
...
class PolicyDueDateConfigPayloadV2:
    ...
    Attributes:
        calculation_type (PolicyDueDateConfigPayloadV2CalculationType):  Example: weekdays.
        days (EngineParamBindingPayloadV2):  Example: {'array_value': [{'literal': 'SEV123', 'reference':
    ...
    calculation_type: PolicyDueDateConfigPayloadV2CalculationType
    days: EngineParamBindingPayloadV2
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        days = EngineParamBindingPayloadV2.from_dict(d.pop("days"))
        ...
        policy_due_date_config_payload_v2 = cls(
            calculation_type=calculation_type,
            days=days,
            incident_timestamp_id=incident_timestamp_id,
        ...
        policy_due_date_config_payload_v2.additional_properties = d
        return policy_due_date_config_payload_v2
