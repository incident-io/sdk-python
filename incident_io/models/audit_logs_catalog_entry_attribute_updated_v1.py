...
if TYPE_CHECKING:
    ...
    from ..models.audit_log_catalog_attribute_updated_metadata_v2 import (
...
T = TypeVar("T", bound="AuditLogsCatalogEntryAttributeUpdatedV1")


@_attrs_define
class AuditLogsCatalogEntryAttributeUpdatedV1:
    """
    Example:
        {'action': 'catalog_entry_attribute.updated', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
            ...
            ['01FCNDV6P870EA6S7TK1DSYDG0', '01FCNDV6P870EA6S7TK1DSYDG2'], 'before_values': ['01FCNDV6P870EA6S7TK1DSYDG0',
            '01FCNDV6P870EA6S7TK1DSYDG1']}, 'occurred_at': '2021-08-17T13:28:57.801578Z', 'targets': [{'id':
            ...
            'type': 'catalog_attribute'}], 'version': 1}
    ...
    Attributes:
        ...
        metadata (AuditLogCatalogAttributeUpdatedMetadataV2):  Example: {'after_values': ['01FCNDV6P870EA6S7TK1DSYDG0',
    ...
    metadata: AuditLogCatalogAttributeUpdatedMetadataV2
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        metadata = AuditLogCatalogAttributeUpdatedMetadataV2.from_dict(
            d.pop("metadata")
        )
        ...
        audit_logs_catalog_entry_attribute_updated_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            metadata=metadata,
        ...
        audit_logs_catalog_entry_attribute_updated_v1.additional_properties = d
        return audit_logs_catalog_entry_attribute_updated_v1
