...
T = TypeVar("T", bound="EscalationsV2ListEscalationPath")


@_attrs_define
class EscalationsV2ListEscalationPath:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        d = dict(src_dict)
        escalations_v2_list_escalation_path = cls()
        ...
        escalations_v2_list_escalation_path.additional_properties = (
            additional_properties
        )
        return escalations_v2_list_escalation_path
