...
if TYPE_CHECKING:
    from ..models.catalog_create_entry_payload_v3_attribute_values import (
        CatalogCreateEntryPayloadV3AttributeValues,
    )


T = TypeVar("T", bound="CatalogCreateEntryPayloadV3")
...
class CatalogCreateEntryPayloadV3:
    ...
    Attributes:
        attribute_values (CatalogCreateEntryPayloadV3AttributeValues): Values of this entry Example: {'abc123':
    ...
    attribute_values: CatalogCreateEntryPayloadV3AttributeValues
    catalog_type_id: str
    name: str
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        d = dict(src_dict)
        attribute_values = CatalogCreateEntryPayloadV3AttributeValues.from_dict(
        ...
        catalog_create_entry_payload_v3 = cls(
            attribute_values=attribute_values,
            catalog_type_id=catalog_type_id,
            name=name,
            aliases=aliases,
        ...
        catalog_create_entry_payload_v3.additional_properties = d
        return catalog_create_entry_payload_v3
