...
T = TypeVar("T", bound="ConditionOperationV3")


@_attrs_define(kw_only=True)
class ConditionOperationV3:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        condition_operation_v3 = cls(
            label=label,
            value=value,
        )

        condition_operation_v3.additional_properties = d
        return condition_operation_v3
