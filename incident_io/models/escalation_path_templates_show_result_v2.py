...
T = TypeVar("T", bound="EscalationPathTemplatesShowResultV2")


@_attrs_define
class EscalationPathTemplatesShowResultV2:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        escalation_path_templates_show_result_v2 = cls(
            escalation_path_template=escalation_path_template,
        )

        escalation_path_templates_show_result_v2.additional_properties = d
        return escalation_path_templates_show_result_v2
