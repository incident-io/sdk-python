...
from ..models.status_page_incident_affected_component_v2_component_status import (
...
class StatusPageIncidentAffectedComponentV2:
    ...
    Attributes:
        ...
        component_status (StatusPageIncidentAffectedComponentV2ComponentStatus): The status of the relevant component in
            a status page incident Example: operational.
    """

    component_id: str
    component_status: StatusPageIncidentAffectedComponentV2ComponentStatus
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        status_page_incident_affected_component_v2 = cls(
            component_id=component_id,
            component_status=component_status,
        )

        status_page_incident_affected_component_v2.additional_properties = d
        return status_page_incident_affected_component_v2
