...
T = TypeVar("T", bound="IncidentWithStatusChangeV2")
...
class IncidentWithStatusChangeV2:
    ...
    Example:
        {'incident': {'call_url': 'https://zoom.us/foo', 'created_at': '2021-08-17T13:28:57.801578Z', 'creator':
            ...
            workflow'}}, 'custom_field_entries': [{'custom_field': {'description': 'Which team is impacted by this issue',
            ...
            'Product'}]}, 'values': [{'value_catalog_entry': {'aliases': ['lawrence@incident.io', 'lawrence'],
            'external_id': '761722cd-d1d7-477b-ac7e-90f9e079dc33', 'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Primary On-
            call'}, 'value_link': 'https://google.com/', 'value_numeric': '123.456', 'value_option': {'custom_field_id':
    ...
    Attributes:
        ...
        new_status (IncidentStatusV2):  Example: {'category': 'triage', 'created_at': '2021-08-17T13:28:57.801578Z',
        ...
        previous_status (IncidentStatusV2):  Example: {'category': 'triage', 'created_at':
            '2021-08-17T13:28:57.801578Z', 'description': "Impact has been **fully mitigated**, and we're ready to learn
            from this incident.", 'id': '01FCNDV6P870EA6S7TK1DSYD5H', 'name': 'Closed', 'rank': 4, 'updated_at':
            '2021-08-17T13:28:57.801578Z'}.
        message (str | Unset): Message that explains the context behind the update Example: We're working on a fix,
            hoping to ship in the next 30 minutes.
    """
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        previous_status = IncidentStatusV2.from_dict(d.pop("previous_status"))

        message = d.pop("message", UNSET)

        incident_with_status_change_v2 = cls(
            incident=incident,
            new_status=new_status,
            previous_status=previous_status,
            message=message,
        ...
        incident_with_status_change_v2.additional_properties = d
