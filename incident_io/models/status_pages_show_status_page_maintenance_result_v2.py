...
T = TypeVar("T", bound="StatusPagesShowStatusPageMaintenanceResultV2")


@_attrs_define(kw_only=True)
class StatusPagesShowStatusPageMaintenanceResultV2:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        status_pages_show_status_page_maintenance_result_v2 = cls(
            status_page_maintenance=status_page_maintenance,
        )

        status_pages_show_status_page_maintenance_result_v2.additional_properties = d
        return status_pages_show_status_page_maintenance_result_v2
