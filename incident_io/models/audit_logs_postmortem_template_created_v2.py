...
T = TypeVar("T", bound="AuditLogsPostmortemTemplateCreatedV2")


@_attrs_define
class AuditLogsPostmortemTemplateCreatedV2:
    """
    Example:
        {'action': 'postmortem_template.created', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
    ...
    Attributes:
        action (str): The type of log entry that this is Example: postmortem_template.created.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_postmortem_template_created_v2 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_postmortem_template_created_v2.additional_properties = d
        return audit_logs_postmortem_template_created_v2
