...
if TYPE_CHECKING:
    ...
    from ..models.audit_log_microsoft_entra_tenant_linked_metadata_v2 import (
        AuditLogMicrosoftEntraTenantLinkedMetadataV2,
    )
    from ..models.audit_log_target_v2 import AuditLogTargetV2


T = TypeVar("T", bound="AuditLogsMicrosoftEntraTenantLinkedV1")


@_attrs_define
class AuditLogsMicrosoftEntraTenantLinkedV1:
    """
    Example:
        {'action': 'microsoft_entra_tenant.linked', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
            {'user_base_role_slug': 'admin', 'user_custom_role_slugs': 'engineering,security'}, 'name': 'John Doe', 'type':
            'user'}, 'context': {'location': '1.2.3.4', 'user_agent': 'Chrome/91.0.4472.114'}, 'metadata': {'tenant_domain':
            'acme.com', 'tenant_id': 'f339c180-eee9-4e7d-95eb-d19a69b9a922'}, 'occurred_at': '2021-08-17T13:28:57.801578Z',
            'targets': [{'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Organisation', 'type': 'organisation'}], 'version': 1}

    Attributes:
        action (str): The type of log entry that this is Example: microsoft_entra_tenant.linked.
        ...
        metadata (AuditLogMicrosoftEntraTenantLinkedMetadataV2):  Example: {'tenant_domain': 'acme.com', 'tenant_id':
    ...
    metadata: AuditLogMicrosoftEntraTenantLinkedMetadataV2
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        metadata = AuditLogMicrosoftEntraTenantLinkedMetadataV2.from_dict(
            d.pop("metadata")
        )
        ...
        audit_logs_microsoft_entra_tenant_linked_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            metadata=metadata,
        ...
        audit_logs_microsoft_entra_tenant_linked_v1.additional_properties = d
        return audit_logs_microsoft_entra_tenant_linked_v1
