...
T = TypeVar("T", bound="AuditLogsAlertSourceConfigDeletedV1")


@_attrs_define(kw_only=True)
class AuditLogsAlertSourceConfigDeletedV1:
    """
    Example:
        {'action': 'alert_source_config.deleted', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
    ...
    Attributes:
        action (str): The type of log entry that this is Example: alert_source_config.deleted.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_alert_source_config_deleted_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_alert_source_config_deleted_v1.additional_properties = d
        return audit_logs_alert_source_config_deleted_v1
