...
from ..models.escalation_path_node_level_v2_ack_mode import (
...
class EscalationPathNodeLevelV2:
    ...
    Attributes:
        ...
        ack_mode (EscalationPathNodeLevelV2AckMode | Unset): Controls the behaviour of acknowledgements for this level,
            with 'first' cancelling all other escalations on the same level when someone acks Example: all.
        ...
        time_to_ack_interval_condition (EscalationPathNodeLevelV2TimeToAckIntervalCondition | Unset): If the time to ack
            is relative to a time window, this defines whether we move when the window is active or inactive Example:
            active.
    ...
    ack_mode: EscalationPathNodeLevelV2AckMode | Unset = UNSET
    ...
    time_to_ack_interval_condition: (
        EscalationPathNodeLevelV2TimeToAckIntervalCondition | Unset
    ) = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        from ..models.escalation_path_target_v2 import (
        ...
        ack_mode: EscalationPathNodeLevelV2AckMode | Unset
        if isinstance(_ack_mode, Unset):
            ack_mode = UNSET
        else:
            ack_mode = EscalationPathNodeLevelV2AckMode(_ack_mode)
