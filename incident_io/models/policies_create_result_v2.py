...
T = TypeVar("T", bound="PoliciesCreateResultV2")
...
class PoliciesCreateResultV2:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        policies_create_result_v2 = cls(
            policy=policy,
        )

        policies_create_result_v2.additional_properties = d
        return policies_create_result_v2
