...
T = TypeVar("T", bound="AuditLogsTelemetryDataSourceUninstalledV1")


@_attrs_define
class AuditLogsTelemetryDataSourceUninstalledV1:
    """
    Example:
        {'action': 'telemetry_data_source.uninstalled', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
            ...
            '2021-08-17T13:28:57.801578Z', 'targets': [{'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Grafana Cloud', 'type':
            'telemetry_data_source'}], 'version': 1}

    Attributes:
        action (str): The type of log entry that this is Example: telemetry_data_source.uninstalled.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_telemetry_data_source_uninstalled_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_telemetry_data_source_uninstalled_v1.additional_properties = d
        return audit_logs_telemetry_data_source_uninstalled_v1
