...
if TYPE_CHECKING:
    ...
    from ..models.audit_log_extension_connector_called_metadata_v2 import (
        AuditLogExtensionConnectorCalledMetadataV2,
    )
    from ..models.audit_log_target_v2 import AuditLogTargetV2


T = TypeVar("T", bound="AuditLogsExtensionConnectorCalledV1")


@_attrs_define(kw_only=True)
class AuditLogsExtensionConnectorCalledV1:
    """
    Example:
        {'action': 'extension_connector.called', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
            ...
            'user'}, 'context': {'location': '1.2.3.4', 'user_agent': 'Chrome/91.0.4472.114'}, 'metadata': {'outcome':
            'success', 'source_kind': 'mcp', 'surface': 'chat', 'telemetry_query_id': '01FCNDV6P870EA6S7TK1DSYDG0', 'write':
            'true'}, 'occurred_at': '2021-08-17T13:28:57.801578Z', 'targets': [{'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name':
            'Acme Deploy', 'type': 'extension_connector'}, {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'restart_service',
            'type': 'extension_connector_tool'}], 'version': 1}
    ...
    Attributes:
        ...
        metadata (AuditLogExtensionConnectorCalledMetadataV2):  Example: {'outcome': 'success', 'source_kind': 'mcp',
            'surface': 'chat', 'telemetry_query_id': '01FCNDV6P870EA6S7TK1DSYDG0', 'write': 'true'}.
    ...
    metadata: AuditLogExtensionConnectorCalledMetadataV2
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        metadata = AuditLogExtensionConnectorCalledMetadataV2.from_dict(
            d.pop("metadata")
        )
        ...
        audit_logs_extension_connector_called_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            metadata=metadata,
        ...
        audit_logs_extension_connector_called_v1.additional_properties = d
        return audit_logs_extension_connector_called_v1
