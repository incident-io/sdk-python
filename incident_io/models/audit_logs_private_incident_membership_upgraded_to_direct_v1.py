...
T = TypeVar("T", bound="AuditLogsPrivateIncidentMembershipUpgradedToDirectV1")


@_attrs_define
class AuditLogsPrivateIncidentMembershipUpgradedToDirectV1:
    """
    Example:
        {'action': 'private_incident_membership.upgraded_to_direct', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0',
            'metadata': {'user_base_role_slug': 'admin', 'user_custom_role_slugs': 'engineering,security'}, 'name': 'John
            Doe', 'type': 'user'}, 'context': {'location': '1.2.3.4', 'user_agent': 'Chrome/91.0.4472.114'}, 'occurred_at':
            '2021-08-17T13:28:57.801578Z', 'targets': [{'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Bob the builder',
            'type': 'user'}, {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': '#INC-123 The website is slow', 'type':
            'incident'}], 'version': 1}

    Attributes:
        action (str): The type of log entry that this is Example: private_incident_membership.upgraded_to_direct.
        ...
        targets (list[AuditLogTargetV2]): The custom field that was created Example: [{'id':
            '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Bob the builder', 'type': 'user'}, {'id': '01FCNDV6P870EA6S7TK1DSYDG0',
            'name': '#INC-123 The website is slow', 'type': 'incident'}].
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_private_incident_membership_upgraded_to_direct_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_private_incident_membership_upgraded_to_direct_v1.additional_properties = d
        return audit_logs_private_incident_membership_upgraded_to_direct_v1
