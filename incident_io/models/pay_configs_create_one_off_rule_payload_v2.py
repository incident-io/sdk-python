...
class PayConfigsCreateOneOffRulePayloadV2:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        pay_configs_create_one_off_rule_payload_v2 = cls(
            end_at=end_at,
            name=name,
            rate_cents=rate_cents,
            start_at=start_at,
        ...
        pay_configs_create_one_off_rule_payload_v2.additional_properties = d
        return pay_configs_create_one_off_rule_payload_v2
