...
T = TypeVar("T", bound="SeveritiesCreatePayloadV1")


@_attrs_define(kw_only=True)
class SeveritiesCreatePayloadV1:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        severities_create_payload_v1 = cls(
            description=description,
            name=name,
            rank=rank,
        )

        severities_create_payload_v1.additional_properties = d
        return severities_create_payload_v1
