...
T = TypeVar("T", bound="AuditLogsStatusPageUpdatedV1")


@_attrs_define
class AuditLogsStatusPageUpdatedV1:
    """
    Example:
        {'action': 'status_page.updated', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
            ...
            'status_page'}], 'version': 1}

    Attributes:
        action (str): The type of log entry that this is Example: status_page.updated.
        ...
        targets (list[AuditLogTargetV2]): The custom field that was created Example: [{'id':
            '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Public Page', 'type': 'status_page'}].
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_status_page_updated_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_status_page_updated_v1.additional_properties = d
        return audit_logs_status_page_updated_v1
