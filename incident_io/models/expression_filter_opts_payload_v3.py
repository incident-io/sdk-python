...
T = TypeVar("T", bound="ExpressionFilterOptsPayloadV3")
...
class ExpressionFilterOptsPayloadV3:
    ...
    Attributes:
        condition_groups (list[ConditionGroupPayloadV3]): The condition groups to apply in this filter. Only one group
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        expression_filter_opts_payload_v3 = cls(
            condition_groups=condition_groups,
        )

        expression_filter_opts_payload_v3.additional_properties = d
        return expression_filter_opts_payload_v3
