...
T = TypeVar("T", bound="AlertRouteTemplateBindingPayloadV3")
...
class AlertRouteTemplateBindingPayloadV3:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        alert_route_template_binding_payload_v3 = cls(
            binding=binding,
        )

        alert_route_template_binding_payload_v3.additional_properties = d
        return alert_route_template_binding_payload_v3
