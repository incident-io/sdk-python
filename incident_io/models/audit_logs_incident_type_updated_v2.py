...
T = TypeVar("T", bound="AuditLogsIncidentTypeUpdatedV2")


@_attrs_define
class AuditLogsIncidentTypeUpdatedV2:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_incident_type_updated_v2 = cls(
            action=action,
            actor=actor,
            context=context,
            metadata=metadata,
        ...
        audit_logs_incident_type_updated_v2.additional_properties = d
        return audit_logs_incident_type_updated_v2
