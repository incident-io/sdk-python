...
T = TypeVar("T", bound="PolicyAssignmentRulesV2")
...
class PolicyAssignmentRulesV2:
    ...
    Attributes:
        bindings (list[EngineParamBindingV2]): Bindings which define the user to be assigned. We will assign the first
            user which evaluates; the rest are fallback values Example: [{'array_value': [{'label': 'Lawrence Jones',
    ...
    bindings: list[EngineParamBindingV2]
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for bindings_item_data in _bindings:
            bindings_item = EngineParamBindingV2.from_dict(bindings_item_data)
        ...
        policy_assignment_rules_v2 = cls(
            bindings=bindings,
            reminder_due_date_offset_hours=reminder_due_date_offset_hours,
        ...
        policy_assignment_rules_v2.additional_properties = d
        return policy_assignment_rules_v2
