...
T = TypeVar("T", bound="AlertsResolveResultV2")


@_attrs_define
class AlertsResolveResultV2:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        alerts_resolve_result_v2 = cls(
            alert=alert,
        )

        alerts_resolve_result_v2.additional_properties = d
        return alerts_resolve_result_v2
