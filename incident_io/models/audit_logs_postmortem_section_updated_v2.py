...
T = TypeVar("T", bound="AuditLogsPostmortemSectionUpdatedV2")


@_attrs_define(kw_only=True)
class AuditLogsPostmortemSectionUpdatedV2:
    """
    Example:
        {'action': 'postmortem_section.updated', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
            ...
            '2021-08-17T13:28:57.801578Z', 'targets': [{'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'follow_ups', 'type':
            'postmortem_template_section'}], 'version': 2}

    Attributes:
        action (str): The type of log entry that this is Example: postmortem_section.updated.
        ...
        targets (list[AuditLogTargetV2]): The custom field that was created Example: [{'id':
            '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'follow_ups', 'type': 'postmortem_template_section'}].
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_postmortem_section_updated_v2 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_postmortem_section_updated_v2.additional_properties = d
        return audit_logs_postmortem_section_updated_v2
