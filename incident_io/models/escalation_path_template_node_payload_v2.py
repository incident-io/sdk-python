...
from ..models.escalation_path_template_node_payload_v2_type import (
...
if TYPE_CHECKING:
    ...
    from ..models.escalation_path_node_level_with_binding_payload_v2 import (
        EscalationPathNodeLevelWithBindingPayloadV2,
    )
    from ..models.escalation_path_node_notify_channel_with_binding_payload_v2 import (
    ...
    from ..models.escalation_path_template_node_if_else_payload_v2 import (
...
class EscalationPathTemplateNodePayloadV2:
    ...
    Attributes:
        ...
        type_ (EscalationPathTemplateNodePayloadV2Type): The type of this node. Available types are:
        ...
        escalation_path (EscalationPathNodeEscalationPathV2 | Unset):  Example: {'escalation_path_id':
            '01FCNDV6P870EA6S7TK1DSYDG0'}.
        if_else (EscalationPathTemplateNodeIfElsePayloadV2 | Unset):  Example: {'conditions': [{'operation': 'one_of',
            ...
            'active', 'time_to_ack_seconds': 1800, 'time_to_ack_weekday_interval_config_id': '01FCNDV6P870EA6S7TK1DSYDG0'},
            'repeat': {'repeat_times': 3, 'to_node': '01FCNDV6P870EA6S7TK1DSYDG0'}, 'type': 'if_else'}]}.
        level (EscalationPathNodeLevelWithBindingPayloadV2 | Unset):  Example: {'ack_mode': 'all', 'retry_config':
        ...
        notify_channel (EscalationPathNodeNotifyChannelWithBindingPayloadV2 | Unset):  Example: {'targets': [{'binding':
            {'array_value': [{'literal': 'SEV123', 'reference': 'incident.severity'}], 'value': {'literal': 'SEV123',
    ...
    id: str
    type_: EscalationPathTemplateNodePayloadV2Type
    delay: EscalationPathNodeDelayV2 | Unset = UNSET
    escalation_path: EscalationPathNodeEscalationPathV2 | Unset = UNSET
    if_else: EscalationPathTemplateNodeIfElsePayloadV2 | Unset = UNSET
    level: EscalationPathNodeLevelWithBindingPayloadV2 | Unset = UNSET
    notify_channel: EscalationPathNodeNotifyChannelWithBindingPayloadV2 | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        type_ = EscalationPathTemplateNodePayloadV2Type(d.pop("type"))
        ...
        if_else: EscalationPathTemplateNodeIfElsePayloadV2 | Unset
        if isinstance(_if_else, Unset):
            if_else = UNSET
        else:
            if_else = EscalationPathTemplateNodeIfElsePayloadV2.from_dict(_if_else)

        _level = d.pop("level", UNSET)
        level: EscalationPathNodeLevelWithBindingPayloadV2 | Unset
        if isinstance(_level, Unset):
            level = UNSET
        else:
            level = EscalationPathNodeLevelWithBindingPayloadV2.from_dict(_level)

        _notify_channel = d.pop("notify_channel", UNSET)
        notify_channel: EscalationPathNodeNotifyChannelWithBindingPayloadV2 | Unset
        if isinstance(_notify_channel, Unset):
            notify_channel = UNSET
        else:
            notify_channel = (
                EscalationPathNodeNotifyChannelWithBindingPayloadV2.from_dict(
                    _notify_channel
                )
            )
        ...
        escalation_path_template_node_payload_v2 = cls(
            id=id,
            type_=type_,
            delay=delay,
        ...
        escalation_path_template_node_payload_v2.additional_properties = d
        return escalation_path_template_node_payload_v2
