...
T = TypeVar("T", bound="FollowUpsCreateResultV3")
...
class FollowUpsCreateResultV3:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        follow_ups_create_result_v3 = cls(
            follow_up=follow_up,
        )

        follow_ups_create_result_v3.additional_properties = d
        return follow_ups_create_result_v3
