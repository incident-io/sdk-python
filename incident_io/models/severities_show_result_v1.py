...
T = TypeVar("T", bound="SeveritiesShowResultV1")


@_attrs_define
class SeveritiesShowResultV1:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        severities_show_result_v1 = cls(
            severity=severity,
        )

        severities_show_result_v1.additional_properties = d
        return severities_show_result_v1
