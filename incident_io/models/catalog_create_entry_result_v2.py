...
T = TypeVar("T", bound="CatalogCreateEntryResultV2")
...
class CatalogCreateEntryResultV2:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        catalog_create_entry_result_v2 = cls(
            catalog_entry=catalog_entry,
        )

        catalog_create_entry_result_v2.additional_properties = d
        return catalog_create_entry_result_v2
