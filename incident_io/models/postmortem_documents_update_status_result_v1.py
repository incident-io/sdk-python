...
class PostmortemDocumentsUpdateStatusResultV1:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        postmortem_documents_update_status_result_v1 = cls(
            postmortem_document=postmortem_document,
        )

        postmortem_documents_update_status_result_v1.additional_properties = d
        return postmortem_documents_update_status_result_v1
