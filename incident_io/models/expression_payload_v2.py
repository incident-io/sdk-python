...
class ExpressionPayloadV2:
    ...
    Attributes:
        ...
        root_reference (str): The root reference for this expression (i.e. where the expression starts) Example:
            incident.status.
        else_branch (ExpressionElseBranchPayloadV2 | Unset):  Example: {'result': {'array_value': [{'literal': 'SEV123',
    ...
    reference: str
    root_reference: str
    else_branch: ExpressionElseBranchPayloadV2 | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        else_branch: ExpressionElseBranchPayloadV2 | Unset
