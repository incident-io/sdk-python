...
if TYPE_CHECKING:
    ...
    from ..models.audit_log_qr_code_mobile_login_setting_updated_metadata_v2 import (
        AuditLogQrCodeMobileLoginSettingUpdatedMetadataV2,
    )
    from ..models.audit_log_target_v2 import AuditLogTargetV2


T = TypeVar("T", bound="AuditLogsQrCodeMobileLoginSettingUpdatedV1")


@_attrs_define
class AuditLogsQrCodeMobileLoginSettingUpdatedV1:
    """
    Example:
        {'action': 'qr_code_mobile_login_setting.updated', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
    ...
    Attributes:
        action (str): The type of log entry that this is Example: qr_code_mobile_login_setting.updated.
        ...
        metadata (AuditLogQrCodeMobileLoginSettingUpdatedMetadataV2):  Example: {'enabled': 'true'}.
    ...
    metadata: AuditLogQrCodeMobileLoginSettingUpdatedMetadataV2
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        metadata = AuditLogQrCodeMobileLoginSettingUpdatedMetadataV2.from_dict(
            d.pop("metadata")
        )
        ...
        audit_logs_qr_code_mobile_login_setting_updated_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            metadata=metadata,
        ...
        audit_logs_qr_code_mobile_login_setting_updated_v1.additional_properties = d
        return audit_logs_qr_code_mobile_login_setting_updated_v1
