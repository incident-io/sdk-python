...
from ..models.alert_route_custom_field_binding_payload_v2_merge_strategy import (
...
T = TypeVar("T", bound="AlertRouteCustomFieldBindingPayloadV2")
...
class AlertRouteCustomFieldBindingPayloadV2:
    ...
    Attributes:
        ...
        merge_strategy (AlertRouteCustomFieldBindingPayloadV2MergeStrategy): The strategy to use when multiple alerts
            match this route Example: first-wins.
    """

    binding: EngineParamBindingPayloadV2
    custom_field_id: str
    merge_strategy: AlertRouteCustomFieldBindingPayloadV2MergeStrategy
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        alert_route_custom_field_binding_payload_v2 = cls(
            binding=binding,
            custom_field_id=custom_field_id,
            merge_strategy=merge_strategy,
        )

        alert_route_custom_field_binding_payload_v2.additional_properties = d
        return alert_route_custom_field_binding_payload_v2
