...
if TYPE_CHECKING:
    ...
    from ..models.audit_log_mobile_intune_enabled_setting_updated_metadata_v2 import (
        AuditLogMobileIntuneEnabledSettingUpdatedMetadataV2,
    )
    from ..models.audit_log_target_v2 import AuditLogTargetV2


T = TypeVar("T", bound="AuditLogsMobileIntuneEnabledSettingUpdatedV1")


@_attrs_define
class AuditLogsMobileIntuneEnabledSettingUpdatedV1:
    """
    Example:
        {'action': 'mobile_intune_enabled_setting.updated', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
            {'user_base_role_slug': 'admin', 'user_custom_role_slugs': 'engineering,security'}, 'name': 'John Doe', 'type':
            'user'}, 'context': {'location': '1.2.3.4', 'user_agent': 'Chrome/91.0.4472.114'}, 'metadata': {'enabled':
            'true'}, 'occurred_at': '2021-08-17T13:28:57.801578Z', 'targets': [{'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name':
            'Organisation Settings', 'type': 'organisation_settings'}], 'version': 1}

    Attributes:
        action (str): The type of log entry that this is Example: mobile_intune_enabled_setting.updated.
        ...
        metadata (AuditLogMobileIntuneEnabledSettingUpdatedMetadataV2):  Example: {'enabled': 'true'}.
        ...
        targets (list[AuditLogTargetV2]): The custom field that was created Example: [{'id':
            '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Organisation Settings', 'type': 'organisation_settings'}].
    ...
    metadata: AuditLogMobileIntuneEnabledSettingUpdatedMetadataV2
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        metadata = AuditLogMobileIntuneEnabledSettingUpdatedMetadataV2.from_dict(
            d.pop("metadata")
        )
        ...
        audit_logs_mobile_intune_enabled_setting_updated_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            metadata=metadata,
        ...
        audit_logs_mobile_intune_enabled_setting_updated_v1.additional_properties = d
        return audit_logs_mobile_intune_enabled_setting_updated_v1
