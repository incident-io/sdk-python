...
T = TypeVar("T", bound="FollowUpsConnectExternalIssueResultV3")


@_attrs_define(kw_only=True)
class FollowUpsConnectExternalIssueResultV3:
    """
    Example:
    ...
    Attributes:
        follow_up (FollowUpV3):  Example: {'assignee': {'email': 'lisa@incident.io', 'id': '01FCNDV6P870EA6S7TK1DSYDG0',
            'name': 'Lisa Karlin Curtis', 'role': 'owner', 'slack_user_id': 'U02AYNF2XJM'}, 'assignee_team': {'id':
            'abc123', 'name': 'abc123'}, 'category': {'description': 'Follow-ups related to infrastructure changes.', 'id':
            '01GNW4BAQ7XRMFF6FHKNXDFPRW', 'name': 'Infrastructure', 'rank': 10}, 'completed_at':
            '2021-08-17T13:28:57.801578Z', 'created_at': '2021-08-17T13:28:57.801578Z', 'creator': {'alert': {'id':
            '01GW2G3V0S59R238FAHPDS1R66', 'title': '*errors.withMessage: PG::Error failed to connect'}, 'api_key': {'id':
            '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'My test API key'}, 'user': {'email': 'lisa@incident.io', 'id':
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        d = dict(src_dict)
        follow_up = FollowUpV3.from_dict(d.pop("follow_up"))

        follow_ups_connect_external_issue_result_v3 = cls(
            follow_up=follow_up,
        )

        follow_ups_connect_external_issue_result_v3.additional_properties = d
        return follow_ups_connect_external_issue_result_v3
