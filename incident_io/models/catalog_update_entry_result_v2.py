...
T = TypeVar("T", bound="CatalogUpdateEntryResultV2")


@_attrs_define
class CatalogUpdateEntryResultV2:
    """
    Example:
        {'catalog_entry': {'aliases': ['lawrence@incident.io', 'lawrence'], 'archived_at':
            ...
            'abc123'}], 'type': 'Custom["Service"]'}], 'version': 1}, 'semantic_type': 'abc123', 'source_repo_url':
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        catalog_update_entry_result_v2 = cls(
            catalog_entry=catalog_entry,
            catalog_type=catalog_type,
        )

        catalog_update_entry_result_v2.additional_properties = d
        return catalog_update_entry_result_v2
