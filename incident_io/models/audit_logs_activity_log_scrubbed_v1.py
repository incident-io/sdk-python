...
T = TypeVar("T", bound="AuditLogsActivityLogScrubbedV1")


@_attrs_define
class AuditLogsActivityLogScrubbedV1:
    """
    Example:
        {'action': 'activity_log.scrubbed', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
            ...
            '2021-08-17T13:28:57.801578Z', 'targets': [{'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Activity log entry
            (01FCNDV6P870EA6S7TK1DSYDG0)', 'type': 'activity_log'}], 'version': 1}

    Attributes:
        action (str): The type of log entry that this is Example: activity_log.scrubbed.
        ...
        targets (list[AuditLogTargetV2]): The custom field that was created Example: [{'id':
            '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Activity log entry (01FCNDV6P870EA6S7TK1DSYDG0)', 'type':
            'activity_log'}].
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_activity_log_scrubbed_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_activity_log_scrubbed_v1.additional_properties = d
        return audit_logs_activity_log_scrubbed_v1
