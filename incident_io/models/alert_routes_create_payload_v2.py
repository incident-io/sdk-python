...
T = TypeVar("T", bound="AlertRoutesCreatePayloadV2")


@_attrs_define
class AlertRoutesCreatePayloadV2:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        alert_routes_create_payload_v2 = cls(
            alert_sources=alert_sources,
            channel_config=channel_config,
            condition_groups=condition_groups,
            enabled=enabled,
        ...
        alert_routes_create_payload_v2.additional_properties = d
        return alert_routes_create_payload_v2
