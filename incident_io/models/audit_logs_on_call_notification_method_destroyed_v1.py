...
T = TypeVar("T", bound="AuditLogsOnCallNotificationMethodDestroyedV1")


@_attrs_define(kw_only=True)
class AuditLogsOnCallNotificationMethodDestroyedV1:
    """
    Example:
        {'action': 'on_call_notification_method.destroyed', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
            ...
            '2021-08-17T13:28:57.801578Z', 'targets': [{'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Phone notification
            method', 'type': 'on_call_notification_method'}, {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Bob the builder',
            'type': 'user'}], 'version': 1}
    ...
    Attributes:
        ...
        targets (list[AuditLogTargetV2]): The custom field that was created Example: [{'id':
            ...
            {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Bob the builder', 'type': 'user'}].
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_on_call_notification_method_destroyed_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_on_call_notification_method_destroyed_v1.additional_properties = d
        return audit_logs_on_call_notification_method_destroyed_v1
