...
T = TypeVar("T", bound="CatalogUpdateEntryPayloadV2AttributeValues")


@_attrs_define
class CatalogUpdateEntryPayloadV2AttributeValues:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        d = dict(src_dict)
        catalog_update_entry_payload_v2_attribute_values = cls()
        ...
        catalog_update_entry_payload_v2_attribute_values.additional_properties = (
            additional_properties
        )
        return catalog_update_entry_payload_v2_attribute_values
