...
if TYPE_CHECKING:
    ...
    from ..models.audit_log_telemetry_data_source_access_mode_changed_metadata_v2 import (
        AuditLogTelemetryDataSourceAccessModeChangedMetadataV2,
    )


T = TypeVar("T", bound="AuditLogsTelemetryDataSourceAccessModeChangedV1")


@_attrs_define
class AuditLogsTelemetryDataSourceAccessModeChangedV1:
    """
    Example:
        {'action': 'telemetry_data_source.access_mode_changed', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0',
            ...
            {'from': 'default', 'to': 'restricted'}, 'occurred_at': '2021-08-17T13:28:57.801578Z', 'targets': [{'id':
            '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Grafana Cloud', 'type': 'telemetry_data_source'}], 'version': 1}

    Attributes:
        action (str): The type of log entry that this is Example: telemetry_data_source.access_mode_changed.
        ...
        metadata (AuditLogTelemetryDataSourceAccessModeChangedMetadataV2):  Example: {'from': 'default', 'to':
            'restricted'}.
    ...
    metadata: AuditLogTelemetryDataSourceAccessModeChangedMetadataV2
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        metadata = AuditLogTelemetryDataSourceAccessModeChangedMetadataV2.from_dict(
            d.pop("metadata")
        )
        ...
        audit_logs_telemetry_data_source_access_mode_changed_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            metadata=metadata,
        ...
        audit_logs_telemetry_data_source_access_mode_changed_v1.additional_properties = d
        return audit_logs_telemetry_data_source_access_mode_changed_v1
