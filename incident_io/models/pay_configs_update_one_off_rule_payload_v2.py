...
T = TypeVar("T", bound="PayConfigsUpdateOneOffRulePayloadV2")
...
class PayConfigsUpdateOneOffRulePayloadV2:
    """
    Example:
        {'end_at': '2021-08-17T13:28:57.801578Z', 'name': 'Christmas day', 'rate_cents': 4800, 'start_at':
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        pay_configs_update_one_off_rule_payload_v2 = cls(
            end_at=end_at,
            name=name,
            rate_cents=rate_cents,
            start_at=start_at,
        ...
        pay_configs_update_one_off_rule_payload_v2.additional_properties = d
        return pay_configs_update_one_off_rule_payload_v2
