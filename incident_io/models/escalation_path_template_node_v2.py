...
from ..models.escalation_path_template_node_v2_type import (
...
if TYPE_CHECKING:
    ...
    from ..models.escalation_path_node_level_with_binding_v2 import (
        EscalationPathNodeLevelWithBindingV2,
    )
    from ..models.escalation_path_node_notify_channel_with_binding_v2 import (
        EscalationPathNodeNotifyChannelWithBindingV2,
    )
    from ..models.escalation_path_node_repeat_v2 import EscalationPathNodeRepeatV2
    from ..models.escalation_path_template_node_if_else_v2 import (
        EscalationPathTemplateNodeIfElseV2,
    )


T = TypeVar("T", bound="EscalationPathTemplateNodeV2")
...
class EscalationPathTemplateNodeV2:
    ...
    Attributes:
        ...
        type_ (EscalationPathTemplateNodeV2Type): The type of this node. Available types are:
        ...
        escalation_path (EscalationPathNodeEscalationPathV2 | Unset):  Example: {'escalation_path_id':
            '01FCNDV6P870EA6S7TK1DSYDG0'}.
        if_else (EscalationPathTemplateNodeIfElseV2 | Unset):  Example: {'conditions': [{'operation': {'label':
            ...
            'time_to_ack_weekday_interval_config_id': '01FCNDV6P870EA6S7TK1DSYDG0'}, 'repeat': {'repeat_times': 3,
            'to_node': '01FCNDV6P870EA6S7TK1DSYDG0'}, 'type': 'if_else'}]}.
        level (EscalationPathNodeLevelWithBindingV2 | Unset):  Example: {'ack_mode': 'all', 'retry_config': {'attempts':
        ...
        notify_channel (EscalationPathNodeNotifyChannelWithBindingV2 | Unset):  Example: {'targets': [{'binding':
            {'array_value': [{'label': 'Lawrence Jones', 'literal': 'SEV123', 'reference': 'incident.severity'}], 'value':
            {'label': 'Lawrence Jones', 'literal': 'SEV123', 'reference': 'incident.severity'}}, 'id':
    ...
    id: str
    type_: EscalationPathTemplateNodeV2Type
    delay: EscalationPathNodeDelayV2 | Unset = UNSET
    escalation_path: EscalationPathNodeEscalationPathV2 | Unset = UNSET
    if_else: EscalationPathTemplateNodeIfElseV2 | Unset = UNSET
    level: EscalationPathNodeLevelWithBindingV2 | Unset = UNSET
    notify_channel: EscalationPathNodeNotifyChannelWithBindingV2 | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        type_ = EscalationPathTemplateNodeV2Type(d.pop("type"))
        ...
        if_else: EscalationPathTemplateNodeIfElseV2 | Unset
        if isinstance(_if_else, Unset):
            if_else = UNSET
        else:
            if_else = EscalationPathTemplateNodeIfElseV2.from_dict(_if_else)

        _level = d.pop("level", UNSET)
        level: EscalationPathNodeLevelWithBindingV2 | Unset
        if isinstance(_level, Unset):
            level = UNSET
        else:
            level = EscalationPathNodeLevelWithBindingV2.from_dict(_level)

        _notify_channel = d.pop("notify_channel", UNSET)
        notify_channel: EscalationPathNodeNotifyChannelWithBindingV2 | Unset
        if isinstance(_notify_channel, Unset):
            notify_channel = UNSET
        else:
            notify_channel = EscalationPathNodeNotifyChannelWithBindingV2.from_dict(
                _notify_channel
            )
        ...
        escalation_path_template_node_v2 = cls(
            id=id,
            type_=type_,
            delay=delay,
        ...
        escalation_path_template_node_v2.additional_properties = d
        return escalation_path_template_node_v2
