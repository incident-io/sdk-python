...
T = TypeVar("T", bound="IncidentTypesShowResultV1")
...
class IncidentTypesShowResultV1:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        incident_types_show_result_v1 = cls(
            incident_type=incident_type,
        )

        incident_types_show_result_v1.additional_properties = d
        return incident_types_show_result_v1
