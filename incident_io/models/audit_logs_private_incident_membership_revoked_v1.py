...
T = TypeVar("T", bound="AuditLogsPrivateIncidentMembershipRevokedV1")


@_attrs_define
class AuditLogsPrivateIncidentMembershipRevokedV1:
    """
    Example:
        {'action': 'private_incident_membership.revoked', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
    ...
    Attributes:
        action (str): The type of log entry that this is Example: private_incident_membership.revoked.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_private_incident_membership_revoked_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_private_incident_membership_revoked_v1.additional_properties = d
        return audit_logs_private_incident_membership_revoked_v1
