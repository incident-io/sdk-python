...
T = TypeVar("T", bound="IncidentRolesShowResultV1")


@_attrs_define(kw_only=True)
class IncidentRolesShowResultV1:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        incident_roles_show_result_v1 = cls(
            incident_role=incident_role,
        )

        incident_roles_show_result_v1.additional_properties = d
        return incident_roles_show_result_v1
