...
T = TypeVar("T", bound="AuditLogsIncidentTypeCreatedV1")


@_attrs_define(kw_only=True)
class AuditLogsIncidentTypeCreatedV1:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_incident_type_created_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_incident_type_created_v1.additional_properties = d
        return audit_logs_incident_type_created_v1
