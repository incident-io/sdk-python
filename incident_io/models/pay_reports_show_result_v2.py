...
T = TypeVar("T", bound="PayReportsShowResultV2")


@_attrs_define(kw_only=True)
class PayReportsShowResultV2:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        pay_reports_show_result_v2 = cls(
            pay_report=pay_report,
        )

        pay_reports_show_result_v2.additional_properties = d
        return pay_reports_show_result_v2
