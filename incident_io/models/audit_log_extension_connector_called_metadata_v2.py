...
T = TypeVar("T", bound="AuditLogExtensionConnectorCalledMetadataV2")


@_attrs_define
class AuditLogExtensionConnectorCalledMetadataV2:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_log_extension_connector_called_metadata_v2 = cls(
            outcome=outcome,
            source_kind=source_kind,
            surface=surface,
            write=write,
        ...
        audit_log_extension_connector_called_metadata_v2.additional_properties = d
        return audit_log_extension_connector_called_metadata_v2
