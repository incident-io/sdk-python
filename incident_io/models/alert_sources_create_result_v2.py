...
T = TypeVar("T", bound="AlertSourcesCreateResultV2")


@_attrs_define
class AlertSourcesCreateResultV2:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        alert_sources_create_result_v2 = cls(
            alert_source=alert_source,
        )

        alert_sources_create_result_v2.additional_properties = d
        return alert_sources_create_result_v2
