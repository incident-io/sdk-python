...
T = TypeVar("T", bound="CustomFieldOptionsUpdateResultV1")
...
class CustomFieldOptionsUpdateResultV1:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        custom_field_options_update_result_v1 = cls(
            custom_field_option=custom_field_option,
        )

        custom_field_options_update_result_v1.additional_properties = d
        return custom_field_options_update_result_v1
