...
T = TypeVar("T", bound="SecretsCreateResultV2")


@_attrs_define
class SecretsCreateResultV2:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        secrets_create_result_v2 = cls(
            secret=secret,
        )

        secrets_create_result_v2.additional_properties = d
        return secrets_create_result_v2
