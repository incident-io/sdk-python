...
T = TypeVar("T", bound="PolicyFindingsRestoreResultV2")
...
class PolicyFindingsRestoreResultV2:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        policy_findings_restore_result_v2 = cls(
            policy_finding=policy_finding,
        )

        policy_findings_restore_result_v2.additional_properties = d
        return policy_findings_restore_result_v2
