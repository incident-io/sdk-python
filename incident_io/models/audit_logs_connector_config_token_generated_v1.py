...
T = TypeVar("T", bound="AuditLogsConnectorConfigTokenGeneratedV1")


@_attrs_define
class AuditLogsConnectorConfigTokenGeneratedV1:
    """
    Example:
        {'action': 'connector_config.token_generated', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
            ...
            '2021-08-17T13:28:57.801578Z', 'targets': [{'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'My Connector', 'type':
            'connector_config'}], 'version': 1}

    Attributes:
        action (str): The type of log entry that this is Example: connector_config.token_generated.
        ...
        targets (list[AuditLogTargetV2]): The custom field that was created Example: [{'id':
            '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'My Connector', 'type': 'connector_config'}].
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_connector_config_token_generated_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_connector_config_token_generated_v1.additional_properties = d
        return audit_logs_connector_config_token_generated_v1
