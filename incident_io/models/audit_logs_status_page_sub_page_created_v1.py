...
T = TypeVar("T", bound="AuditLogsStatusPageSubPageCreatedV1")


@_attrs_define(kw_only=True)
class AuditLogsStatusPageSubPageCreatedV1:
    """
    Example:
        {'action': 'status_page_sub_page.created', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_status_page_sub_page_created_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_status_page_sub_page_created_v1.additional_properties = d
        return audit_logs_status_page_sub_page_created_v1
