...
T = TypeVar("T", bound="ActionsShowResultV2")


@_attrs_define
class ActionsShowResultV2:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        actions_show_result_v2 = cls(
            action=action,
        )

        actions_show_result_v2.additional_properties = d
        return actions_show_result_v2
