...
T = TypeVar("T", bound="APIKeysRotateResultV1")
...
class APIKeysRotateResultV1:
    ...
    Attributes:
        ...
        token (str): The new bearer token to use in API requests. This is the only time the token is returned — store it
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        api_keys_rotate_result_v1 = cls(
            api_key=api_key,
            token=token,
        )

        api_keys_rotate_result_v1.additional_properties = d
        return api_keys_rotate_result_v1
