...
T = TypeVar("T", bound="EscalationsReassignEscalationResultV2")


@_attrs_define(kw_only=True)
class EscalationsReassignEscalationResultV2:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        escalations_reassign_escalation_result_v2 = cls(
            escalation=escalation,
        )

        escalations_reassign_escalation_result_v2.additional_properties = d
        return escalations_reassign_escalation_result_v2
