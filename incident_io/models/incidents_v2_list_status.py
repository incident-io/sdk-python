...
T = TypeVar("T", bound="IncidentsV2ListStatus")


@_attrs_define(kw_only=True)
class IncidentsV2ListStatus:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        incidents_v2_list_status.additional_properties = additional_properties
        return incidents_v2_list_status
