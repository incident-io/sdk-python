...
class CatalogCreateEntryPayloadV2AttributeValues:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        d = dict(src_dict)
        catalog_create_entry_payload_v2_attribute_values = cls()
        ...
        catalog_create_entry_payload_v2_attribute_values.additional_properties = (
            additional_properties
        )
        return catalog_create_entry_payload_v2_attribute_values
