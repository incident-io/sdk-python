...
T = TypeVar("T", bound="AuditLogsHolidayUserFeedUpdatedV1")


@_attrs_define
class AuditLogsHolidayUserFeedUpdatedV1:
    """
    Example:
        {'action': 'holiday_user_feed.updated', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
    ...
    Attributes:
        action (str): The type of log entry that this is Example: holiday_user_feed.updated.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_holiday_user_feed_updated_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_holiday_user_feed_updated_v1.additional_properties = d
        return audit_logs_holiday_user_feed_updated_v1
