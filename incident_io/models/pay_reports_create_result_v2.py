...
T = TypeVar("T", bound="PayReportsCreateResultV2")


@_attrs_define
class PayReportsCreateResultV2:
    """
    Example:
        {'pay_report': {'created_at': '2026-04-01T09:00:00Z', 'creator': {'api_key': {'id':
            ...
            '01G0J1EXE7AXZ2C93K61WBPYEH', 'name': 'March 2026', 'overlapping_shifts': 'paid_per_schedule', 'schedule_ids':
            ['01FCNDV6P870EA6S7TK1DSYDG0'], 'start_date': '2026-03-01', 'status': 'pending', 'unpaid_shifts': 'included',
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        pay_reports_create_result_v2 = cls(
            pay_report=pay_report,
        )

        pay_reports_create_result_v2.additional_properties = d
        return pay_reports_create_result_v2
