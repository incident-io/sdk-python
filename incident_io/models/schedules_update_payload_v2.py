...
T = TypeVar("T", bound="SchedulesUpdatePayloadV2")
...
class SchedulesUpdatePayloadV2:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        schedules_update_payload_v2 = cls(
            schedule=schedule,
        )

        schedules_update_payload_v2.additional_properties = d
        return schedules_update_payload_v2
