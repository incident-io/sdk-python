...
T = TypeVar("T", bound="AuditLogsScheduleOverrideDeletedV1")


@_attrs_define
class AuditLogsScheduleOverrideDeletedV1:
    """
    Example:
        {'action': 'schedule_override.deleted', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
            ...
            '2021-08-17T13:28:57.801578Z', 'targets': [{'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Override for Urgent
            Support', 'type': 'schedule_override'}], 'version': 1}
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_schedule_override_deleted_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_schedule_override_deleted_v1.additional_properties = d
        return audit_logs_schedule_override_deleted_v1
