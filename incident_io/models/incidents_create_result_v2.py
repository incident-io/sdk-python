...
T = TypeVar("T", bound="IncidentsCreateResultV2")


@_attrs_define
class IncidentsCreateResultV2:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        incidents_create_result_v2 = cls(
            incident=incident,
        )

        incidents_create_result_v2.additional_properties = d
        return incidents_create_result_v2
