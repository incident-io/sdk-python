...
T = TypeVar("T", bound="IncidentRolesCreatePayloadV1")


@_attrs_define(kw_only=True)
class IncidentRolesCreatePayloadV1:
    """
    Example:
    ...
    Attributes:
        ...
        required (bool): DEPRECATED: this will always be false. Example: False.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        incident_roles_create_payload_v1 = cls(
            description=description,
            instructions=instructions,
            name=name,
            required=required,
        ...
        incident_roles_create_payload_v1.additional_properties = d
        return incident_roles_create_payload_v1
