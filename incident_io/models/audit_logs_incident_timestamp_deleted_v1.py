...
T = TypeVar("T", bound="AuditLogsIncidentTimestampDeletedV1")


@_attrs_define
class AuditLogsIncidentTimestampDeletedV1:
    """
    Example:
        {'action': 'incident_timestamp.deleted', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
            ...
            'incident_timestamp'}], 'version': 1}

    Attributes:
        action (str): The type of log entry that this is Example: incident_timestamp.deleted.
        ...
        targets (list[AuditLogTargetV2]): The custom field that was created Example: [{'id':
            '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Fixed at', 'type': 'incident_timestamp'}].
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_incident_timestamp_deleted_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_incident_timestamp_deleted_v1.additional_properties = d
        return audit_logs_incident_timestamp_deleted_v1
