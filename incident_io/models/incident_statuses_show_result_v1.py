...
T = TypeVar("T", bound="IncidentStatusesShowResultV1")
...
class IncidentStatusesShowResultV1:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        incident_statuses_show_result_v1 = cls(
            incident_status=incident_status,
        )

        incident_statuses_show_result_v1.additional_properties = d
        return incident_statuses_show_result_v1
