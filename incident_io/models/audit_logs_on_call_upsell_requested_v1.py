...
if TYPE_CHECKING:
    ...
    from ..models.audit_log_on_call_upsell_requested_metadata_v2 import (
        AuditLogOnCallUpsellRequestedMetadataV2,
    )
    from ..models.audit_log_target_v2 import AuditLogTargetV2


T = TypeVar("T", bound="AuditLogsOnCallUpsellRequestedV1")
...
class AuditLogsOnCallUpsellRequestedV1:
    """
    Example:
        {'action': 'on_call_upsell.requested', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
            ...
            'seats_added': '5'}, 'occurred_at': '2021-08-17T13:28:57.801578Z', 'targets': [{'id':
            '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'On-call upsell (+5 seats)', 'type': 'on_call_upsell_request'}],
            'version': 1}

    Attributes:
        action (str): The type of log entry that this is Example: on_call_upsell.requested.
        ...
        metadata (AuditLogOnCallUpsellRequestedMetadataV2):  Example: {'gate_count_after': '15', 'gate_count_before':
            '10', 'requested_by_user_id': '01JV9EMFCFRGCFVNDWTBKT2EBR', 'seats_added': '5'}.
    ...
    metadata: AuditLogOnCallUpsellRequestedMetadataV2
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        metadata = AuditLogOnCallUpsellRequestedMetadataV2.from_dict(d.pop("metadata"))
        ...
        audit_logs_on_call_upsell_requested_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            metadata=metadata,
        ...
        audit_logs_on_call_upsell_requested_v1.additional_properties = d
        return audit_logs_on_call_upsell_requested_v1
