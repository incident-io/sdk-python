...
T = TypeVar("T", bound="AuditLogsAnnouncementRuleCreatedV1")


@_attrs_define
class AuditLogsAnnouncementRuleCreatedV1:
    """
    Example:
        {'action': 'announcement_rule.created', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
            ...
            '2021-08-17T13:28:57.801578Z', 'targets': [{'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': '#engineering', 'type':
            'announcement_rule'}], 'version': 1}
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_announcement_rule_created_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_announcement_rule_created_v1.additional_properties = d
        return audit_logs_announcement_rule_created_v1
