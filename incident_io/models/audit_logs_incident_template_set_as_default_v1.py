...
T = TypeVar("T", bound="AuditLogsIncidentTemplateSetAsDefaultV1")


@_attrs_define(kw_only=True)
class AuditLogsIncidentTemplateSetAsDefaultV1:
    """
    Example:
        {'action': 'incident_template.set_as_default', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
            ...
            '2021-08-17T13:28:57.801578Z', 'targets': [{'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Production incidents',
            'type': 'incident_template'}], 'version': 1}

    Attributes:
        action (str): The type of log entry that this is Example: incident_template.set_as_default.
        ...
        targets (list[AuditLogTargetV2]): The custom field that was created Example: [{'id':
            '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Production incidents', 'type': 'incident_template'}].
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_incident_template_set_as_default_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_incident_template_set_as_default_v1.additional_properties = d
        return audit_logs_incident_template_set_as_default_v1
