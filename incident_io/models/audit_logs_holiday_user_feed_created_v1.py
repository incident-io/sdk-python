...
T = TypeVar("T", bound="AuditLogsHolidayUserFeedCreatedV1")


@_attrs_define(kw_only=True)
class AuditLogsHolidayUserFeedCreatedV1:
    """
    Example:
        {'action': 'holiday_user_feed.created', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
            ...
            '2021-08-17T13:28:57.801578Z', 'targets': [{'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'US Team holidays',
            'type': 'holiday_user_feed'}], 'version': 1}

    Attributes:
        action (str): The type of log entry that this is Example: holiday_user_feed.created.
        ...
        targets (list[AuditLogTargetV2]): The custom field that was created Example: [{'id':
            '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'US Team holidays', 'type': 'holiday_user_feed'}].
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_holiday_user_feed_created_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_holiday_user_feed_created_v1.additional_properties = d
        return audit_logs_holiday_user_feed_created_v1
