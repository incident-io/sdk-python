...
T = TypeVar("T", bound="WorkflowActorV2")
...
class WorkflowActorV2:
    """
    Example:
        {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'My little workflow'}
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        workflow_actor_v2 = cls(
            id=id,
            name=name,
        )

        workflow_actor_v2.additional_properties = d
        return workflow_actor_v2
