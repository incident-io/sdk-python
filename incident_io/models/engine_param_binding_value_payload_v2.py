...
T = TypeVar("T", bound="EngineParamBindingValuePayloadV2")


@_attrs_define
class EngineParamBindingValuePayloadV2:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        engine_param_binding_value_payload_v2 = cls(
            literal=literal,
            reference=reference,
        )

        engine_param_binding_value_payload_v2.additional_properties = d
