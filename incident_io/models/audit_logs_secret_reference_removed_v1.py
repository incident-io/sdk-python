...
T = TypeVar("T", bound="AuditLogsSecretReferenceRemovedV1")


@_attrs_define
class AuditLogsSecretReferenceRemovedV1:
    """
    Example:
        {'action': 'secret.reference_removed', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
            ...
            '2021-08-17T13:28:57.801578Z', 'targets': [{'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Datadog webhook signing
            key', 'type': 'secret'}, {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Nudge to write a postmortem', 'type':
            'workflow'}], 'version': 1}

    Attributes:
        action (str): The type of log entry that this is Example: secret.reference_removed.
        ...
        targets (list[AuditLogTargetV2]): The custom field that was created Example: [{'id':
            '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Datadog webhook signing key', 'type': 'secret'}, {'id':
            '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Nudge to write a postmortem', 'type': 'workflow'}].
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_secret_reference_removed_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_secret_reference_removed_v1.additional_properties = d
        return audit_logs_secret_reference_removed_v1
