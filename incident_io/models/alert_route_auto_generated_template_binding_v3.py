...
T = TypeVar("T", bound="AlertRouteAutoGeneratedTemplateBindingV3")


@_attrs_define(kw_only=True)
class AlertRouteAutoGeneratedTemplateBindingV3:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        alert_route_auto_generated_template_binding_v3 = cls(
            autogenerated=autogenerated,
            binding=binding,
        )

        alert_route_auto_generated_template_binding_v3.additional_properties = d
        return alert_route_auto_generated_template_binding_v3
