...
T = TypeVar("T", bound="AlertRouteAlertSourcePayloadV3")
...
class AlertRouteAlertSourcePayloadV3:
    ...
    Attributes:
        ...
        condition_groups (list[ConditionGroupPayloadV3]): What conditions should alerts from this source meet to be
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        alert_route_alert_source_payload_v3 = cls(
            alert_source_id=alert_source_id,
            condition_groups=condition_groups,
        )

        alert_route_alert_source_payload_v3.additional_properties = d
        return alert_route_alert_source_payload_v3
