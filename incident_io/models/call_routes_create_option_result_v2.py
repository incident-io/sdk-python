...
T = TypeVar("T", bound="CallRoutesCreateOptionResultV2")
...
class CallRoutesCreateOptionResultV2:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        call_routes_create_option_result_v2 = cls(
            option=option,
        )

        call_routes_create_option_result_v2.additional_properties = d
        return call_routes_create_option_result_v2
