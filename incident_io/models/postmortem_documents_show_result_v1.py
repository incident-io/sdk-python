...
T = TypeVar("T", bound="PostmortemDocumentsShowResultV1")


@_attrs_define(kw_only=True)
class PostmortemDocumentsShowResultV1:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        postmortem_documents_show_result_v1 = cls(
            postmortem_document=postmortem_document,
        )

        postmortem_documents_show_result_v1.additional_properties = d
        return postmortem_documents_show_result_v1
