...
T = TypeVar("T", bound="IncidentTemplateAutoGeneratedBindingV1")


@_attrs_define(kw_only=True)
class IncidentTemplateAutoGeneratedBindingV1:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        incident_template_auto_generated_binding_v1 = cls(
            autogenerated=autogenerated,
            binding=binding,
        )

        incident_template_auto_generated_binding_v1.additional_properties = d
        return incident_template_auto_generated_binding_v1
