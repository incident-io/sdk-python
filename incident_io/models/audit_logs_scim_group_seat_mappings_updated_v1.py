...
if TYPE_CHECKING:
    ...
    from ..models.audit_log_scim_group_seat_mapping_changed_metadata_v2 import (
        AuditLogSCIMGroupSeatMappingChangedMetadataV2,
    )
    from ..models.audit_log_target_v2 import AuditLogTargetV2


T = TypeVar("T", bound="AuditLogsScimGroupSeatMappingsUpdatedV1")


@_attrs_define
class AuditLogsScimGroupSeatMappingsUpdatedV1:
    """
    Example:
        {'action': 'scim_group.seat_mappings_updated', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
            ...
            {'after_seat_types': '[full_access, responder_access]', 'before_seat_types': '[full_access]'}, 'occurred_at':
            '2021-08-17T13:28:57.801578Z', 'targets': [{'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Security', 'type':
            'scim_group'}], 'version': 1}

    Attributes:
        action (str): The type of log entry that this is Example: scim_group.seat_mappings_updated.
        ...
        metadata (AuditLogSCIMGroupSeatMappingChangedMetadataV2):  Example: {'after_seat_types': '[full_access,
            responder_access]', 'before_seat_types': '[full_access]'}.
    ...
    metadata: AuditLogSCIMGroupSeatMappingChangedMetadataV2
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        metadata = AuditLogSCIMGroupSeatMappingChangedMetadataV2.from_dict(
            d.pop("metadata")
        )
        ...
        audit_logs_scim_group_seat_mappings_updated_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            metadata=metadata,
        ...
        audit_logs_scim_group_seat_mappings_updated_v1.additional_properties = d
        return audit_logs_scim_group_seat_mappings_updated_v1
