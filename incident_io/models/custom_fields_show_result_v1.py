...
T = TypeVar("T", bound="CustomFieldsShowResultV1")


@_attrs_define
class CustomFieldsShowResultV1:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        custom_fields_show_result_v1 = cls(
            custom_field=custom_field,
        )

        custom_fields_show_result_v1.additional_properties = d
        return custom_fields_show_result_v1
