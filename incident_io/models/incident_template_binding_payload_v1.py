...
T = TypeVar("T", bound="IncidentTemplateBindingPayloadV1")
...
class IncidentTemplateBindingPayloadV1:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        incident_template_binding_payload_v1 = cls(
            binding=binding,
        )

        incident_template_binding_payload_v1.additional_properties = d
        return incident_template_binding_payload_v1
