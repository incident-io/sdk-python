...
T = TypeVar("T", bound="EscalationPathTemplatesUpdateResultV2")
...
class EscalationPathTemplatesUpdateResultV2:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        escalation_path_templates_update_result_v2 = cls(
            escalation_path_template=escalation_path_template,
        )

        escalation_path_templates_update_result_v2.additional_properties = d
        return escalation_path_templates_update_result_v2
