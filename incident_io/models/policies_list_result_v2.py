...
T = TypeVar("T", bound="PoliciesListResultV2")
...
class PoliciesListResultV2:
    """
    Example:
        {'pagination_meta': {'after': '01FCNDV6P870EA6S7TK1DSYDG0', 'page_size': 25}, 'policies': [{'assignment_rules':
    ...
    Attributes:
        ...
        policies (list[PolicyV2]):  Example: [{'assignment_rules': {'bindings': [{'array_value': [{'label': 'Lawrence
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for policies_item_data in _policies:
            policies_item = PolicyV2.from_dict(policies_item_data)

            policies.append(policies_item)

        policies_list_result_v2 = cls(
            pagination_meta=pagination_meta,
            policies=policies,
        )

        policies_list_result_v2.additional_properties = d
        return policies_list_result_v2
