...
from ..models.webhooks_public_alert_resolved_v1_response_body_event_type import (
...
T = TypeVar("T", bound="WebhooksPublicAlertResolvedV1ResponseBody")


@_attrs_define(kw_only=True)
class WebhooksPublicAlertResolvedV1ResponseBody:
    """
    Example:
        {'event_type': 'public_alert.alert_resolved_v1', 'public_alert.alert_resolved_v1': {'alert_group_ids':
    ...
    Attributes:
        event_type (WebhooksPublicAlertResolvedV1ResponseBodyEventType): What type of event is this webhook for?
            Example: public_alert.alert_resolved_v1.
        public_alert_alert_resolved_v1 (AlertV2):  Example: {'alert_group_ids': ['01GW2G3V0S59R238FAHPDS1R66'],
    ...
    event_type: WebhooksPublicAlertResolvedV1ResponseBodyEventType
    public_alert_alert_resolved_v1: AlertV2
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        event_type = self.event_type.value

        public_alert_alert_resolved_v1 = self.public_alert_alert_resolved_v1.to_dict()
        ...
        field_dict.update(
            {
                ...
                "public_alert.alert_resolved_v1": public_alert_alert_resolved_v1,
            }
        )
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        public_alert_alert_resolved_v1 = AlertV2.from_dict(
            d.pop("public_alert.alert_resolved_v1")
        )

        webhooks_public_alert_resolved_v1_response_body = cls(
            event_type=event_type,
            public_alert_alert_resolved_v1=public_alert_alert_resolved_v1,
        )

        webhooks_public_alert_resolved_v1_response_body.additional_properties = d
        return webhooks_public_alert_resolved_v1_response_body
