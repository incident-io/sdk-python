...
T = TypeVar("T", bound="AuditLogsAnnouncementPostTemplateSetAsDefaultV1")


@_attrs_define(kw_only=True)
class AuditLogsAnnouncementPostTemplateSetAsDefaultV1:
    """
    Example:
        {'action': 'announcement_post_template.set_as_default', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0',
            ...
            '2021-08-17T13:28:57.801578Z', 'targets': [{'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Major incident',
            'type': 'announcement_post_template'}], 'version': 1}

    Attributes:
        action (str): The type of log entry that this is Example: announcement_post_template.set_as_default.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_announcement_post_template_set_as_default_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_announcement_post_template_set_as_default_v1.additional_properties = d
        return audit_logs_announcement_post_template_set_as_default_v1
