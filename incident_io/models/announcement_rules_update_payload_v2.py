...
from ..models.announcement_rules_update_payload_v2_conditions_no_longer_apply_behaviour import (
    AnnouncementRulesUpdatePayloadV2ConditionsNoLongerApplyBehaviour,
)
from ..models.announcement_rules_update_payload_v2_mode import (
    AnnouncementRulesUpdatePayloadV2Mode,
)
from ..models.announcement_rules_update_payload_v2_private_incident_scope import (
    AnnouncementRulesUpdatePayloadV2PrivateIncidentScope,
)
from ..models.announcement_rules_update_payload_v2_update_sharing_mode import (
...
T = TypeVar("T", bound="AnnouncementRulesUpdatePayloadV2")


@_attrs_define(kw_only=True)
class AnnouncementRulesUpdatePayloadV2:
    """
    Example:
    ...
    Attributes:
        ...
        mode (AnnouncementRulesUpdatePayloadV2Mode): Which incidents are announced: live incidents only, or triage
            incidents too Example: live_and_closed.
        name (str): Human readable name for the rule Example: Data Breaches.
        update_sharing_mode (AnnouncementRulesUpdatePayloadV2UpdateSharingMode): Where incident updates are shared once
            the incident is announced Example: none.
        conditions_no_longer_apply_behaviour (AnnouncementRulesUpdatePayloadV2ConditionsNoLongerApplyBehaviour | Unset):
        ...
        owning_team_ids (list[str] | Unset): IDs of the teams that own this rule. The existing owning teams are kept
            when omitted. Example: ['01G0J1EXE7AXZ2C93K61WBPYEH'].
        private_incident_scope (AnnouncementRulesUpdatePayloadV2PrivateIncidentScope | Unset): Which private incidents
        ...
        template_id (str | Unset): ID of the announcement template used to render this rule's posts. The existing
            template is kept when omitted. Example: 01FCNDV6P870EA6S7TK1DSYDG0.
    """

    condition_groups: list[ConditionGroupPayloadV2]
    mode: AnnouncementRulesUpdatePayloadV2Mode
    name: str
    update_sharing_mode: AnnouncementRulesUpdatePayloadV2UpdateSharingMode
    conditions_no_longer_apply_behaviour: (
        AnnouncementRulesUpdatePayloadV2ConditionsNoLongerApplyBehaviour | Unset
    ) = UNSET
    microsoft_teams_channel_ids: list[str] | Unset = UNSET
    owning_team_ids: list[str] | Unset = UNSET
    private_incident_scope: (
        AnnouncementRulesUpdatePayloadV2PrivateIncidentScope | Unset
    ) = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        mode = AnnouncementRulesUpdatePayloadV2Mode(d.pop("mode"))
        ...
        announcement_rules_update_payload_v2 = cls(
            condition_groups=condition_groups,
            mode=mode,
            name=name,
            update_sharing_mode=update_sharing_mode,
        ...
        announcement_rules_update_payload_v2.additional_properties = d
        return announcement_rules_update_payload_v2
