...
T = TypeVar("T", bound="AnnouncementTemplatesCreateResultV2")
...
class AnnouncementTemplatesCreateResultV2:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        announcement_templates_create_result_v2 = cls(
            announcement_template=announcement_template,
        )

        announcement_templates_create_result_v2.additional_properties = d
        return announcement_templates_create_result_v2
