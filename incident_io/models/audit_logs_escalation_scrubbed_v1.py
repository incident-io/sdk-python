...
T = TypeVar("T", bound="AuditLogsEscalationScrubbedV1")


@_attrs_define
class AuditLogsEscalationScrubbedV1:
    """
    Example:
        {'action': 'escalation.scrubbed', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
            ...
            '2021-08-17T13:28:57.801578Z', 'targets': [{'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Escalation
            (01KB0083ASNF7EPT8NHQNRDXFC)', 'type': 'escalation'}], 'version': 1}

    Attributes:
        action (str): The type of log entry that this is Example: escalation.scrubbed.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_escalation_scrubbed_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_escalation_scrubbed_v1.additional_properties = d
        return audit_logs_escalation_scrubbed_v1
