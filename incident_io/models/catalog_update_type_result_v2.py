...
T = TypeVar("T", bound="CatalogUpdateTypeResultV2")


@_attrs_define
class CatalogUpdateTypeResultV2:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        catalog_update_type_result_v2 = cls(
            catalog_type=catalog_type,
        )

        catalog_update_type_result_v2.additional_properties = d
        return catalog_update_type_result_v2
