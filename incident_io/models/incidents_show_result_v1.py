...
T = TypeVar("T", bound="IncidentsShowResultV1")


@_attrs_define(kw_only=True)
class IncidentsShowResultV1:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        incidents_show_result_v1 = cls(
            incident=incident,
        )

        incidents_show_result_v1.additional_properties = d
        return incidents_show_result_v1
