...
if TYPE_CHECKING:
    from ..models.expression_branch_payload_v3 import ExpressionBranchPayloadV3
    from ..models.returns_meta_v3 import ReturnsMetaV3


T = TypeVar("T", bound="ExpressionBranchesOptsPayloadV3")
...
class ExpressionBranchesOptsPayloadV3:
    ...
    Attributes:
        branches (list[ExpressionBranchPayloadV3]): The branches to apply for this operation Example:
    ...
    branches: list[ExpressionBranchPayloadV3]
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.expression_branch_payload_v3 import (
        ...
        for branches_item_data in _branches:
            branches_item = ExpressionBranchPayloadV3.from_dict(branches_item_data)

            branches.append(branches_item)

        returns = ReturnsMetaV3.from_dict(d.pop("returns"))

        expression_branches_opts_payload_v3 = cls(
            branches=branches,
            returns=returns,
        )

        expression_branches_opts_payload_v3.additional_properties = d
        return expression_branches_opts_payload_v3
