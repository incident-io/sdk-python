...
T = TypeVar("T", bound="WorkflowsShowWorkflowResultV2")


@_attrs_define(kw_only=True)
class WorkflowsShowWorkflowResultV2:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        workflows_show_workflow_result_v2 = cls(
            management_meta=management_meta,
            workflow=workflow,
        )

        workflows_show_workflow_result_v2.additional_properties = d
        return workflows_show_workflow_result_v2
