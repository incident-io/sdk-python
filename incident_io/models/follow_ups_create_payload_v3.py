...
T = TypeVar("T", bound="FollowUpsCreatePayloadV3")
...
class FollowUpsCreatePayloadV3:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        follow_ups_create_payload_v3 = cls(
            incident_id=incident_id,
            title=title,
        ...
        follow_ups_create_payload_v3.additional_properties = d
        return follow_ups_create_payload_v3
