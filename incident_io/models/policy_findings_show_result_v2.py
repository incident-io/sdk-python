...
T = TypeVar("T", bound="PolicyFindingsShowResultV2")


@_attrs_define(kw_only=True)
class PolicyFindingsShowResultV2:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        policy_findings_show_result_v2 = cls(
            policy_finding=policy_finding,
        )

        policy_findings_show_result_v2.additional_properties = d
        return policy_findings_show_result_v2
