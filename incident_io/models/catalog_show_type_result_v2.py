...
T = TypeVar("T", bound="CatalogShowTypeResultV2")


@_attrs_define(kw_only=True)
class CatalogShowTypeResultV2:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        catalog_show_type_result_v2 = cls(
            catalog_type=catalog_type,
        )

        catalog_show_type_result_v2.additional_properties = d
        return catalog_show_type_result_v2
