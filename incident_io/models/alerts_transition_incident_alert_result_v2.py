...
T = TypeVar("T", bound="AlertsTransitionIncidentAlertResultV2")


@_attrs_define
class AlertsTransitionIncidentAlertResultV2:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        alerts_transition_incident_alert_result_v2 = cls(
            incident_alert=incident_alert,
        )

        alerts_transition_incident_alert_result_v2.additional_properties = d
        return alerts_transition_incident_alert_result_v2
