...
T = TypeVar("T", bound="CallRoutesUpdateResultV2")


@_attrs_define(kw_only=True)
class CallRoutesUpdateResultV2:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        call_routes_update_result_v2 = cls(
            call_route=call_route,
        )

        call_routes_update_result_v2.additional_properties = d
        return call_routes_update_result_v2
