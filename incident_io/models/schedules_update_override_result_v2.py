...
T = TypeVar("T", bound="SchedulesUpdateOverrideResultV2")
...
class SchedulesUpdateOverrideResultV2:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        schedules_update_override_result_v2 = cls(
            override=override,
        )

        schedules_update_override_result_v2.additional_properties = d
        return schedules_update_override_result_v2
