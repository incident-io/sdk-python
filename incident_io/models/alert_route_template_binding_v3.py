...
T = TypeVar("T", bound="AlertRouteTemplateBindingV3")
...
class AlertRouteTemplateBindingV3:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        alert_route_template_binding_v3 = cls(
            binding=binding,
        )

        alert_route_template_binding_v3.additional_properties = d
        return alert_route_template_binding_v3
