...
T = TypeVar("T", bound="AlertAttributesCreateResultV2")
...
class AlertAttributesCreateResultV2:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        alert_attributes_create_result_v2 = cls(
            alert_attribute=alert_attribute,
        )

        alert_attributes_create_result_v2.additional_properties = d
        return alert_attributes_create_result_v2
