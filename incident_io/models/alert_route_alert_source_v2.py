...
T = TypeVar("T", bound="AlertRouteAlertSourceV2")


@_attrs_define(kw_only=True)
class AlertRouteAlertSourceV2:
    """
    Example:
    ...
    Attributes:
        ...
        condition_groups (list[ConditionGroupV2]): What conditions should alerts from this source meet to be included in
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        alert_route_alert_source_v2 = cls(
            alert_source_id=alert_source_id,
            condition_groups=condition_groups,
        )

        alert_route_alert_source_v2.additional_properties = d
        return alert_route_alert_source_v2
