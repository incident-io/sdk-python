...
T = TypeVar("T", bound="StatusPagesUpdateStatusPageMaintenanceResultV2")
...
class StatusPagesUpdateStatusPageMaintenanceResultV2:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        status_pages_update_status_page_maintenance_result_v2 = cls(
            status_page_maintenance=status_page_maintenance,
        )

        status_pages_update_status_page_maintenance_result_v2.additional_properties = d
        return status_pages_update_status_page_maintenance_result_v2
