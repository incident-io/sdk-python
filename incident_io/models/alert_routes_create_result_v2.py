...
T = TypeVar("T", bound="AlertRoutesCreateResultV2")
...
class AlertRoutesCreateResultV2:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        alert_routes_create_result_v2 = cls(
            alert_route=alert_route,
        )

        alert_routes_create_result_v2.additional_properties = d
        return alert_routes_create_result_v2
