...
T = TypeVar("T", bound="AuditLogsPostIncidentTaskUpdatedV1")


@_attrs_define(kw_only=True)
class AuditLogsPostIncidentTaskUpdatedV1:
    """
    Example:
        {'action': 'post_incident_task.updated', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
    ...
    Attributes:
        action (str): The type of log entry that this is Example: post_incident_task.updated.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_post_incident_task_updated_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_post_incident_task_updated_v1.additional_properties = d
        return audit_logs_post_incident_task_updated_v1
