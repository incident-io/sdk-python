...
if TYPE_CHECKING:
    ...
    from ..models.audit_log_email_otp_login_setting_updated_metadata_v2 import (
...
T = TypeVar("T", bound="AuditLogsEmailOtpLoginSettingUpdatedV1")


@_attrs_define
class AuditLogsEmailOtpLoginSettingUpdatedV1:
    """
    Example:
        {'action': 'email_otp_login_setting.updated', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
    ...
    Attributes:
        action (str): The type of log entry that this is Example: email_otp_login_setting.updated.
        ...
        metadata (AuditLogEmailOtpLoginSettingUpdatedMetadataV2):  Example: {'enabled': 'true'}.
    ...
    metadata: AuditLogEmailOtpLoginSettingUpdatedMetadataV2
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        metadata = AuditLogEmailOtpLoginSettingUpdatedMetadataV2.from_dict(
            d.pop("metadata")
        )
        ...
        audit_logs_email_otp_login_setting_updated_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            metadata=metadata,
        ...
        audit_logs_email_otp_login_setting_updated_v1.additional_properties = d
        return audit_logs_email_otp_login_setting_updated_v1
