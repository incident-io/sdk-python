...
T = TypeVar("T", bound="AuditLogsOnCallNotificationMethodCreatedV1")


@_attrs_define(kw_only=True)
class AuditLogsOnCallNotificationMethodCreatedV1:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_on_call_notification_method_created_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_on_call_notification_method_created_v1.additional_properties = d
        return audit_logs_on_call_notification_method_created_v1
