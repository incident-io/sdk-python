...
if TYPE_CHECKING:
    ...
    from ..models.alert_message_config_v3 import AlertMessageConfigV3
    from ..models.alert_route_alert_source_v3 import AlertRouteAlertSourceV3
    from ..models.alert_route_escalation_config_v3 import AlertRouteEscalationConfigV3
    from ..models.alert_route_incident_config_v3 import AlertRouteIncidentConfigV3
    from ..models.condition_group_v3 import ConditionGroupV3
    from ..models.expression_v3 import ExpressionV3


T = TypeVar("T", bound="AlertRouteV3")
...
class AlertRouteV3:
    ...
    Attributes:
        alert_sources (list[AlertRouteAlertSourceV3]): Which alert sources this route matches Example:
        ...
        condition_groups (list[ConditionGroupV3]): Filter: the condition groups that must be true for this route to fire
        ...
        escalation_config (AlertRouteEscalationConfigV3):  Example: {'auto_cancel_escalations': False,
            ...
            'on_each_new_alert'}}.
        expressions (list[ExpressionV3]): The expressions used by bindings in this route Example: [{'else_branch':
        ...
        message_config (AlertMessageConfigV3):  Example: {'destinations': [{'condition_groups': [{'conditions':
            [{'operation': {'label': 'Lawrence Jones', 'value': '01FCQSP07Z74QMMYPDDGQB9FTG'}, 'param_bindings':
            [{'array_value': [{'literal': 'SEV123', 'reference': 'incident.severity'}], 'value': {'literal': 'SEV123',
            'reference': 'incident.severity'}}], 'subject': {'label': 'Priority', 'reference': 'alert.priority'}}]}],
            ...
            'group_alerts_summary': False}, 'slack_targets': {'binding': {'array_value': [{'literal': 'SEV123', 'reference':
        ...
        version (int): The version of this alert route Example: 1.
        created_at (datetime.datetime | Unset): When this alert route was created Example: 2021-08-17T13:28:57.801578Z.
        owning_team_ids (list[str] | Unset): IDs of teams that own this alert route Example:
            ['01G0J1EXE7AXZ2C93K61WBPYEH'].
        updated_at (datetime.datetime | Unset): When this alert route was last updated Example:
            2021-08-17T13:28:57.801578Z.
    """

    alert_sources: list[AlertRouteAlertSourceV3]
    condition_groups: list[ConditionGroupV3]
    enabled: bool
    escalation_config: AlertRouteEscalationConfigV3
    expressions: list[ExpressionV3]
    grouping_config: AlertGroupingConfigV3
    id: str
    incident_config: AlertRouteIncidentConfigV3
    is_private: bool
    message_config: AlertMessageConfigV3
    name: str
    version: int
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        from ..models.alert_message_config_v3 import (
            AlertMessageConfigV3,
        )
        from ..models.alert_route_alert_source_v3 import (
            AlertRouteAlertSourceV3,
        )
        from ..models.alert_route_escalation_config_v3 import (
            AlertRouteEscalationConfigV3,
        )
        from ..models.alert_route_incident_config_v3 import (
        ...
        for alert_sources_item_data in _alert_sources:
            alert_sources_item = AlertRouteAlertSourceV3.from_dict(
        ...
        escalation_config = AlertRouteEscalationConfigV3.from_dict(
        ...
        incident_config = AlertRouteIncidentConfigV3.from_dict(d.pop("incident_config"))

        is_private = d.pop("is_private")

        message_config = AlertMessageConfigV3.from_dict(d.pop("message_config"))
        ...
        alert_route_v3.additional_properties = d
        return alert_route_v3
