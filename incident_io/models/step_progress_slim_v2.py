...
from ..models.step_progress_slim_v2_status import StepProgressSlimV2Status
from ..models.step_progress_slim_v2_webhook_delivery_state import (
    StepProgressSlimV2WebhookDeliveryState,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.webhook_delivery_slim_v2 import WebhookDeliverySlimV2
...
class StepProgressSlimV2:
    ...
    Attributes:
        status (StepProgressSlimV2Status): Status of the step Example: complete.
        ...
        webhook_delivery (WebhookDeliverySlimV2 | Unset):  Example: {'duration_ms': 412, 'endpoint':
            'https://example.com/hooks/incident', 'method': 'POST', 'outcome': 'non_2xx', 'status_code': 500}.
        webhook_delivery_state (StepProgressSlimV2WebhookDeliveryState | Unset): Whether this step's delivery can be
            shown, for a webhook.send step. Absent for all other step types Example: expired.
    """

    status: StepProgressSlimV2Status
    step: str
    completed_at: datetime.datetime | Unset = UNSET
    error: str | Unset = UNSET
    incident_id: str | Unset = UNSET
    incident_reference: str | Unset = UNSET
    webhook_delivery: WebhookDeliverySlimV2 | Unset = UNSET
    webhook_delivery_state: StepProgressSlimV2WebhookDeliveryState | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.webhook_delivery_slim_v2 import (
            WebhookDeliverySlimV2,
        )

        d = dict(src_dict)
        status = StepProgressSlimV2Status(d.pop("status"))
        ...
        webhook_delivery: WebhookDeliverySlimV2 | Unset
        if isinstance(_webhook_delivery, Unset):
            webhook_delivery = UNSET
        else:
            webhook_delivery = WebhookDeliverySlimV2.from_dict(_webhook_delivery)

        _webhook_delivery_state = d.pop("webhook_delivery_state", UNSET)
        webhook_delivery_state: StepProgressSlimV2WebhookDeliveryState | Unset
        if isinstance(_webhook_delivery_state, Unset):
            webhook_delivery_state = UNSET
        else:
            webhook_delivery_state = StepProgressSlimV2WebhookDeliveryState(
                _webhook_delivery_state
            )

        step_progress_slim_v2 = cls(
            status=status,
            step=step,
        ...
        step_progress_slim_v2.additional_properties = d
        return step_progress_slim_v2
