...
if TYPE_CHECKING:
    from ..models.schedule_create_payload_v2 import ScheduleCreatePayloadV2


T = TypeVar("T", bound="SchedulesCreatePayloadV2")
...
class SchedulesCreatePayloadV2:
    """
    Example:
        {'schedule': {'annotations': {'incident.io/terraform/version': 'version-of-terraform'}, 'config': {'rotations':
    ...
    Attributes:
        schedule (ScheduleCreatePayloadV2):  Example: {'annotations': {'incident.io/terraform/version': 'version-of-
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.schedule_create_payload_v2 import (
            ScheduleCreatePayloadV2,
        )

        d = dict(src_dict)
        schedule = ScheduleCreatePayloadV2.from_dict(d.pop("schedule"))

        schedules_create_payload_v2 = cls(
            schedule=schedule,
        )

        schedules_create_payload_v2.additional_properties = d
        return schedules_create_payload_v2
