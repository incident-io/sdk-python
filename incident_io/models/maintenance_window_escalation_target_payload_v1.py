...
T = TypeVar("T", bound="MaintenanceWindowEscalationTargetPayloadV1")


@_attrs_define
class MaintenanceWindowEscalationTargetPayloadV1:
    """
    Example:
    ...
    Attributes:
        escalation_paths (EngineParamBindingPayloadV2 | Unset):  Example: {'array_value': [{'literal': 'SEV123',
            'reference': 'incident.severity'}], 'value': {'literal': 'SEV123', 'reference': 'incident.severity'}}.
        users (EngineParamBindingPayloadV2 | Unset):  Example: {'array_value': [{'literal': 'SEV123', 'reference':
            'incident.severity'}], 'value': {'literal': 'SEV123', 'reference': 'incident.severity'}}.
    """

    escalation_paths: EngineParamBindingPayloadV2 | Unset = UNSET
    users: EngineParamBindingPayloadV2 | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        escalation_paths: EngineParamBindingPayloadV2 | Unset
        if isinstance(_escalation_paths, Unset):
            escalation_paths = UNSET
        else:
            escalation_paths = EngineParamBindingPayloadV2.from_dict(_escalation_paths)

        _users = d.pop("users", UNSET)
        users: EngineParamBindingPayloadV2 | Unset
        if isinstance(_users, Unset):
            users = UNSET
        else:
            users = EngineParamBindingPayloadV2.from_dict(_users)

        maintenance_window_escalation_target_payload_v1 = cls(
            escalation_paths=escalation_paths,
            users=users,
        )

        maintenance_window_escalation_target_payload_v1.additional_properties = d
        return maintenance_window_escalation_target_payload_v1
