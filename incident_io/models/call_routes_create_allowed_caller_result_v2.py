...
T = TypeVar("T", bound="CallRoutesCreateAllowedCallerResultV2")


@_attrs_define(kw_only=True)
class CallRoutesCreateAllowedCallerResultV2:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        call_routes_create_allowed_caller_result_v2 = cls(
            allowed_caller=allowed_caller,
        )

        call_routes_create_allowed_caller_result_v2.additional_properties = d
        return call_routes_create_allowed_caller_result_v2
