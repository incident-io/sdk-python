...
T = TypeVar("T", bound="CallRoutesUpdateAllowedCallerPayloadV2")
...
class CallRoutesUpdateAllowedCallerPayloadV2:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        call_routes_update_allowed_caller_payload_v2 = cls(
            phone_number=phone_number,
            name=name,
        )

        call_routes_update_allowed_caller_payload_v2.additional_properties = d
        return call_routes_update_allowed_caller_payload_v2
