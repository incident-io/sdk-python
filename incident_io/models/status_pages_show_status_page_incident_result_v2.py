...
T = TypeVar("T", bound="StatusPagesShowStatusPageIncidentResultV2")


@_attrs_define
class StatusPagesShowStatusPageIncidentResultV2:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        status_pages_show_status_page_incident_result_v2 = cls(
            status_page_incident=status_page_incident,
        )

        status_pages_show_status_page_incident_result_v2.additional_properties = d
        return status_pages_show_status_page_incident_result_v2
