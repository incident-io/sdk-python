...
class AlertsV2ListIncludeMaintenanceWindow:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        d = dict(src_dict)
        alerts_v2_list_include_maintenance_window = cls()
        ...
        alerts_v2_list_include_maintenance_window.additional_properties = (
            additional_properties
        )
        return alerts_v2_list_include_maintenance_window
