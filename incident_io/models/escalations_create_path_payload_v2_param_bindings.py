...
T = TypeVar("T", bound="EscalationsCreatePathPayloadV2ParamBindings")


@_attrs_define
class EscalationsCreatePathPayloadV2ParamBindings:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        d = dict(src_dict)
        escalations_create_path_payload_v2_param_bindings = cls()
        ...
        escalations_create_path_payload_v2_param_bindings.additional_properties = (
            additional_properties
        )
        return escalations_create_path_payload_v2_param_bindings
