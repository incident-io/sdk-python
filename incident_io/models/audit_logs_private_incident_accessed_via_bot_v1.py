...
T = TypeVar("T", bound="AuditLogsPrivateIncidentAccessedViaBotV1")


@_attrs_define(kw_only=True)
class AuditLogsPrivateIncidentAccessedViaBotV1:
    """
    Example:
        {'action': 'private_incident.accessed_via_bot', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
    ...
    Attributes:
        action (str): The type of log entry that this is Example: private_incident.accessed_via_bot.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_private_incident_accessed_via_bot_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_private_incident_accessed_via_bot_v1.additional_properties = d
        return audit_logs_private_incident_accessed_via_bot_v1
