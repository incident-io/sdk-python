...
class EscalationPathNodeNotifyChannelV2:
    ...
    Attributes:
        ...
        time_to_ack_interval_condition (EscalationPathNodeNotifyChannelV2TimeToAckIntervalCondition | Unset): If the
    ...
    time_to_ack_interval_condition: (
        EscalationPathNodeNotifyChannelV2TimeToAckIntervalCondition | Unset
    ) = UNSET
