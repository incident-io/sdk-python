...
from ..models.custom_fields_update_payload_v1_required import (
    CustomFieldsUpdatePayloadV1Required,
)
from ..models.custom_fields_update_payload_v1_required_v2 import (
...
class CustomFieldsUpdatePayloadV1:
    ...
    Attributes:
        ...
        required (CustomFieldsUpdatePayloadV1Required | Unset): When this custom field must be set during the incident
            lifecycle. [DEPRECATED: please use required_v2 instead]. Example: never.
        required_v2 (CustomFieldsUpdatePayloadV1RequiredV2 | Unset): When this custom field must be set during the
    ...
    required: CustomFieldsUpdatePayloadV1Required | Unset = UNSET
    required_v2: CustomFieldsUpdatePayloadV1RequiredV2 | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        required: CustomFieldsUpdatePayloadV1Required | Unset
        if isinstance(_required, Unset):
            required = UNSET
        else:
            required = CustomFieldsUpdatePayloadV1Required(_required)

        _required_v2 = d.pop("required_v2", UNSET)
        required_v2: CustomFieldsUpdatePayloadV1RequiredV2 | Unset
        if isinstance(_required_v2, Unset):
            required_v2 = UNSET
        else:
            required_v2 = CustomFieldsUpdatePayloadV1RequiredV2(_required_v2)

        show_in_announcement_post = d.pop("show_in_announcement_post", UNSET)

        custom_fields_update_payload_v1 = cls(
            description=description,
            name=name,
            show_before_closure=show_before_closure,
            show_before_creation=show_before_creation,
        ...
        custom_fields_update_payload_v1.additional_properties = d
        return custom_fields_update_payload_v1
