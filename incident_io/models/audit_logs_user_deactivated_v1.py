...
T = TypeVar("T", bound="AuditLogsUserDeactivatedV1")


@_attrs_define(kw_only=True)
class AuditLogsUserDeactivatedV1:
    """
    Example:
        {'action': 'user.deactivated', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata': {'user_base_role_slug':
    ...
    Attributes:
        action (str): The type of log entry that this is Example: user.deactivated.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_user_deactivated_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_user_deactivated_v1.additional_properties = d
        return audit_logs_user_deactivated_v1
