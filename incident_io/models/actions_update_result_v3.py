...
T = TypeVar("T", bound="ActionsUpdateResultV3")


@_attrs_define
class ActionsUpdateResultV3:
    """
    Example:
    ...
    Attributes:
        action (ActionV3):  Example: {'assignee': {'email': 'lisa@incident.io', 'id': '01FCNDV6P870EA6S7TK1DSYDG0',
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        d = dict(src_dict)
        action = ActionV3.from_dict(d.pop("action"))

        actions_update_result_v3 = cls(
            action=action,
        )

        actions_update_result_v3.additional_properties = d
        return actions_update_result_v3
