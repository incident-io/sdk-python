...
T = TypeVar("T", bound="AuditLogsPostmortemTemplateCreatedV1")


@_attrs_define
class AuditLogsPostmortemTemplateCreatedV1:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_postmortem_template_created_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_postmortem_template_created_v1.additional_properties = d
        return audit_logs_postmortem_template_created_v1
