...
T = TypeVar("T", bound="IncidentTimelineItemsCreateResultV2")
...
class IncidentTimelineItemsCreateResultV2:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        incident_timeline_items_create_result_v2 = cls(
            incident_timeline_item=incident_timeline_item,
        )

        incident_timeline_items_create_result_v2.additional_properties = d
        return incident_timeline_items_create_result_v2
