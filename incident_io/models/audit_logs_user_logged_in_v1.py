...
if TYPE_CHECKING:
    ...
    from ..models.audit_log_user_logged_in_metadata_v2 import (
        AuditLogUserLoggedInMetadataV2,
    )


T = TypeVar("T", bound="AuditLogsUserLoggedInV1")


@_attrs_define
class AuditLogsUserLoggedInV1:
    """
    Example:
        {'action': 'user.logged_in', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata': {'user_base_role_slug':
            'admin', 'user_custom_role_slugs': 'engineering,security'}, 'name': 'John Doe', 'type': 'user'}, 'context':
            {'location': '1.2.3.4', 'user_agent': 'Chrome/91.0.4472.114'}, 'metadata': {'login_method': 'slack_oidc'},
            'occurred_at': '2021-08-17T13:28:57.801578Z', 'targets': [{'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Bob the
            builder', 'type': 'user'}], 'version': 1}

    Attributes:
        action (str): The type of log entry that this is Example: user.logged_in.
        ...
        metadata (AuditLogUserLoggedInMetadataV2):  Example: {'login_method': 'slack_oidc'}.
        ...
        targets (list[AuditLogTargetV2]): The custom field that was created Example: [{'id':
            '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Bob the builder', 'type': 'user'}].
    ...
    metadata: AuditLogUserLoggedInMetadataV2
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        metadata = AuditLogUserLoggedInMetadataV2.from_dict(d.pop("metadata"))
        ...
        audit_logs_user_logged_in_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            metadata=metadata,
        ...
        audit_logs_user_logged_in_v1.additional_properties = d
        return audit_logs_user_logged_in_v1
