...
if TYPE_CHECKING:
    ...
    from ..models.audit_log_user_role_membership_changed_metadata_v2 import (
        AuditLogUserRoleMembershipChangedMetadataV2,
    )


T = TypeVar("T", bound="AuditLogsUserRoleMembershipsUpdatedV1")


@_attrs_define
class AuditLogsUserRoleMembershipsUpdatedV1:
    """
    Example:
        {'action': 'user.role_memberships_updated', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
            ...
            'targets': [{'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Bob the builder', 'type': 'user'}], 'version': 1}

    Attributes:
        action (str): The type of log entry that this is Example: user.role_memberships_updated.
        ...
        metadata (AuditLogUserRoleMembershipChangedMetadataV2):  Example: {'after_base_role_slug': 'owner',
            'after_custom_role_slugs': 'engineering,data', 'before_base_role_slug': 'admin', 'before_custom_role_slugs':
    ...
    metadata: AuditLogUserRoleMembershipChangedMetadataV2
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_user_role_memberships_updated_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            metadata=metadata,
        ...
        audit_logs_user_role_memberships_updated_v1.additional_properties = d
        return audit_logs_user_role_memberships_updated_v1
