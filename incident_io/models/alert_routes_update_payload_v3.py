...
T = TypeVar("T", bound="AlertRoutesUpdatePayloadV3")
...
class AlertRoutesUpdatePayloadV3:
    ...
    Example:
        {'alert_sources': [{'alert_source_id': '01FCNDV6P870EA6S7TK1DSYDG0', 'condition_groups': [{'conditions':
            ...
            incidents', 'owning_team_ids': ['01G0J1EXE7AXZ2C93K61WBPYEH'], 'version': 1}
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        alert_routes_update_payload_v3 = cls(
            alert_sources=alert_sources,
            condition_groups=condition_groups,
            enabled=enabled,
            escalation_config=escalation_config,
        ...
        alert_routes_update_payload_v3.additional_properties = d
        return alert_routes_update_payload_v3
