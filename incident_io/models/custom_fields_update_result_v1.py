...
T = TypeVar("T", bound="CustomFieldsUpdateResultV1")


@_attrs_define
class CustomFieldsUpdateResultV1:
    """
    Example:
    ...
    Attributes:
        custom_field (CustomFieldV1):  Example: {'catalog_type_id': '01FCNDV6P870EA6S7TK1DSYDG0', 'created_at':
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        custom_fields_update_result_v1 = cls(
            custom_field=custom_field,
        )

        custom_fields_update_result_v1.additional_properties = d
        return custom_fields_update_result_v1
