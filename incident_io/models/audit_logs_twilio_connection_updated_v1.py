...
T = TypeVar("T", bound="AuditLogsTwilioConnectionUpdatedV1")


@_attrs_define(kw_only=True)
class AuditLogsTwilioConnectionUpdatedV1:
    """
    Example:
        {'action': 'twilio_connection.updated', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
    ...
    Attributes:
        action (str): The type of log entry that this is Example: twilio_connection.updated.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_twilio_connection_updated_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            metadata=metadata,
        ...
        audit_logs_twilio_connection_updated_v1.additional_properties = d
        return audit_logs_twilio_connection_updated_v1
