...
from ..models.alert_route_severity_binding_v2_merge_strategy import (
...
T = TypeVar("T", bound="AlertRouteSeverityBindingV2")


@_attrs_define(kw_only=True)
class AlertRouteSeverityBindingV2:
    """
    Example:
        {'binding': {'array_value': [{'label': 'Lawrence Jones', 'literal': 'SEV123', 'reference':
            'incident.severity'}], 'value': {'label': 'Lawrence Jones', 'literal': 'SEV123', 'reference':
            'incident.severity'}}, 'merge_strategy': 'first-wins'}

    Attributes:
        merge_strategy (AlertRouteSeverityBindingV2MergeStrategy): Strategy for merging severity when multiple alerts
            create/update the same incident Example: first-wins.
    ...
    merge_strategy: AlertRouteSeverityBindingV2MergeStrategy
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        alert_route_severity_binding_v2 = cls(
            merge_strategy=merge_strategy,
            binding=binding,
        )

        alert_route_severity_binding_v2.additional_properties = d
        return alert_route_severity_binding_v2
