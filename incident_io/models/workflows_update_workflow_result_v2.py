...
T = TypeVar("T", bound="WorkflowsUpdateWorkflowResultV2")
...
class WorkflowsUpdateWorkflowResultV2:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        workflows_update_workflow_result_v2 = cls(
            management_meta=management_meta,
            workflow=workflow,
        )

        workflows_update_workflow_result_v2.additional_properties = d
        return workflows_update_workflow_result_v2
