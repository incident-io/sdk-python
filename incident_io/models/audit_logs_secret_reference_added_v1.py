...
T = TypeVar("T", bound="AuditLogsSecretReferenceAddedV1")


@_attrs_define
class AuditLogsSecretReferenceAddedV1:
    """
    Example:
        {'action': 'secret.reference_added', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
    ...
    Attributes:
        action (str): The type of log entry that this is Example: secret.reference_added.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_secret_reference_added_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_secret_reference_added_v1.additional_properties = d
        return audit_logs_secret_reference_added_v1
