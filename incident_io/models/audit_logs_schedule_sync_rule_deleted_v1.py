...
T = TypeVar("T", bound="AuditLogsScheduleSyncRuleDeletedV1")


@_attrs_define
class AuditLogsScheduleSyncRuleDeletedV1:
    """
    Example:
        {'action': 'schedule_sync_rule.deleted', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
    ...
    Attributes:
        action (str): The type of log entry that this is Example: schedule_sync_rule.deleted.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_schedule_sync_rule_deleted_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_schedule_sync_rule_deleted_v1.additional_properties = d
        return audit_logs_schedule_sync_rule_deleted_v1
