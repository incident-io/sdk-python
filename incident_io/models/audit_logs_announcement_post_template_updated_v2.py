...
if TYPE_CHECKING:
    ...
    from ..models.audit_log_announcement_post_template_owning_teams_metadata_v2 import (
...
T = TypeVar("T", bound="AuditLogsAnnouncementPostTemplateUpdatedV2")


@_attrs_define(kw_only=True)
class AuditLogsAnnouncementPostTemplateUpdatedV2:
    """
    Example:
        {'action': 'announcement_post_template.updated', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
            ...
            'targets': [{'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Major incident', 'type':
            'announcement_post_template'}], 'version': 2}

    Attributes:
        action (str): The type of log entry that this is Example: announcement_post_template.updated.
        ...
        metadata (AuditLogAnnouncementPostTemplateOwningTeamsMetadataV2):  Example: {'after_owning_team_ids':
            '01FCNDV6P870EA6S7TK1DSYDG0,01FCNDV6P870EA6S7TK1DSYDG2', 'before_owning_team_ids':
        ...
        targets (list[AuditLogTargetV2]): The custom field that was created Example: [{'id':
            '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Major incident', 'type': 'announcement_post_template'}].
    ...
    metadata: AuditLogAnnouncementPostTemplateOwningTeamsMetadataV2
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        metadata = AuditLogAnnouncementPostTemplateOwningTeamsMetadataV2.from_dict(
            d.pop("metadata")
        )
        ...
        audit_logs_announcement_post_template_updated_v2 = cls(
            action=action,
            actor=actor,
            context=context,
            metadata=metadata,
        ...
        audit_logs_announcement_post_template_updated_v2.additional_properties = d
        return audit_logs_announcement_post_template_updated_v2
