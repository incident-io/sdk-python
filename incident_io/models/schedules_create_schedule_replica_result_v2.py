...
T = TypeVar("T", bound="SchedulesCreateScheduleReplicaResultV2")
...
class SchedulesCreateScheduleReplicaResultV2:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        schedules_create_schedule_replica_result_v2 = cls(
            schedule_replica=schedule_replica,
        )

        schedules_create_schedule_replica_result_v2.additional_properties = d
        return schedules_create_schedule_replica_result_v2
