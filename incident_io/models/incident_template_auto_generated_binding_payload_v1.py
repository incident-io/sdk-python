...
T = TypeVar("T", bound="IncidentTemplateAutoGeneratedBindingPayloadV1")


@_attrs_define
class IncidentTemplateAutoGeneratedBindingPayloadV1:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        incident_template_auto_generated_binding_payload_v1 = cls(
            autogenerated=autogenerated,
            binding=binding,
        )

        incident_template_auto_generated_binding_payload_v1.additional_properties = d
        return incident_template_auto_generated_binding_payload_v1
