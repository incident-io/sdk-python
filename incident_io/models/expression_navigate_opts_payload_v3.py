...
T = TypeVar("T", bound="ExpressionNavigateOptsPayloadV3")
...
class ExpressionNavigateOptsPayloadV3:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        expression_navigate_opts_payload_v3 = cls(
            reference=reference,
        )

        expression_navigate_opts_payload_v3.additional_properties = d
        return expression_navigate_opts_payload_v3
