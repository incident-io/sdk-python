...
T = TypeVar("T", bound="AuditLogsTimelineItemDeletedV1")


@_attrs_define(kw_only=True)
class AuditLogsTimelineItemDeletedV1:
    """
    Example:
        {'action': 'timeline_item.deleted', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
            ...
            '2021-08-17T13:28:57.801578Z', 'targets': [{'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Timeline item
            (01FCNDV6P870EA6S7TK1DSYDG0)', 'type': 'timeline_item'}], 'version': 1}

    Attributes:
        action (str): The type of log entry that this is Example: timeline_item.deleted.
        ...
        targets (list[AuditLogTargetV2]): The custom field that was created Example: [{'id':
            '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Timeline item (01FCNDV6P870EA6S7TK1DSYDG0)', 'type': 'timeline_item'}].
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_timeline_item_deleted_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_timeline_item_deleted_v1.additional_properties = d
        return audit_logs_timeline_item_deleted_v1
