...
T = TypeVar("T", bound="CatalogUpdateTypeResultV3")
...
class CatalogUpdateTypeResultV3:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        catalog_update_type_result_v3 = cls(
            catalog_type=catalog_type,
        )

        catalog_update_type_result_v3.additional_properties = d
        return catalog_update_type_result_v3
