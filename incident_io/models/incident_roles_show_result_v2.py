...
T = TypeVar("T", bound="IncidentRolesShowResultV2")


@_attrs_define
class IncidentRolesShowResultV2:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        incident_roles_show_result_v2 = cls(
            incident_role=incident_role,
        )

        incident_roles_show_result_v2.additional_properties = d
        return incident_roles_show_result_v2
