...
if TYPE_CHECKING:
    ...
    from ..models.audit_log_twilio_connection_metadata_v2 import (
        AuditLogTwilioConnectionMetadataV2,
    )


T = TypeVar("T", bound="AuditLogsTwilioConnectionCreatedV1")


@_attrs_define(kw_only=True)
class AuditLogsTwilioConnectionCreatedV1:
    """
    Example:
        {'action': 'twilio_connection.created', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
            {'user_base_role_slug': 'admin', 'user_custom_role_slugs': 'engineering,security'}, 'name': 'John Doe', 'type':
            'user'}, 'context': {'location': '1.2.3.4', 'user_agent': 'Chrome/91.0.4472.114'}, 'metadata': {'account_sid':
            'AC11111111111111111111111111111111'}, 'occurred_at': '2021-08-17T13:28:57.801578Z', 'targets': [{'id':
            '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Production Twilio', 'type': 'twilio_connection'}], 'version': 1}

    Attributes:
        action (str): The type of log entry that this is Example: twilio_connection.created.
        ...
        metadata (AuditLogTwilioConnectionMetadataV2):  Example: {'account_sid': 'AC11111111111111111111111111111111'}.
        ...
        targets (list[AuditLogTargetV2]): The custom field that was created Example: [{'id':
            '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Production Twilio', 'type': 'twilio_connection'}].
    ...
    metadata: AuditLogTwilioConnectionMetadataV2
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        metadata = AuditLogTwilioConnectionMetadataV2.from_dict(d.pop("metadata"))
        ...
        audit_logs_twilio_connection_created_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            metadata=metadata,
        ...
        audit_logs_twilio_connection_created_v1.additional_properties = d
        return audit_logs_twilio_connection_created_v1
