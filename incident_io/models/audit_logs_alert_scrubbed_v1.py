...
T = TypeVar("T", bound="AuditLogsAlertScrubbedV1")


@_attrs_define
class AuditLogsAlertScrubbedV1:
    """
    Example:
        {'action': 'alert.scrubbed', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata': {'user_base_role_slug':
            ...
            'targets': [{'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Alert (01KB0083ASNF7EPT8NHQNRDXFC)', 'type':
            'alert'}], 'version': 1}

    Attributes:
        action (str): The type of log entry that this is Example: alert.scrubbed.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_alert_scrubbed_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_alert_scrubbed_v1.additional_properties = d
        return audit_logs_alert_scrubbed_v1
