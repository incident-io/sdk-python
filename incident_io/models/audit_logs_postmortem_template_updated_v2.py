...
T = TypeVar("T", bound="AuditLogsPostmortemTemplateUpdatedV2")


@_attrs_define
class AuditLogsPostmortemTemplateUpdatedV2:
    """
    Example:
        {'action': 'postmortem_template.updated', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
    ...
    Attributes:
        action (str): The type of log entry that this is Example: postmortem_template.updated.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_postmortem_template_updated_v2 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_postmortem_template_updated_v2.additional_properties = d
        return audit_logs_postmortem_template_updated_v2
