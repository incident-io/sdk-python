...
T = TypeVar("T", bound="FollowUpsUpdateResultV2")


@_attrs_define(kw_only=True)
class FollowUpsUpdateResultV2:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        follow_ups_update_result_v2 = cls(
            follow_up=follow_up,
        )

        follow_ups_update_result_v2.additional_properties = d
        return follow_ups_update_result_v2
