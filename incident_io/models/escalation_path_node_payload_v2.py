...
class EscalationPathNodePayloadV2:
    ...
    Example:
        {'delay': {'delay_interval_condition': 'active', 'delay_seconds': 300, 'delay_weekday_interval_config_id':
            ...
            {'enabled': False, 'rotate_after_seconds': 120}, 'targets': [{'id': 'lawrencejones', 'schedule_mode':
    ...
    Attributes:
        ...
        escalation_path (EscalationPathNodeEscalationPathV2 | Unset):  Example: {'escalation_path_id':
            '01FCNDV6P870EA6S7TK1DSYDG0'}.
        if_else (EscalationPathNodeIfElsePayloadV2 | Unset):  Example: {'conditions': [{'operation': 'one_of',
    ...
    if_else: EscalationPathNodeIfElsePayloadV2 | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if_else: EscalationPathNodeIfElsePayloadV2 | Unset
