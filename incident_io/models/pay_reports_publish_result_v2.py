...
T = TypeVar("T", bound="PayReportsPublishResultV2")
...
class PayReportsPublishResultV2:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        pay_reports_publish_result_v2 = cls(
            pay_report=pay_report,
        )

        pay_reports_publish_result_v2.additional_properties = d
        return pay_reports_publish_result_v2
