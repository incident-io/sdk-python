...
class AuditLogsScheduleOverrideUpdatedV1:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_schedule_override_updated_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_schedule_override_updated_v1.additional_properties = d
        return audit_logs_schedule_override_updated_v1
