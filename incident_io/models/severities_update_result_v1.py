...
T = TypeVar("T", bound="SeveritiesUpdateResultV1")


@_attrs_define(kw_only=True)
class SeveritiesUpdateResultV1:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        severities_update_result_v1 = cls(
            severity=severity,
        )

        severities_update_result_v1.additional_properties = d
        return severities_update_result_v1
