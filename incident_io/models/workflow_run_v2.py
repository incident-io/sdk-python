...
if TYPE_CHECKING:
    from ..models.step_progress_v2 import StepProgressV2


T = TypeVar("T", bound="WorkflowRunV2")
...
class WorkflowRunV2:
    ...
    Attributes:
        ...
        progress (list[StepProgressV2]): Status of each step as it is worked Example: [{'completed_at':
            ...
            'status_code': 500}, 'webhook_delivery_state': 'expired'}].
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for progress_item_data in _progress:
            progress_item = StepProgressV2.from_dict(progress_item_data)
        ...
        workflow_run_v2.additional_properties = d
        return workflow_run_v2
