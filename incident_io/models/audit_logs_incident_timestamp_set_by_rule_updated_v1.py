...
T = TypeVar("T", bound="AuditLogsIncidentTimestampSetByRuleUpdatedV1")


@_attrs_define(kw_only=True)
class AuditLogsIncidentTimestampSetByRuleUpdatedV1:
    """
    Example:
        {'action': 'incident_timestamp_set_by_rule.updated', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
            ...
            '2021-08-17T13:28:57.801578Z', 'targets': [{'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Fixed at', 'type':
            'incident_timestamp'}, {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': "Resolved at ('set by' rule)", 'type':
            'incident_timestamp_set_by_rule'}], 'version': 1}

    Attributes:
        action (str): The type of log entry that this is Example: incident_timestamp_set_by_rule.updated.
        ...
        targets (list[AuditLogTargetV2]): The custom field that was created Example: [{'id':
            '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Fixed at', 'type': 'incident_timestamp'}, {'id':
            '01FCNDV6P870EA6S7TK1DSYDG0', 'name': "Resolved at ('set by' rule)", 'type': 'incident_timestamp_set_by_rule'}].
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_incident_timestamp_set_by_rule_updated_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_incident_timestamp_set_by_rule_updated_v1.additional_properties = d
        return audit_logs_incident_timestamp_set_by_rule_updated_v1
