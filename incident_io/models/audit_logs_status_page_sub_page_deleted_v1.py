...
T = TypeVar("T", bound="AuditLogsStatusPageSubPageDeletedV1")


@_attrs_define
class AuditLogsStatusPageSubPageDeletedV1:
    """
    Example:
        {'action': 'status_page_sub_page.deleted', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
            ...
            '2021-08-17T13:28:57.801578Z', 'targets': [{'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Superpayments France',
            'type': 'status_page_sub_page'}], 'version': 1}

    Attributes:
        action (str): The type of log entry that this is Example: status_page_sub_page.deleted.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_status_page_sub_page_deleted_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_status_page_sub_page_deleted_v1.additional_properties = d
        return audit_logs_status_page_sub_page_deleted_v1
