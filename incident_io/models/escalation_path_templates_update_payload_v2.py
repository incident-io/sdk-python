...
T = TypeVar("T", bound="EscalationPathTemplatesUpdatePayloadV2")
...
class EscalationPathTemplatesUpdatePayloadV2:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        escalation_path_templates_update_payload_v2 = cls(
            name=name,
            path=path,
        ...
        escalation_path_templates_update_payload_v2.additional_properties = d
        return escalation_path_templates_update_payload_v2
