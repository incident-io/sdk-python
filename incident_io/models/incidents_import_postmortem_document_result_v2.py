...
T = TypeVar("T", bound="IncidentsImportPostmortemDocumentResultV2")
...
class IncidentsImportPostmortemDocumentResultV2:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        incidents_import_postmortem_document_result_v2 = cls(
            postmortem_document=postmortem_document,
        )

        incidents_import_postmortem_document_result_v2.additional_properties = d
        return incidents_import_postmortem_document_result_v2
