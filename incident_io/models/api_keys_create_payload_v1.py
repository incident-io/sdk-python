...
from ..models.api_keys_create_payload_v1_role_names_item import (
    APIKeysCreatePayloadV1RoleNamesItem,
)
from ..models.api_keys_create_payload_v1_team_role_names_item import (
    APIKeysCreatePayloadV1TeamRoleNamesItem,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="APIKeysCreatePayloadV1")


@_attrs_define(kw_only=True)
class APIKeysCreatePayloadV1:
    """
    Example:
    ...
    Attributes:
        name (str): Human-readable name for the new API key Example: My test API key.
        role_names (list[APIKeysCreatePayloadV1RoleNamesItem]): Account-level roles to assign to the API key. These
            roles apply across the entire account, not scoped to specific teams. Pass an empty array if no account-level
            roles are needed. Example: ['viewer', 'incident_creator'].
        ...
        team_role_names (list[APIKeysCreatePayloadV1TeamRoleNamesItem]): Roles to grant for the teams specified in
    ...
    name: str
    role_names: list[APIKeysCreatePayloadV1RoleNamesItem]
    team_ids: list[str]
    team_role_names: list[APIKeysCreatePayloadV1TeamRoleNamesItem]
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for role_names_item_data in _role_names:
            role_names_item = APIKeysCreatePayloadV1RoleNamesItem(role_names_item_data)
        ...
        for team_role_names_item_data in _team_role_names:
            team_role_names_item = APIKeysCreatePayloadV1TeamRoleNamesItem(
        ...
        api_keys_create_payload_v1 = cls(
            name=name,
            role_names=role_names,
            team_ids=team_ids,
            team_role_names=team_role_names,
        ...
        api_keys_create_payload_v1.additional_properties = d
        return api_keys_create_payload_v1
