...
T = TypeVar("T", bound="IncidentRolesUpdatePayloadV2")


@_attrs_define
class IncidentRolesUpdatePayloadV2:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        incident_roles_update_payload_v2 = cls(
            description=description,
            instructions=instructions,
            name=name,
            shortform=shortform,
        ...
        incident_roles_update_payload_v2.additional_properties = d
        return incident_roles_update_payload_v2
