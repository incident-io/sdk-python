...
T = TypeVar("T", bound="AlertRouteEscalationTargetPayloadV2")
...
class AlertRouteEscalationTargetPayloadV2:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        alert_route_escalation_target_payload_v2 = cls(
            escalation_paths=escalation_paths,
            users=users,
        )

        alert_route_escalation_target_payload_v2.additional_properties = d
        return alert_route_escalation_target_payload_v2
