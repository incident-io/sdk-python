...
if TYPE_CHECKING:
    ...
    from ..models.audit_log_organisation_settings_updated_metadata_v2 import (
        AuditLogOrganisationSettingsUpdatedMetadataV2,
    )
    from ..models.audit_log_target_v2 import AuditLogTargetV2


T = TypeVar("T", bound="AuditLogsOrganisationSettingsUpdatedV1")


@_attrs_define(kw_only=True)
class AuditLogsOrganisationSettingsUpdatedV1:
    """
    Example:
        {'action': 'organisation_settings.updated', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
            ...
            'default_timezone': 'Europe/London'}, 'occurred_at': '2021-08-17T13:28:57.801578Z', 'targets': [{'id':
            '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Organisation Settings', 'type': 'organisation_settings'}], 'version': 1}

    Attributes:
        action (str): The type of log entry that this is Example: organisation_settings.updated.
        ...
        metadata (AuditLogOrganisationSettingsUpdatedMetadataV2):  Example: {'after_organisation_name': 'Acme
            Corporation', 'before_organisation_name': 'Pineapple Labs', 'default_timezone': 'Europe/London'}.
    ...
    metadata: AuditLogOrganisationSettingsUpdatedMetadataV2
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        metadata = AuditLogOrganisationSettingsUpdatedMetadataV2.from_dict(
            d.pop("metadata")
        )
        ...
        audit_logs_organisation_settings_updated_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            metadata=metadata,
        ...
        audit_logs_organisation_settings_updated_v1.additional_properties = d
        return audit_logs_organisation_settings_updated_v1
