...
T = TypeVar("T", bound="AlertRouteTemplateBindingV2")
...
class AlertRouteTemplateBindingV2:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        alert_route_template_binding_v2 = cls(
            binding=binding,
        )

        alert_route_template_binding_v2.additional_properties = d
        return alert_route_template_binding_v2
