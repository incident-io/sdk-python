...
T = TypeVar("T", bound="SchedulesCreateScheduleSyncRuleResultV2")
...
class SchedulesCreateScheduleSyncRuleResultV2:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        schedules_create_schedule_sync_rule_result_v2 = cls(
            schedule_sync_rule=schedule_sync_rule,
        )

        schedules_create_schedule_sync_rule_result_v2.additional_properties = d
        return schedules_create_schedule_sync_rule_result_v2
