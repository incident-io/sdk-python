...
from ..models.escalation_path_node_level_with_binding_payload_v2_ack_mode import (
    EscalationPathNodeLevelWithBindingPayloadV2AckMode,
)
from ..models.escalation_path_node_level_with_binding_payload_v2_time_to_ack_interval_condition import (
...
T = TypeVar("T", bound="EscalationPathNodeLevelWithBindingPayloadV2")
...
class EscalationPathNodeLevelWithBindingPayloadV2:
    ...
    Example:
        {'ack_mode': 'all', 'retry_config': {'attempts': 3, 'interval_seconds': 300}, 'round_robin_config': {'enabled':
            False, 'rotate_after_seconds': 120}, 'targets': [{'binding': {'array_value': [{'literal': 'SEV123', 'reference':
    ...
    Attributes:
        targets (list[EscalationPathTargetWithBindingPayloadV2]): The targets (users or schedules), each concrete or a
            parameter binding. Example: [{'binding': {'array_value': [{'literal': 'SEV123', 'reference':
            'incident.severity'}], 'value': {'literal': 'SEV123', 'reference': 'incident.severity'}}, 'id':
            '01FCNDV6P870EA6S7TK1DSYDG0', 'schedule_mode': 'currently_on_call', 'selected_rota_id':
            '01FCNDV6P870EA6S7TK1DSYDG0', 'type': 'schedule', 'urgency': 'high'}].
        ack_mode (EscalationPathNodeLevelWithBindingPayloadV2AckMode | Unset): Controls the behaviour of
            acknowledgements for this level, with 'first' cancelling all other escalations on the same level when someone
            acks Example: all.
        ...
        time_to_ack_interval_condition (EscalationPathNodeLevelWithBindingPayloadV2TimeToAckIntervalCondition | Unset):
    ...
    ack_mode: EscalationPathNodeLevelWithBindingPayloadV2AckMode | Unset = UNSET
    ...
    time_to_ack_interval_condition: (
        EscalationPathNodeLevelWithBindingPayloadV2TimeToAckIntervalCondition | Unset
    ) = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        ack_mode: EscalationPathNodeLevelWithBindingPayloadV2AckMode | Unset
        if isinstance(_ack_mode, Unset):
            ack_mode = UNSET
        else:
            ack_mode = EscalationPathNodeLevelWithBindingPayloadV2AckMode(_ack_mode)
        ...
        escalation_path_node_level_with_binding_payload_v2 = cls(
            targets=targets,
            ack_mode=ack_mode,
        ...
        escalation_path_node_level_with_binding_payload_v2.additional_properties = d
        return escalation_path_node_level_with_binding_payload_v2
