...
T = TypeVar("T", bound="AuditLogsSecretRotatedV1")


@_attrs_define(kw_only=True)
class AuditLogsSecretRotatedV1:
    """
    Example:
        {'action': 'secret.rotated', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata': {'user_base_role_slug':
            ...
            'targets': [{'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Datadog webhook signing key', 'type': 'secret'}],
            'version': 1}

    Attributes:
        action (str): The type of log entry that this is Example: secret.rotated.
        ...
        targets (list[AuditLogTargetV2]): The custom field that was created Example: [{'id':
            '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Datadog webhook signing key', 'type': 'secret'}].
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_secret_rotated_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_secret_rotated_v1.additional_properties = d
        return audit_logs_secret_rotated_v1
