...
from ..models.embedded_incident_role_v2_role_type import EmbeddedIncidentRoleV2RoleType
from ..types import UNSET, Unset

T = TypeVar("T", bound="EmbeddedIncidentRoleV2")
...
class EmbeddedIncidentRoleV2:
    ...
    Attributes:
        ...
        role_type (EmbeddedIncidentRoleV2RoleType): Type of incident role Example: lead.
        ...
        required (bool | Unset): This field is deprecated. Example: False.
    """
    ...
    instructions: str
    name: str
    role_type: EmbeddedIncidentRoleV2RoleType
    shortform: str
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        role_type = EmbeddedIncidentRoleV2RoleType(d.pop("role_type"))
        ...
        embedded_incident_role_v2.additional_properties = d
