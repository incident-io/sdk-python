...
T = TypeVar("T", bound="AlertAttributesCreatePayloadV2")


@_attrs_define(kw_only=True)
class AlertAttributesCreatePayloadV2:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        alert_attributes_create_payload_v2 = cls(
            array=array,
            name=name,
            type_=type_,
            emoji=emoji,
        ...
        alert_attributes_create_payload_v2.additional_properties = d
        return alert_attributes_create_payload_v2
