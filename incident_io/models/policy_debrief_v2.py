...
T = TypeVar("T", bound="PolicyDebriefV2")
...
class PolicyDebriefV2:
    ...
    Attributes:
        requirements (list[ConditionGroupV2]): Conditions a debrief must satisfy to be compliant Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        policy_debrief_v2 = cls(
            requirements=requirements,
            due_date_config=due_date_config,
            run_on_private_incidents=run_on_private_incidents,
        )

        policy_debrief_v2.additional_properties = d
        return policy_debrief_v2
