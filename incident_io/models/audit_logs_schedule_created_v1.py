...
T = TypeVar("T", bound="AuditLogsScheduleCreatedV1")


@_attrs_define(kw_only=True)
class AuditLogsScheduleCreatedV1:
    """
    Example:
        {'action': 'schedule.created', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata': {'user_base_role_slug':
            ...
            'targets': [{'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'On-call', 'type': 'schedule'}], 'version': 1}

    Attributes:
        action (str): The type of log entry that this is Example: schedule.created.
        ...
        targets (list[AuditLogTargetV2]): The custom field that was created Example: [{'id':
            '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'On-call', 'type': 'schedule'}].
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_schedule_created_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_schedule_created_v1.additional_properties = d
        return audit_logs_schedule_created_v1
