...
T = TypeVar("T", bound="AuditLogsPolicyReportScheduleCreatedV1")


@_attrs_define(kw_only=True)
class AuditLogsPolicyReportScheduleCreatedV1:
    """
    Example:
        {'action': 'policy_report_schedule.created', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
    ...
    Attributes:
        action (str): The type of log entry that this is Example: policy_report_schedule.created.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_policy_report_schedule_created_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_policy_report_schedule_created_v1.additional_properties = d
        return audit_logs_policy_report_schedule_created_v1
