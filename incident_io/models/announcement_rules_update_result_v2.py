...
T = TypeVar("T", bound="AnnouncementRulesUpdateResultV2")


@_attrs_define(kw_only=True)
class AnnouncementRulesUpdateResultV2:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        announcement_rules_update_result_v2 = cls(
            announcement_rule=announcement_rule,
        )

        announcement_rules_update_result_v2.additional_properties = d
        return announcement_rules_update_result_v2
