...
T = TypeVar("T", bound="AuditLogsAlertChatMessageTemplateUpdatedV1")


@_attrs_define(kw_only=True)
class AuditLogsAlertChatMessageTemplateUpdatedV1:
    """
    Example:
        {'action': 'alert_chat_message_template.updated', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
            ...
            '2021-08-17T13:28:57.801578Z', 'targets': [{'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Standard', 'type':
            'alert_chat_message_template'}], 'version': 1}

    Attributes:
        action (str): The type of log entry that this is Example: alert_chat_message_template.updated.
        ...
        targets (list[AuditLogTargetV2]): The custom field that was created Example: [{'id':
            '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Standard', 'type': 'alert_chat_message_template'}].
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_alert_chat_message_template_updated_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_alert_chat_message_template_updated_v1.additional_properties = d
        return audit_logs_alert_chat_message_template_updated_v1
