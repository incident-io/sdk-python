...
T = TypeVar("T", bound="FollowUpsShowResultV2")


@_attrs_define(kw_only=True)
class FollowUpsShowResultV2:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        follow_ups_show_result_v2 = cls(
            follow_up=follow_up,
        )

        follow_ups_show_result_v2.additional_properties = d
        return follow_ups_show_result_v2
