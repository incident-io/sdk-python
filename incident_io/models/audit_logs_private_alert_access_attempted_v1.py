...
if TYPE_CHECKING:
    ...
    from ..models.audit_log_private_alert_access_attempted_metadata_v2 import (
        AuditLogPrivateAlertAccessAttemptedMetadataV2,
    )
    from ..models.audit_log_target_v2 import AuditLogTargetV2


T = TypeVar("T", bound="AuditLogsPrivateAlertAccessAttemptedV1")


@_attrs_define(kw_only=True)
class AuditLogsPrivateAlertAccessAttemptedV1:
    """
    Example:
        {'action': 'private_alert.access_attempted', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
            ...
            'granted'}, 'occurred_at': '2021-08-17T13:28:57.801578Z', 'targets': [{'id': '01FCNDV6P870EA6S7TK1DSYDG0',
            'name': 'Alert (01KB0083ASNF7EPT8NHQNRDXFC)', 'type': 'alert'}], 'version': 1}

    Attributes:
        action (str): The type of log entry that this is Example: private_alert.access_attempted.
        ...
        metadata (AuditLogPrivateAlertAccessAttemptedMetadataV2):  Example: {'outcome': 'granted'}.
        ...
        targets (list[AuditLogTargetV2]): The custom field that was created Example: [{'id':
            '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Alert (01KB0083ASNF7EPT8NHQNRDXFC)', 'type': 'alert'}].
    ...
    metadata: AuditLogPrivateAlertAccessAttemptedMetadataV2
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        metadata = AuditLogPrivateAlertAccessAttemptedMetadataV2.from_dict(
            d.pop("metadata")
        )
        ...
        audit_logs_private_alert_access_attempted_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            metadata=metadata,
        ...
        audit_logs_private_alert_access_attempted_v1.additional_properties = d
        return audit_logs_private_alert_access_attempted_v1
