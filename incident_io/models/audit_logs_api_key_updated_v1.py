...
T = TypeVar("T", bound="AuditLogsAPIKeyUpdatedV1")


@_attrs_define(kw_only=True)
class AuditLogsAPIKeyUpdatedV1:
    """
    Example:
        {'action': 'api_key.updated', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata': {'user_base_role_slug':
            ...
            'targets': [{'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Development API Key', 'type': 'api_key'}], 'version':
            1}

    Attributes:
        action (str): The type of log entry that this is Example: api_key.updated.
        ...
        targets (list[AuditLogTargetV2]): The custom field that was created Example: [{'id':
            '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Development API Key', 'type': 'api_key'}].
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_api_key_updated_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_api_key_updated_v1.additional_properties = d
        return audit_logs_api_key_updated_v1
