...
T = TypeVar("T", bound="AuditLogTelemetryDataSourceQueriedMetadataV2V2")
...
class AuditLogTelemetryDataSourceQueriedMetadataV2V2:
    ...
    Example:
        {'access_mode': 'restricted', 'investigation_id': '01FCNDV6P870EA6S7TK1DSYDG0', 'outcome': 'granted', 'surface':
            'chat', 'telemetry_query_id': '01FCNDV6P870EA6S7TK1DSYDG0'}
    ...
    Attributes:
        ...
        telemetry_query_id (str | Unset): ID of the recorded query, pointing at our full stored record of it Example:
            01FCNDV6P870EA6S7TK1DSYDG0.
    """
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_log_telemetry_data_source_queried_metadata_v2v2 = cls(
            access_mode=access_mode,
            outcome=outcome,
            surface=surface,
        ...
        audit_log_telemetry_data_source_queried_metadata_v2v2.additional_properties = d
        return audit_log_telemetry_data_source_queried_metadata_v2v2
