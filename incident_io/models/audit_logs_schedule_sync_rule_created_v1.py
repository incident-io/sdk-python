...
T = TypeVar("T", bound="AuditLogsScheduleSyncRuleCreatedV1")


@_attrs_define
class AuditLogsScheduleSyncRuleCreatedV1:
    """
    Example:
        {'action': 'schedule_sync_rule.created', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
            ...
            '2021-08-17T13:28:57.801578Z', 'targets': [{'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'on_call sync rule to
            Slack user group S012345ABCD', 'type': 'schedule_sync_rule'}], 'version': 1}

    Attributes:
        action (str): The type of log entry that this is Example: schedule_sync_rule.created.
        ...
        targets (list[AuditLogTargetV2]): The custom field that was created Example: [{'id':
            '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'on_call sync rule to Slack user group S012345ABCD', 'type':
            'schedule_sync_rule'}].
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_schedule_sync_rule_created_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_schedule_sync_rule_created_v1.additional_properties = d
        return audit_logs_schedule_sync_rule_created_v1
