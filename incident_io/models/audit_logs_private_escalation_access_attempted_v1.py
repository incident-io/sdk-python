...
if TYPE_CHECKING:
    ...
    from ..models.audit_log_private_escalation_access_attempted_metadata_v2 import (
...
class AuditLogsPrivateEscalationAccessAttemptedV1:
    """
    Example:
        {'action': 'private_escalation.access_attempted', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
            ...
            'name': 'Escalation (01KB0083ASNF7EPT8NHQNRDXFC)', 'type': 'escalation'}], 'version': 1}

    Attributes:
        action (str): The type of log entry that this is Example: private_escalation.access_attempted.
        ...
        metadata (AuditLogPrivateEscalationAccessAttemptedMetadataV2):  Example: {'outcome': 'granted'}.
        ...
        targets (list[AuditLogTargetV2]): The custom field that was created Example: [{'id':
            '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Escalation (01KB0083ASNF7EPT8NHQNRDXFC)', 'type': 'escalation'}].
    ...
    metadata: AuditLogPrivateEscalationAccessAttemptedMetadataV2
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        metadata = AuditLogPrivateEscalationAccessAttemptedMetadataV2.from_dict(
            d.pop("metadata")
        )
        ...
        audit_logs_private_escalation_access_attempted_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            metadata=metadata,
        ...
        audit_logs_private_escalation_access_attempted_v1.additional_properties = d
        return audit_logs_private_escalation_access_attempted_v1
