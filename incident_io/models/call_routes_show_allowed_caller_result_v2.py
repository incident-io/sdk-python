...
T = TypeVar("T", bound="CallRoutesShowAllowedCallerResultV2")


@_attrs_define
class CallRoutesShowAllowedCallerResultV2:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        call_routes_show_allowed_caller_result_v2 = cls(
            allowed_caller=allowed_caller,
        )

        call_routes_show_allowed_caller_result_v2.additional_properties = d
        return call_routes_show_allowed_caller_result_v2
