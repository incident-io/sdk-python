...
from ..models.workflows_update_workflow_payload_v2_runs_on_incident_modes_item import (
    WorkflowsUpdateWorkflowPayloadV2RunsOnIncidentModesItem,
)
from ..models.workflows_update_workflow_payload_v2_runs_on_incidents import (
    WorkflowsUpdateWorkflowPayloadV2RunsOnIncidents,
)
from ..models.workflows_update_workflow_payload_v2_state import (
...
if TYPE_CHECKING:
    ...
    from ..models.workflows_update_workflow_payload_v2_annotations import (
        WorkflowsUpdateWorkflowPayloadV2Annotations,
    )


T = TypeVar("T", bound="WorkflowsUpdateWorkflowPayloadV2")
...
class WorkflowsUpdateWorkflowPayloadV2:
    ...
    Attributes:
        ...
        runs_on_incident_modes (list[WorkflowsUpdateWorkflowPayloadV2RunsOnIncidentModesItem]): Which incident modes
        ...
        runs_on_incidents (WorkflowsUpdateWorkflowPayloadV2RunsOnIncidents): Which incidents should the workflow be
        ...
        private_incident_scope (WorkflowsUpdateWorkflowPayloadV2PrivateIncidentScope | Unset): Which private incidents
        ...
        skip_step_upgrades (bool | Unset): Skips workflow step upgrades, when the parameters for an existing workflow
            step change Example: False.
        state (WorkflowsUpdateWorkflowPayloadV2State | Unset): What state this workflow is in Example: active.
    """
    ...
    private_incident_scope: (
        WorkflowsUpdateWorkflowPayloadV2PrivateIncidentScope | Unset
    ) = UNSET
    shortform: str | Unset = UNSET
    skip_step_upgrades: bool | Unset = UNSET
    state: WorkflowsUpdateWorkflowPayloadV2State | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        skip_step_upgrades = self.skip_step_upgrades
        ...
        if skip_step_upgrades is not UNSET:
            field_dict["skip_step_upgrades"] = skip_step_upgrades
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        annotations: WorkflowsUpdateWorkflowPayloadV2Annotations | Unset
        if isinstance(_annotations, Unset):
            annotations = UNSET
        else:
            annotations = WorkflowsUpdateWorkflowPayloadV2Annotations.from_dict(
                _annotations
            )
        ...
        skip_step_upgrades = d.pop("skip_step_upgrades", UNSET)

        _state = d.pop("state", UNSET)
        state: WorkflowsUpdateWorkflowPayloadV2State | Unset
        if isinstance(_state, Unset):
            state = UNSET
        else:
            state = WorkflowsUpdateWorkflowPayloadV2State(_state)

        workflows_update_workflow_payload_v2 = cls(
            condition_groups=condition_groups,
            continue_on_step_error=continue_on_step_error,
            expressions=expressions,
            name=name,
        ...
        workflows_update_workflow_payload_v2.additional_properties = d
        return workflows_update_workflow_payload_v2
