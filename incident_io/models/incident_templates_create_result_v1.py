...
T = TypeVar("T", bound="IncidentTemplatesCreateResultV1")


@_attrs_define(kw_only=True)
class IncidentTemplatesCreateResultV1:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        incident_templates_create_result_v1 = cls(
            incident_template=incident_template,
        )

        incident_templates_create_result_v1.additional_properties = d
        return incident_templates_create_result_v1
