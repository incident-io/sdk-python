...
T = TypeVar("T", bound="IncidentRolesUpdateResultV1")
...
class IncidentRolesUpdateResultV1:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        incident_roles_update_result_v1 = cls(
            incident_role=incident_role,
        )

        incident_roles_update_result_v1.additional_properties = d
        return incident_roles_update_result_v1
