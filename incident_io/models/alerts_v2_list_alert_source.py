...
T = TypeVar("T", bound="AlertsV2ListAlertSource")


@_attrs_define(kw_only=True)
class AlertsV2ListAlertSource:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        d = dict(src_dict)
        alerts_v2_list_alert_source = cls()
        ...
        alerts_v2_list_alert_source.additional_properties = additional_properties
        return alerts_v2_list_alert_source
