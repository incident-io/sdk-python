...
T = TypeVar("T", bound="AlertRouteAlertSourceV3")


@_attrs_define(kw_only=True)
class AlertRouteAlertSourceV3:
    """
    Example:
    ...
    Attributes:
        ...
        condition_groups (list[ConditionGroupV3]): What conditions should alerts from this source meet to be included in
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        alert_route_alert_source_v3 = cls(
            alert_source_id=alert_source_id,
            condition_groups=condition_groups,
        )

        alert_route_alert_source_v3.additional_properties = d
        return alert_route_alert_source_v3
