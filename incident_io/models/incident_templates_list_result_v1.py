...
T = TypeVar("T", bound="IncidentTemplatesListResultV1")
...
class IncidentTemplatesListResultV1:
    """
    Example:
        {'incident_templates': [{'created_at': '2021-08-17T13:28:57.801578Z', 'expressions': [{'else_branch': {'result':
    ...
    Attributes:
        incident_templates (list[IncidentTemplateV1]):  Example: [{'created_at': '2021-08-17T13:28:57.801578Z',
            ...
            {'label': 'Lawrence Jones', 'value': '01FCQSP07Z74QMMYPDDGQB9FTG'}, 'param_bindings': [{'array_value':
            [{'literal': 'SEV123', 'reference': 'incident.severity'}], 'value': {'literal': 'SEV123', 'reference':
            'incident.severity'}}], 'subject': {'label': 'Priority', 'reference': 'alert.priority'}}]}], 'result':
            {'array_value': [{'literal': 'SEV123', 'reference': 'incident.severity'}], 'value': {'literal': 'SEV123',
            'reference': 'incident.severity'}}}], 'returns': {'array': True, 'type': 'IncidentStatus'}}, 'cast': {'returns':
            {'array': True, 'type': 'IncidentStatus'}}, 'concatenate': {'reference': '1235', 'reference_label': 'Teams'},
            'filter': {'condition_groups': [{'conditions': [{'operation': {'label': 'Lawrence Jones', 'value':
            '01FCQSP07Z74QMMYPDDGQB9FTG'}, 'param_bindings': [{'array_value': [{'literal': 'SEV123', 'reference':
            'incident.severity'}], 'value': {'literal': 'SEV123', 'reference': 'incident.severity'}}], 'subject': {'label':
            ...
            '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Payments incidents', 'template': {'custom_fields': [{'binding':
            {'array_value': [{'literal': 'SEV123', 'reference': 'incident.severity'}], 'value': {'literal': 'SEV123',
            ...
            [{'literal': 'SEV123', 'reference': 'incident.severity'}], 'value': {'literal': 'SEV123', 'reference':
            'incident.severity'}}}, 'name': {'autogenerated': False, 'binding': {'array_value': [{'literal': 'SEV123',
            'reference': 'incident.severity'}], 'value': {'literal': 'SEV123', 'reference': 'incident.severity'}}},
            'severity': {'binding': {'array_value': [{'literal': 'SEV123', 'reference': 'incident.severity'}], 'value':
            {'literal': 'SEV123', 'reference': 'incident.severity'}}, 'merge_strategy': 'first-wins'}, 'start_in_triage':
            {'binding': {'array_value': [{'literal': 'SEV123', 'reference': 'incident.severity'}], 'value': {'literal':
            'SEV123', 'reference': 'incident.severity'}}}, 'summary': {'autogenerated': False, 'binding': {'array_value':
            [{'literal': 'SEV123', 'reference': 'incident.severity'}], 'value': {'literal': 'SEV123', 'reference':
            'incident.severity'}}}, 'workspace': {'binding': {'array_value': [{'literal': 'SEV123', 'reference':
            'incident.severity'}], 'value': {'literal': 'SEV123', 'reference': 'incident.severity'}}}}, 'updated_at':
            '2021-08-17T13:28:57.801578Z'}].
        pagination_meta (PaginationMetaResultV1 | Unset):  Example: {'after': '01FCNDV6P870EA6S7TK1DSYDG0', 'page_size':
            25}.
    """

    incident_templates: list[IncidentTemplateV1]
    pagination_meta: PaginationMetaResultV1 | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        incident_templates = []
        for incident_templates_item_data in self.incident_templates:
            incident_templates_item = incident_templates_item_data.to_dict()
            incident_templates.append(incident_templates_item)
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        d = dict(src_dict)
        incident_templates = []
        _incident_templates = d.pop("incident_templates")
        for incident_templates_item_data in _incident_templates:
            incident_templates_item = IncidentTemplateV1.from_dict(
                incident_templates_item_data
            )
        ...
        incident_templates_list_result_v1 = cls(
            incident_templates=incident_templates,
            pagination_meta=pagination_meta,
        )

        incident_templates_list_result_v1.additional_properties = d
        return incident_templates_list_result_v1
