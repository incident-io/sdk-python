...
T = TypeVar("T", bound="AuditLogsEscalationPathUpdatedV1")


@_attrs_define
class AuditLogsEscalationPathUpdatedV1:
    """
    Example:
        {'action': 'escalation_path.updated', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
            ...
            'type': 'escalation_path'}], 'version': 1}

    Attributes:
        action (str): The type of log entry that this is Example: escalation_path.updated.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_escalation_path_updated_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_escalation_path_updated_v1.additional_properties = d
        return audit_logs_escalation_path_updated_v1
