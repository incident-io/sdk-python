...
class ActivityAlertRefV2:
    ...
    Example:
        {'actor': {'alert': {'id': '01GW2G3V0S59R238FAHPDS1R66', 'title': '*errors.withMessage: PG::Error failed to
            ...
            workflow'}}, 'alert_id': '01FCNDV6P870EA6S7TK1DSYDG0'}

    Attributes:
        alert_id (str): The alert. Fetch it from GET /v2/alerts/{id}. Example: 01FCNDV6P870EA6S7TK1DSYDG0.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        activity_alert_ref_v2 = cls(
            alert_id=alert_id,
            actor=actor,
        )

        activity_alert_ref_v2.additional_properties = d
        return activity_alert_ref_v2
