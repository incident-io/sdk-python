...
T = TypeVar("T", bound="AlertsAddTagsResultV2")


@_attrs_define(kw_only=True)
class AlertsAddTagsResultV2:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        alerts_add_tags_result_v2 = cls(
            alert=alert,
        )

        alerts_add_tags_result_v2.additional_properties = d
        return alerts_add_tags_result_v2
