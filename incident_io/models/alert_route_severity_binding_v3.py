...
from ..models.alert_route_severity_binding_v3_merge_strategy import (
...
T = TypeVar("T", bound="AlertRouteSeverityBindingV3")


@_attrs_define(kw_only=True)
class AlertRouteSeverityBindingV3:
    """
    Example:
    ...
    Attributes:
        merge_strategy (AlertRouteSeverityBindingV3MergeStrategy): Strategy for merging severity when multiple alerts
    ...
    merge_strategy: AlertRouteSeverityBindingV3MergeStrategy
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        alert_route_severity_binding_v3 = cls(
            merge_strategy=merge_strategy,
            binding=binding,
        )

        alert_route_severity_binding_v3.additional_properties = d
        return alert_route_severity_binding_v3
