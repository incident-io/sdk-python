...
T = TypeVar("T", bound="AuditLogsTelemetryDataSourceWriteAccessRevokedV1")


@_attrs_define(kw_only=True)
class AuditLogsTelemetryDataSourceWriteAccessRevokedV1:
    """
    Example:
        {'action': 'telemetry_data_source.write_access_revoked', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0',
    ...
    Attributes:
        action (str): The type of log entry that this is Example: telemetry_data_source.write_access_revoked.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_telemetry_data_source_write_access_revoked_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            metadata=metadata,
        ...
        audit_logs_telemetry_data_source_write_access_revoked_v1.additional_properties = d
        return audit_logs_telemetry_data_source_write_access_revoked_v1
