...
T = TypeVar("T", bound="IncidentTemplatesUpdatePayloadV1")


@_attrs_define(kw_only=True)
class IncidentTemplatesUpdatePayloadV1:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        incident_templates_update_payload_v1 = cls(
            name=name,
            template=template,
            expressions=expressions,
        )

        incident_templates_update_payload_v1.additional_properties = d
        return incident_templates_update_payload_v1
