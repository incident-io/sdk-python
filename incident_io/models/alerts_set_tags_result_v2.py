...
T = TypeVar("T", bound="AlertsSetTagsResultV2")


@_attrs_define(kw_only=True)
class AlertsSetTagsResultV2:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        alerts_set_tags_result_v2 = cls(
            alert=alert,
        )

        alerts_set_tags_result_v2.additional_properties = d
        return alerts_set_tags_result_v2
