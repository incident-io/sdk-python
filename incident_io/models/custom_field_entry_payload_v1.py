...
class CustomFieldEntryPayloadV1:
    ...
    custom_field_id: str
    values: list[CustomFieldValuePayloadV1]
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.custom_field_value_payload_v1 import (
        ...
        for values_item_data in _values:
            values_item = CustomFieldValuePayloadV1.from_dict(values_item_data)

            values.append(values_item)

        custom_field_entry_payload_v1 = cls(
            custom_field_id=custom_field_id,
            values=values,
        )

        custom_field_entry_payload_v1.additional_properties = d
        return custom_field_entry_payload_v1
