...
if TYPE_CHECKING:
    ...
    from ..models.audit_log_telemetry_data_source_tool_access_changed_metadata_v2 import (
        AuditLogTelemetryDataSourceToolAccessChangedMetadataV2,
    )


T = TypeVar("T", bound="AuditLogsTelemetryDataSourceToolAccessChangedV1")


@_attrs_define(kw_only=True)
class AuditLogsTelemetryDataSourceToolAccessChangedV1:
    """
    Example:
        {'action': 'telemetry_data_source.tool_access_changed', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0',
            ...
            'override', 'surface': 'chat', 'tool': 'restart_service'}, 'occurred_at': '2021-08-17T13:28:57.801578Z',
    ...
    Attributes:
        action (str): The type of log entry that this is Example: telemetry_data_source.tool_access_changed.
        ...
        metadata (AuditLogTelemetryDataSourceToolAccessChangedMetadataV2):  Example: {'after': '{"type":"allow"}',
            'before': '{"type":"deny"}', 'change_id': '01JD8ZQK9X0000000000000000', 'source': 'override', 'surface': 'chat',
    ...
    metadata: AuditLogTelemetryDataSourceToolAccessChangedMetadataV2
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        metadata = AuditLogTelemetryDataSourceToolAccessChangedMetadataV2.from_dict(
            d.pop("metadata")
        )
        ...
        audit_logs_telemetry_data_source_tool_access_changed_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            metadata=metadata,
        ...
        audit_logs_telemetry_data_source_tool_access_changed_v1.additional_properties = d
        return audit_logs_telemetry_data_source_tool_access_changed_v1
