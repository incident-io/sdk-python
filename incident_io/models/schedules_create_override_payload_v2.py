...
T = TypeVar("T", bound="SchedulesCreateOverridePayloadV2")


@_attrs_define
class SchedulesCreateOverridePayloadV2:
    """
    Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        schedules_create_override_payload_v2 = cls(
            end_at=end_at,
            layer_id=layer_id,
            rotation_id=rotation_id,
            schedule_id=schedule_id,
        ...
        schedules_create_override_payload_v2.additional_properties = d
        return schedules_create_override_payload_v2
