...
T = TypeVar("T", bound="AuditLogsAnnouncementRuleCreatedV2")


@_attrs_define(kw_only=True)
class AuditLogsAnnouncementRuleCreatedV2:
    """
    Example:
        {'action': 'announcement_rule.created', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
    ...
    Attributes:
        action (str): The type of log entry that this is Example: announcement_rule.created.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_announcement_rule_created_v2 = cls(
            action=action,
            actor=actor,
            context=context,
            metadata=metadata,
        ...
        audit_logs_announcement_rule_created_v2.additional_properties = d
        return audit_logs_announcement_rule_created_v2
