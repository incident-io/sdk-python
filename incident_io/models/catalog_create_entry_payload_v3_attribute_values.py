...
T = TypeVar("T", bound="CatalogCreateEntryPayloadV3AttributeValues")


@_attrs_define(kw_only=True)
class CatalogCreateEntryPayloadV3AttributeValues:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        d = dict(src_dict)
        catalog_create_entry_payload_v3_attribute_values = cls()
        ...
        catalog_create_entry_payload_v3_attribute_values.additional_properties = (
            additional_properties
        )
        return catalog_create_entry_payload_v3_attribute_values
