...
T = TypeVar("T", bound="AuditLogsPrivateIncidentAccessRequestedV1")


@_attrs_define(kw_only=True)
class AuditLogsPrivateIncidentAccessRequestedV1:
    """
    Example:
        {'action': 'private_incident.access_requested', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
            ...
            slow', 'type': 'incident'}], 'version': 1}

    Attributes:
        action (str): The type of log entry that this is Example: private_incident.access_requested.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_private_incident_access_requested_v1 = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_private_incident_access_requested_v1.additional_properties = d
        return audit_logs_private_incident_access_requested_v1
