...
from ..models.alert_route_custom_field_binding_payload_v3_merge_strategy import (
...
T = TypeVar("T", bound="AlertRouteCustomFieldBindingPayloadV3")


@_attrs_define
class AlertRouteCustomFieldBindingPayloadV3:
    """
    Example:
    ...
    Attributes:
        ...
        merge_strategy (AlertRouteCustomFieldBindingPayloadV3MergeStrategy): The strategy to use when multiple alerts
            match this route Example: first-wins.
    """

    binding: EngineParamBindingPayloadV3
    custom_field_id: str
    merge_strategy: AlertRouteCustomFieldBindingPayloadV3MergeStrategy
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        alert_route_custom_field_binding_payload_v3 = cls(
            binding=binding,
            custom_field_id=custom_field_id,
            merge_strategy=merge_strategy,
        )

        alert_route_custom_field_binding_payload_v3.additional_properties = d
        return alert_route_custom_field_binding_payload_v3
