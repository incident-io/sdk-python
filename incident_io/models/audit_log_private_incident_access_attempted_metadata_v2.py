...
class AuditLogPrivateIncidentAccessAttemptedMetadataV2:
    ...
    Attributes:
        outcome (AuditLogPrivateIncidentAccessAttemptedMetadataV2Outcome | Unset): Whether or not the user was able to
            access the private incident Example: granted.
    """

    outcome: AuditLogPrivateIncidentAccessAttemptedMetadataV2Outcome | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        outcome: AuditLogPrivateIncidentAccessAttemptedMetadataV2Outcome | Unset
