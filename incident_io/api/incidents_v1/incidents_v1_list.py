...
from ...models.incidents_list_result_v1 import IncidentsListResultV1
...
) -> ErrorResponse | IncidentsListResultV1 | None:
    if response.status_code == 200:
        response_200 = IncidentsListResultV1.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | IncidentsListResultV1]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        status (list[str] | Unset): Filter for incidents in these statuses Example: ['declined'].
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | IncidentsListResultV1
    """
...
_DEPRECATION_MESSAGE = "GET /v1/incidents is deprecated and will be removed. See https://api-docs.incident.io/ for the replacement."
