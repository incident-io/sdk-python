...
from ...models.incidents_show_result_v1 import IncidentsShowResultV1
...
) -> ErrorResponse | IncidentsShowResultV1 | None:
    if response.status_code == 200:
        response_200 = IncidentsShowResultV1.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | IncidentsShowResultV1]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorResponse | IncidentsShowResultV1
    """
...
_DEPRECATION_MESSAGE = "GET /v1/incidents/{id} is deprecated and will be removed. See https://api-docs.incident.io/ for the replacement."
