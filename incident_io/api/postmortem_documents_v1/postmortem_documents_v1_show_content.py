...
from ...models.postmortem_documents_show_content_result_v1 import (
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/postmortem_documents/{id}/content".format(
...
) -> ErrorResponse | PostmortemDocumentsShowContentResultV1 | None:
    if response.status_code == 200:
        response_200 = PostmortemDocumentsShowContentResultV1.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | PostmortemDocumentsShowContentResultV1]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorResponse | PostmortemDocumentsShowContentResultV1
    """
