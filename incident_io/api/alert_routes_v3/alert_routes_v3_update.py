...
from ...models.alert_routes_update_payload_v3 import AlertRoutesUpdatePayloadV3
from ...models.alert_routes_update_result_v3 import AlertRoutesUpdateResultV3
...
def _get_kwargs(
    id: str,
    *,
    body: AlertRoutesUpdatePayloadV3,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/v3/alert_routes/{id}".format(
...
) -> AlertRoutesUpdateResultV3 | ErrorResponse | None:
    if response.status_code == 200:
        response_200 = AlertRoutesUpdateResultV3.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[AlertRoutesUpdateResultV3 | ErrorResponse]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Update Alert Routes V3

     Update an existing alert route in your account.

    Args:
        id (str): Unique identifier of the alert route Example: 01FCNDV6P870EA6S7TK1DSYDG0.
        body (AlertRoutesUpdatePayloadV3):  Example: {'alert_sources': [{'alert_source_id':
            ...
            'owning_team_ids': ['01G0J1EXE7AXZ2C93K61WBPYEH'], 'version': 1}.
...
def sync(
    ...
    *,
    ...
    Returns:
        AlertRoutesUpdateResultV3 | ErrorResponse
    """
