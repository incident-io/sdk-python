...
def sync_detailed(
    ...
    *,
    ...
    """DestroyWeeklyRule Pay Configs V2

     Remove a weekly rule from a pay config. Time it covered falls back to the base rate, or to a later
    rule that also covers it.
