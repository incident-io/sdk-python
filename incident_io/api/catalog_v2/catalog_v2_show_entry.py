...
from ...models.catalog_show_entry_result_v2 import CatalogShowEntryResultV2
...
) -> CatalogShowEntryResultV2 | ErrorResponse | None:
    if response.status_code == 200:
        response_200 = CatalogShowEntryResultV2.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[CatalogShowEntryResultV2 | ErrorResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        CatalogShowEntryResultV2 | ErrorResponse
    """
...
_DEPRECATION_MESSAGE = "GET /v2/catalog_entries/{id} is deprecated and will be removed. See https://api-docs.incident.io/ for the replacement."
