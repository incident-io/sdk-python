...
from ...models.catalog_list_entries_result_v2 import CatalogListEntriesResultV2
...
) -> CatalogListEntriesResultV2 | ErrorResponse | None:
    if response.status_code == 200:
        response_200 = CatalogListEntriesResultV2.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[CatalogListEntriesResultV2 | ErrorResponse]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        CatalogListEntriesResultV2 | ErrorResponse
    """
...
_DEPRECATION_MESSAGE = "GET /v2/catalog_entries is deprecated and will be removed. See https://api-docs.incident.io/ for the replacement."
