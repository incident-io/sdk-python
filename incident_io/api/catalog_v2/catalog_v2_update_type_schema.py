...
_DEPRECATION_MESSAGE = "POST /v2/catalog_types/{id}/actions/update_schema is deprecated and will be removed. See https://api-docs.incident.io/ for the replacement."
