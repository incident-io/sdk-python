...
from ...models.custom_fields_list_result_v1 import CustomFieldsListResultV1
...
) -> CustomFieldsListResultV1 | ErrorResponse | None:
    if response.status_code == 200:
        response_200 = CustomFieldsListResultV1.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[CustomFieldsListResultV1 | ErrorResponse]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        CustomFieldsListResultV1 | ErrorResponse
    """
