...
from ...models.custom_fields_show_result_v1 import CustomFieldsShowResultV1
...
) -> CustomFieldsShowResultV1 | ErrorResponse | None:
    if response.status_code == 200:
        response_200 = CustomFieldsShowResultV1.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[CustomFieldsShowResultV1 | ErrorResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        CustomFieldsShowResultV1 | ErrorResponse
    """
...
_DEPRECATION_MESSAGE = "GET /v1/custom_fields/{id} is deprecated and will be removed. See https://api-docs.incident.io/ for the replacement."
