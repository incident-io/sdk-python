...
from ...models.incident_memberships_revoke_payload_v1 import (
...
def _get_kwargs(
    *,
    body: IncidentMembershipsRevokePayloadV1,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (IncidentMembershipsRevokePayloadV1):  Example: {'incident_id':
