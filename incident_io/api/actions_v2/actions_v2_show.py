...
from ...models.actions_show_result_v2 import ActionsShowResultV2
...
) -> ActionsShowResultV2 | ErrorResponse | None:
    if response.status_code == 200:
        response_200 = ActionsShowResultV2.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ActionsShowResultV2 | ErrorResponse]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Show Actions V2
     ...
     Deprecated: this endpoint will be removed on 31 December 2026. Use <code>GET /v3/actions/{id}</code>
    instead.
...
def sync(
    ...
    *,
    ...
    Returns:
        ActionsShowResultV2 | ErrorResponse
    """
...
_DEPRECATION_MESSAGE = "GET /v2/actions/{id} is deprecated and will be removed. See https://api-docs.incident.io/ for the replacement."
