...
from ...models.maintenance_windows_update_payload_v1 import (
    MaintenanceWindowsUpdatePayloadV1,
)
from ...models.maintenance_windows_update_result_v1 import (
...
def _get_kwargs(
    id: str,
    *,
    body: MaintenanceWindowsUpdatePayloadV1,
) -> dict[str, Any]:
...
) -> ErrorResponse | MaintenanceWindowsUpdateResultV1 | None:
    if response.status_code == 200:
        response_200 = MaintenanceWindowsUpdateResultV1.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | MaintenanceWindowsUpdateResultV1]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (MaintenanceWindowsUpdatePayloadV1):  Example: {'alert_condition_groups':
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorResponse | MaintenanceWindowsUpdateResultV1
    """
