...
from ...models.workflow_runs_show_result_v2 import WorkflowRunsShowResultV2
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v2/workflow_runs/{id}".format(
...
) -> ErrorResponse | WorkflowRunsShowResultV2 | None:
    if response.status_code == 200:
        response_200 = WorkflowRunsShowResultV2.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | WorkflowRunsShowResultV2]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorResponse | WorkflowRunsShowResultV2
    """
