...
from ...models.status_pages_list_status_page_maintenances_result_v2 import (
...
) -> ErrorResponse | StatusPagesListStatusPageMaintenancesResultV2 | None:
    if response.status_code == 200:
        response_200 = StatusPagesListStatusPageMaintenancesResultV2.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | StatusPagesListStatusPageMaintenancesResultV2]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        component_id (str | Unset): Filter status page maintenance windows to only those that
            impacted the specified component. This ID may be found by calling the
            ShowStatusPageStructure endpoint. Example: 01FCNDV6P870EA6S7TK1DSYDG1.
        group_id (str | Unset): Filter status page maintenance windows to only those that impacted
        ...
        sub_page_id (str | Unset): Filter status page maintenance windows to only those that
            impacted the specified sub-page. This ID may be found by calling the
            ShowStatusPageStructure endpoint. Example: 01FCNDV6P870EA6S7TK1DSYDG3.
        start_at (datetime.datetime | Unset): Filter status page maintenance windows to only those
            that had impacts during or after this time. Example: 2021-08-17T13:28:57.801578Z.
        end_at (datetime.datetime | Unset): Filter status page maintenance windows to only those
            that had impacts during or before this time. Example: 2021-08-17T13:28:57.801578Z.
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | StatusPagesListStatusPageMaintenancesResultV2
    """
