...
from ...models.status_pages_show_status_page_maintenance_result_v2 import (
...
) -> ErrorResponse | StatusPagesShowStatusPageMaintenanceResultV2 | None:
    if response.status_code == 200:
        response_200 = StatusPagesShowStatusPageMaintenanceResultV2.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | StatusPagesShowStatusPageMaintenanceResultV2]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorResponse | StatusPagesShowStatusPageMaintenanceResultV2
    """
