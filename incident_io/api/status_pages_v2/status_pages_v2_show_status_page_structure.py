...
from ...models.status_pages_show_status_page_structure_result_v2 import (
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v2/status_page_structures/{status_page_id}".format(
...
) -> ErrorResponse | StatusPagesShowStatusPageStructureResultV2 | None:
    if response.status_code == 200:
        response_200 = StatusPagesShowStatusPageStructureResultV2.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | StatusPagesShowStatusPageStructureResultV2]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorResponse | StatusPagesShowStatusPageStructureResultV2
    """
