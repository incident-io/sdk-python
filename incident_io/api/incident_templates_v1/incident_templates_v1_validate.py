...
from ...models.incident_templates_validate_payload_v1 import (
    IncidentTemplatesValidatePayloadV1,
)
from ...models.incident_templates_validate_result_v1 import (
...
def _get_kwargs(
    *,
    body: IncidentTemplatesValidatePayloadV1,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/incident_templates/actions/validate",
    }
...
) -> ErrorResponse | IncidentTemplatesValidateResultV1 | None:
    if response.status_code == 200:
        response_200 = IncidentTemplatesValidateResultV1.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | IncidentTemplatesValidateResultV1]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Validate Incident Templates V1
    ...
    Args:
        body (IncidentTemplatesValidatePayloadV1):  Example: {'expressions': [{'else_branch':
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | IncidentTemplatesValidateResultV1
    """
