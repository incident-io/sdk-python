...
from ...models.actions_show_result_v1 import ActionsShowResultV1
...
) -> ActionsShowResultV1 | ErrorResponse | None:
    if response.status_code == 200:
        response_200 = ActionsShowResultV1.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ActionsShowResultV1 | ErrorResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ActionsShowResultV1 | ErrorResponse
    """
...
_DEPRECATION_MESSAGE = "GET /v1/actions/{id} is deprecated and will be removed. See https://api-docs.incident.io/ for the replacement."
