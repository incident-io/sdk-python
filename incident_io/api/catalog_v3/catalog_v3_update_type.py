...
from ...models.catalog_update_type_payload_v3 import CatalogUpdateTypePayloadV3
from ...models.catalog_update_type_result_v3 import CatalogUpdateTypeResultV3
...
def _get_kwargs(
    id: str,
    *,
    body: CatalogUpdateTypePayloadV3,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/v3/catalog_types/{id}".format(
...
) -> CatalogUpdateTypeResultV3 | ErrorResponse | None:
    if response.status_code == 200:
        response_200 = CatalogUpdateTypeResultV3.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[CatalogUpdateTypeResultV3 | ErrorResponse]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (CatalogUpdateTypePayloadV3):  Example: {'annotations': {'incident.io/catalog-
...
def sync(
    ...
    *,
    ...
    Returns:
        CatalogUpdateTypeResultV3 | ErrorResponse
    """
