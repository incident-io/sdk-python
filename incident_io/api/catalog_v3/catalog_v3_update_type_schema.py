...
from ...models.catalog_update_type_schema_payload_v3 import (
    CatalogUpdateTypeSchemaPayloadV3,
)
from ...models.catalog_update_type_schema_result_v3 import (
...
def _get_kwargs(
    id: str,
    *,
    body: CatalogUpdateTypeSchemaPayloadV3,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v3/catalog_types/{id}/actions/update_schema".format(
...
) -> CatalogUpdateTypeSchemaResultV3 | ErrorResponse | None:
    if response.status_code == 200:
        response_200 = CatalogUpdateTypeSchemaResultV3.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[CatalogUpdateTypeSchemaResultV3 | ErrorResponse]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (CatalogUpdateTypeSchemaPayloadV3):  Example: {'attributes': [{'array': False,
...
def sync(
    ...
    *,
    ...
    Returns:
        CatalogUpdateTypeSchemaResultV3 | ErrorResponse
    """
