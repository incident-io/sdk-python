...
from ...models.alert_sources_update_payload_v2 import AlertSourcesUpdatePayloadV2
from ...models.alert_sources_update_result_v2 import AlertSourcesUpdateResultV2
...
def _get_kwargs(
    id: str,
    *,
    body: AlertSourcesUpdatePayloadV2,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/v2/alert_sources/{id}".format(
...
) -> AlertSourcesUpdateResultV2 | ErrorResponse | None:
    if response.status_code == 200:
        response_200 = AlertSourcesUpdateResultV2.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[AlertSourcesUpdateResultV2 | ErrorResponse]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (AlertSourcesUpdatePayloadV2):  Example: {'auto_resolve_incident_alerts': False,
            'auto_resolve_timeout_minutes': 1, 'azure_devops_options': {'project_ids':
            ['01GBSQF3FHF7FWZQNWGHAVQ804', 'ba038695-f5f7-4490-a9ea-bf4ab3cbf483']}, 'disabled':
            False, 'email_options': {'redactions': ['credit_card_numbers'], 'transform_expression':
            "return {\\n  title: $.subject,\\n  description: $.text,\\n  status:
            ...
            'subject': 'incident.severity'}]}], 'fixed_team_id': '01G0J1EXE7AXZ2C93K61WBPYEH',
            ...
            {'rate_limit_shard_key_path': '$.priority'}, 'template': {'attributes':
...
def sync(
    ...
    *,
    ...
    Returns:
        AlertSourcesUpdateResultV2 | ErrorResponse
    """
