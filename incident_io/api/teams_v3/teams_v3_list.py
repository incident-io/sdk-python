...
from ...models.teams_list_result_v3 import TeamsListResultV3
...
) -> ErrorResponse | TeamsListResultV3 | None:
    if response.status_code == 200:
        response_200 = TeamsListResultV3.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | TeamsListResultV3]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | TeamsListResultV3
    """
