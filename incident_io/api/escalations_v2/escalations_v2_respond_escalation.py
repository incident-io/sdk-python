...
from ...models.escalations_respond_escalation_payload_v2 import (
...
def _get_kwargs(
    escalation_id: str,
    *,
    body: EscalationsRespondEscalationPayloadV2,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v2/escalations/{escalation_id}/actions/respond".format(
...
def sync_detailed(
    ...
    *,
    ...
    """RespondEscalation Escalations V2
    ...
    Args:
        ...
        body (EscalationsRespondEscalationPayloadV2):  Example: {'response': 'ack',
            'snooze_details': {'reason': 'Waiting for deployment to complete', 'snooze_until':
