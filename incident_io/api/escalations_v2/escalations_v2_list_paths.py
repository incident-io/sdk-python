...
from ...models.escalations_list_paths_result_v2 import EscalationsListPathsResultV2
...
) -> ErrorResponse | EscalationsListPathsResultV2 | None:
    if response.status_code == 200:
        response_200 = EscalationsListPathsResultV2.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | EscalationsListPathsResultV2]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | EscalationsListPathsResultV2
    """
