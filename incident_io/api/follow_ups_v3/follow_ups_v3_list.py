...
from ...models.follow_ups_v3_list_created_at import FollowUpsV3ListCreatedAt
from ...models.follow_ups_v3_list_incident_mode import FollowUpsV3ListIncidentMode
from ...models.follow_ups_v3_list_updated_at import FollowUpsV3ListUpdatedAt
...
def _get_kwargs(
    *,
    ...
    incident_mode: FollowUpsV3ListIncidentMode | Unset = UNSET,
    assignee_team_id: str | Unset = UNSET,
    created_at: FollowUpsV3ListCreatedAt | Unset = UNSET,
    updated_at: FollowUpsV3ListUpdatedAt | Unset = UNSET,
) -> dict[str, Any]:
...
) -> ErrorResponse | FollowUpsListResultV3 | None:
    if response.status_code == 200:
        response_200 = FollowUpsListResultV3.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | FollowUpsListResultV3]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        after (str | Unset): A follow-up's ID. This endpoint will return a list of follow-ups
        ...
        incident_mode (FollowUpsV3ListIncidentMode | Unset): Filter to follow-ups from incidents
        ...
        created_at (FollowUpsV3ListCreatedAt | Unset): Filter on follow-up created at timestamp.
            Accepted operators are 'gte', 'lte' and 'date_range'. Example: {'gte': ['2025-01-01']}.
        updated_at (FollowUpsV3ListUpdatedAt | Unset): Filter on follow-up updated at timestamp.
            Accepted operators are 'gte', 'lte' and 'date_range'. Example: {'gte': ['2025-01-01']}.
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | FollowUpsListResultV3
     """
