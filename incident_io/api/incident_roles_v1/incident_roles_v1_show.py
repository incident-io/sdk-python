...
from ...models.incident_roles_show_result_v1 import IncidentRolesShowResultV1
...
) -> ErrorResponse | IncidentRolesShowResultV1 | None:
    if response.status_code == 200:
        response_200 = IncidentRolesShowResultV1.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | IncidentRolesShowResultV1]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorResponse | IncidentRolesShowResultV1
    """
...
_DEPRECATION_MESSAGE = "GET /v1/incident_roles/{id} is deprecated and will be removed. See https://api-docs.incident.io/ for the replacement."
