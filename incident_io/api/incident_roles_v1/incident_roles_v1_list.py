...
from ...models.incident_roles_list_result_v1 import IncidentRolesListResultV1
...
) -> ErrorResponse | IncidentRolesListResultV1 | None:
    if response.status_code == 200:
        response_200 = IncidentRolesListResultV1.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | IncidentRolesListResultV1]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | IncidentRolesListResultV1
    """
...
_DEPRECATION_MESSAGE = "GET /v1/incident_roles is deprecated and will be removed. See https://api-docs.incident.io/ for the replacement."
