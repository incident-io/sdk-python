...
_DEPRECATION_MESSAGE = "POST /v2/follow_ups/{id}/actions/connect_external_issue is deprecated and will be removed. See https://api-docs.incident.io/ for the replacement."
