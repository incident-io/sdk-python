...
def sync_detailed(
    ...
    *,
    ...
    """Delete Follow-ups V2

     Deprecated: this endpoint will be removed on 31 December 2026. Use <code>DELETE
...
_DEPRECATION_MESSAGE = "DELETE /v2/follow_ups/{id} is deprecated and will be removed. See https://api-docs.incident.io/ for the replacement."
