...
from ...models.follow_ups_show_result_v2 import FollowUpsShowResultV2
...
) -> ErrorResponse | FollowUpsShowResultV2 | None:
    if response.status_code == 200:
        response_200 = FollowUpsShowResultV2.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | FollowUpsShowResultV2]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Show Follow-ups V2
     ...
     Deprecated: this endpoint will be removed on 31 December 2026. Use <code>GET
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorResponse | FollowUpsShowResultV2
    """
...
_DEPRECATION_MESSAGE = "GET /v2/follow_ups/{id} is deprecated and will be removed. See https://api-docs.incident.io/ for the replacement."
