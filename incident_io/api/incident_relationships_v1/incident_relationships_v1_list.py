...
from ...models.incident_relationships_list_result_v1 import (
...
) -> ErrorResponse | IncidentRelationshipsListResultV1 | None:
    if response.status_code == 200:
        response_200 = IncidentRelationshipsListResultV1.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | IncidentRelationshipsListResultV1]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | IncidentRelationshipsListResultV1
    """
